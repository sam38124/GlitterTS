    ...
    async store(cf) {
        ...
        return {
            form: (await (new financial_service_js_1.default(this.app, {
                ...
                "NotifyURL": `${process.env.DOMAIN}/api-public/v1/sms/points/notify?g-app=${this.app}`,
...
exports.SmsPoints = SmsPoints;
//# sourceMappingURL=sms-pointes.js.map