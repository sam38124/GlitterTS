...
var Monitor = /** @class */ (function () {
    ...
    Monitor.insertHistory = function (obj) {
        return __awaiter(this, void 0, void 0, function () {
            var req, mac_address, e_1;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        mac_address = req.cookies.mac_address;
                        if (!mac_address) {
                            mac_address = tool_js_1.default.randomString(10);
                            (_a = req.res) === null || _a === void 0 ? void 0 : _a.cookie('mac_address', mac_address);
                        }
                        return [4 /*yield*/, database_1.default.query("insert into `".concat(config_js_1.saasConfig.SAAS_NAME, "`.t_monitor set ?"), [
                                {
