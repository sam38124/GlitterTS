    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                ...
                _c = [resp];
                return [4 /*yield*/, new mail_js_1.Mail(req.get('g-app'), req.body.token).getMail({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, new mail_js_1.Mail(req.get('g-app'), req.body.token).postMail(req.body)];
            case 2:
                post = _a.sent();
                return [2 /*return*/, response_1.default.succ(resp, { data: post })];
            case 3: return [2 /*return*/, response_1.default.fail(resp, exception_1.default.BadRequestError('BAD_REQUEST', 'No permission.', null))];
            case 4: return [3 /*break*/, 6];
            case 5:
                err_2 = _a.sent();
...
router.delete('/:id', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var data, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                if (!_a.sent()) return [3 /*break*/, 3];
                return [4 /*yield*/, new mail_js_1.Mail(req.get('g-app'), req.body.token).cancelSendMail(req.params.id)];
            case 2:
                data = _a.sent();
