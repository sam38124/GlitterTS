...
router.post('/listenMessage', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                if (!(Object.keys(req.body.events || {}).length == 0)) return [3 /*break*/, 1];
                return [2 /*return*/, response_1.default.succ(resp, {
                        "result": "OK"
                    })];
            case 1: return [4 /*yield*/, new line_message_1.LineMessage(req.get('g-app'), req.body.token).listenMessage(req.body)];
            case 2:
                _a.sent();
                return [2 /*return*/, response_1.default.succ(resp, {
                        "result": "OK"
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, new line_message_1.LineMessage(req.get('g-app'), req.body.token).postLine(req.body)];
            case 2:
                post = _a.sent();
                return [2 /*return*/, response_1.default.succ(resp, { data: "check OK" })];
            case 3: return [2 /*return*/, response_1.default.fail(resp, exception_1.default.BadRequestError('BAD_REQUEST', 'No permission.', null))];
            case 4: return [3 /*break*/, 6];
            case 5:
                err_3 = _a.sent();
...
router.delete('/', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                if (!_a.sent()) return [3 /*break*/, 3];
                return [4 /*yield*/, new sms_js_1.SMS(req.get('g-app'), req.body.token).deleteSns(req.body)];
            case 2:
                post = _a.sent();
                return [2 /*return*/, response_1.default.succ(resp, { data: "check OK" })];
            case 3: return [2 /*return*/, response_1.default.fail(resp, exception_1.default.BadRequestError('BAD_REQUEST', 'No permission.', null))];
