...
var shopee_1 = require("../services/shopee");
...
router.post('/getAuth', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
...
router.post('/getToken', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
router.get('/sync-status', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, response_1.default.succ(resp, {
                result: shopee_1.Shopee.getItemProgress.find(function (dd) {
                    return dd === req.get('g-app');
                }) !== undefined
            })];
    });
}); });
router.post('/getItemList', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var itemList, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                if (_a.sent()) {
                    ...
                    itemList = new shopee_1.Shopee(req.get('g-app'), req.body.token).getItemList(req.body.start, req.body.end);
                    itemList.then(function () {
                        shopee_1.Shopee.getItemProgress = shopee_1.Shopee.getItemProgress.filter(function (dd) {
                            return dd !== req.get('g-app');
                        });
                    }).catch(function () {
                        shopee_1.Shopee.getItemProgress = shopee_1.Shopee.getItemProgress.filter(function (dd) {
...
router.post('/syncStock', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var res, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, new shopee_1.Shopee(req.get('g-app'), req.body.token).asyncStockFromShopnex()];
            case 1:
                res = _a.sent();
                return [2 /*return*/, response_1.default.succ(resp, {
                        "result": "OK",
...
['post', 'get'].map(function (dd) {
    router[dd]('/stock-hook', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
