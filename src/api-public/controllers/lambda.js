    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, post.lambda(req.query, req.body.router, postData, 'post')];
            case 1:
                data = (_a.sent());
...
router.get('/', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var post, postData, data, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                post = new post_1.Post(req.get('g-app'), req.body.token);
                postData = req.query.data;
                return [4 /*yield*/, post.lambda(req.query, req.query.router, postData, 'get')];
            case 1:
                data = (_a.sent());
                return [2 /*return*/, response_1.default.succ(resp, data)];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                post = new post_1.Post(req.get('g-app'), req.body.token);
                postData = req.body.data;
                return [4 /*yield*/, post.lambda(req.query, req.body.router, postData, 'delete')];
            case 1:
                data = (_a.sent());
                return [2 /*return*/, response_1.default.succ(resp, data)];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                post = new post_1.Post(req.get('g-app'), req.body.token);
                postData = req.body.data;
                return [4 /*yield*/, post.lambda(req.query, req.body.router, postData, 'put')];
            case 1:
                data = (_a.sent());
                return [2 /*return*/, response_1.default.succ(resp, data)];
            case 2:
