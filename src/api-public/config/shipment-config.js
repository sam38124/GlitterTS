...
exports.ShipmentConfig = void 0;
class ShipmentConfig {
}
exports.ShipmentConfig = ShipmentConfig;
ShipmentConfig.list = [
    {
        title: '黑貓宅配',
        value: 'black_cat',
...
ShipmentConfig.supportPrintList = ['FAMIC2C', 'UNIMARTC2C', 'HILIFEC2C', 'OKMARTC2C', 'normal', 'black_cat', 'black_cat_ice', 'UNIMARTFREEZE', 'black_cat_freezing'];
