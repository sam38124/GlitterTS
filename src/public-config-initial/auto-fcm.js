...
class AutoFcm {
    ...
    static async orderChangeInfo(obj) {
        ...
        if (userData) {
            ...
            const appData = await new user_js_1.User(obj.app).getConfigV2({
                key: 'store-information',
                user_id: 'manager',
            });
            await new firebase_js_1.Firebase(obj.app).sendMessage({
...
//# sourceMappingURL=auto-fcm.js.map