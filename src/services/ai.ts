...
export class Ai {
    ...
    public static defaultResponse = [
        ...
        },
        {
            ...
            response: '請前往商品設定的「商品訊息」，在基本資訊欄位可填寫商家資料，作為對外宣傳與首頁資訊',
        },
        {
            tags: ['商店設定'],
            keywords: ['SEO', '圖示', '縮圖'],
            response: '請前往商品設定的「商品訊息」，在SEO欄位可填寫商家在網頁上的SEO設定與圖片，並自訂網域、Google Analytics(GA4)、代碼管理工具',
        },
        {
            tags: ['金流'],
            keywords: ['線上金流', '線下金流', '藍新', '綠界', 'atm', 'line pay', '貨到付款', '信用卡', '付款方式'],
            response: '請前往商品設定的「金流設定」，可管理線上與線下金流，無論是指定付款方式、付款告知提醒等，商家皆可自訂',
        },
        {
            tags: ['配送'],
            keywords: ['宅配', '711', '全家', 'ok', '萊爾富', '店到店', 'c2c', '物流', '配送', '交貨', '物流追蹤'],
            response: '請前往商品設定的「配送設定」，可設定啟用物流的方式，以及設定給消費者的配送說明，超商店到店請詳閱各大超商配送與價格資訊',
        },
        {
            tags: ['配送'],
            keywords: ['物流追蹤'],
            response: '請前往商品設定的「配送設定」，點擊右上角的「物流追蹤設定」，可設定綠界物流參數，設定完成即可達成物流追蹤與托運單列印功能',
        },
        {
            tags: ['運費'],
            keywords: ['級距', '重量', '材積', '公斤', '長寬高'],
            response: '請前往商品設定的「運費設定」，可以設定訂單「總材積」或「總重量」所在的級距，進而計算該訂單運費金額',
        },
        {
            tags: ['購物金'],
            keywords: ['開啟功能', '關閉功能', '新加入', '使用期限', '生日禮', '折抵上限', '允許折抵'],
            response: '請前往商品設定的「購物金設定」，可以設定消費者在訂單結帳時可使用折抵的購物金，以及新註冊加入會員或會員生日禮的購物金自動發放、訂單折抵上限、購物金使用期限等',
        },
    ];
}
