...
export class Release {
    public static async ios(cf: { appName: string; bundleID: string; appDomain: string; project_router: string; glitter_domain: string; domain_url: string }) {
        try {
    ...
    public static async android(cf: { appName: string; bundleID: string; appDomain: string; project_router: string; glitter_domain: string; domain_url: string }) {
        try {
            await Firebase.appRegister({
                appName: cf.appDomain,
                appID: cf.bundleID,
    ...
    public static async resetProjectRouter(cf: { project_router: string; targetString: string; replacementString: string }) {
    ...
    public static getHtml(cf: { appName: string; bundleID: string; appDomain: string; project_router: string; glitter_domain: string }) {
