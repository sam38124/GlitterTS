...
<div class="text-white align-items-center justify-content-center d-flex p-1 rounded" style="border: 2px dashed white;" onclick="${gvc.event(() => {
...
<div class=" bg-dark" style="width: 50px;height: 50px;"></div>
        ...
        rankingBlock: (gvc, widget, setting) => {
            var _a;
