    ...
    return {
        onCreateView: () => {
            ...
            return \`\${mvvm}\`
                                ...
                                `<h2 class="fs-lg mb-2 fw-normal fw-500">Step1. Create class and define your components.</h2>${
                                    doc.codePlace(`import {GVC} from '../glitterBundle/GVController.js';
            ...
            return gvc.bindView(() => {
                ...
                return {
                    ...
                    divCreate: {elem: 'div'}
                                ...
                                }<h2 class="fs-lg mb-2 fw-normal fw-500  mt-4">Step2. Import view component in GVController.</h2>${
                                    doc.codePlace(`import {init} from '../glitterBundle/GVController.js'
