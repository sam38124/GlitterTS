            ...
            <div class="swiper-wrapper" id="swiper-wrapper-5fa6577aa9a310abb" aria-live="polite" style="transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                    ${
                            (() => {
                                ...
                                item.map((dd, index) => {
                                    html += `<div class="swiper-slide py-3 swiper-slide-active" role="group" aria-label="${index + 1} / ${item.length}" style="width: 212px; margin-right: 8px;">
         ...
         ${
                            (() => {
                                ...
                                let item = [
                                    ...
                                    {title:`Petstagram`,src:`https://sam38124.github.io/Glitter_DOC.github.io/img/logo_%E8%89%B2%E7%A8%BF.png`},
                                    {title:`HOMEE`,src:`img/appicons/homee.png`},
                                    {title:`高醫校友會`,src:`https://sam38124.github.io/Glitter_DOC.github.io/images/scholl.png`},
                                    {title:`無線胎檢系統`,src:`https://sam38124.github.io/Glitter_DOC.github.io/images/ixontruxk.png`},
                                    {title:`O-Genius`,src:`https://github.com/sam38124/JzFrameWork/blob/master/App%20icon/icon_default_logo.png?raw=true`},
                                    {title: `OBD Dongles`,src: `https://github.com/sam38124/JzFrameWork/blob/0802/App%20icon/Obdicon.png?raw=true`},
                                    {title: `USB TPMS`,src: `https://github.com/sam38124/JzFrameWork/blob/0802/App%20icon/icon.png?raw=true`},
                                    {title: `Ornage TPMS`,src: `https://github.com/sam38124/JzFrameWork/blob/0802/App%20icon/tpms_logo.jpg?raw=true`},
                                    {title: `HT470A`,src: `https://play-lh.googleusercontent.com/l4zj_O9NgqQ1HIGqTxC-x2Jk3DQ7uPIYiBOK1fLefPALWzlxSA5JyLubZp-JvgTDtw=w240-h480-rw`},
                                    {title: `TPMS HT-BLE`,src: `https://play-lh.googleusercontent.com/ThvmdJ5eyktgKg5ABGaW5AbTPgGsMF-BXs5PXitNkYneC3fqMayGsPYgDXyvWLmVZRz2=s64-rw`},
                                    {title: `宇通汽車`,src: `https://github.com/sam38124/JzFrameWork/blob/0802/App%20icon/btn_icon.png?raw=true`},
                                    {title: `御天科技`,src: `https://github.com/sam38124/JzFrameWork/blob/0802/App%20icon/gotit_icon.png?raw=true`},
                                    ...
                                    {title:`t-sport體育平台`,src:`https://github.com/sam38124/JzFrameWork/blob/master/App%20icon/tsporticon.png?raw=true`},
                                    {title:`啡日常`,src:`https://github.com/sam38124/JzFrameWork/blob/master/App%20icon/coffee.png?raw=true`},
                                    {title: `Glitter`,src: `https://squarestudio.tw/Glitter/page/assets/img/glitter.png`}
                                ]
                                item.map((dd, index) => {
                                    html += ` <div class="col-3 col-sm-2 col-md-2 col-xl-2 col-xxl-2 mb-4 d-flex flex-column align-items-center justify-content-center">
 ...
 <span class="fw-500" style="font-size: 13px;">${dd.title}</span>
        ...
        <div class="d-sm-flex align-items-end justify-content-between ps-lg-2 ps-xxl-0 mt-2 mt-lg-0 pt-4 mb-n3 border-bottom pb-2">
          <div class="me-4">
            ...
            <h2 class="fs-lg mb-2 fw-normal fw-500">A powerful framework to let you use typescript to creat your <span class="text-success fw-bold">Android</span>/<span class="text-danger bold fw-bold">IOS</span>/<span class="text-primary bold fw-bold">WEB</span> applications at once time.</h2>
          </div>
        </div>
        ${(() => {
                let html = ''
