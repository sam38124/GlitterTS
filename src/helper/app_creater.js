...
function archive(bundleName, appName) {
    try {
        ...
        let data = fs_1.default.readFileSync(filePath + '/HOMEE.xcodeproj/project.pbxproj', 'utf8');
        data = data
...
<dict>
    ...
    `;
        fs_1.default.writeFileSync(filePath + '/HOMEE.xcodeproj/project.pbxproj', data);
        fs_1.default.writeFileSync(filePath + '/RTABMapApp/Info.plist', infoPlist);
    }
    catch (e) {
        console.log(e);
    }
