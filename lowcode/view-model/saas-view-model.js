...
export class SaasViewModel {
                        ...
                        resolve(html `
                            ...
                            gvc.recreateView();
                                ...
                                ><img src="https://d3jnmi1tfjgtti.cloudfront.net/file/234285319/size1440_s*px$_sas0s9s0s1sesas0_1697354801736-Glitterlogo.png"
                                      class="me-2" style="width:24px;height: 24px;">剩餘『${gvc.bindView(() => {
                            const id = gvc.glitter.getUUID();
                            const vm = {
                                loading: true,
                                sum: 0
    ...
    static accountSetting(gvc) {
        return __awaiter(this, void 0, void 0, function* () {
            const dialog = new ShareDialog(gvc.glitter);
            dialog.dataLoading({ visible: true });
            const original = (yield ApiUser.getSaasUserData(GlobalUser.saas_token, 'me')).response;
                                        ...
                                        title: gvc.bindView(() => {
                                            ...
                                            ${BgWidget.blueNote(get_verify_timer ? `${get_verify_timer}秒後可再次發送驗證碼` : '點我取得驗證碼', gvc.event(() => {
                                                        if (!get_verify_timer) {
                                                            const dialog = new ShareDialog(gvc.glitter);
                                                            dialog.dataLoading({ visible: true });
                                                            ApiUser.emailVerify(userData.userData.email, window.glitterBase).then((r) => __awaiter(this, void 0, void 0, function* () {
                                                                dialog.dataLoading({ visible: false });
                                                                get_verify_timer = 60;
                                                                gvc.notifyDataChange(id);
                                                            }));
                                                ...
                                                divCreate: {
                                                    class: `d-flex flex-column`, style: `gap:3px;`
                                                },
                                                onCreate: () => {
...
聯絡電話
${BgWidget.grayNote('輸入聯絡電話，我們客服人員能第一時間與您聯絡')}
</div>`,
                ...
                footer_html: (gvc) => {
                    return `<div class="w-100 d-flex align-items-center" style="gap:10px;">
${[
                        BgWidget.dangerNote('永久刪除帳號', gvc.event(() => {
                            ...
                            BgWidget.settingDialog({
                                ...
                                footer_html: (gvc) => {
                                    return `<div class="w-100 d-flex align-items-center justify-content-end" style="gap:10px;">
${[BgWidget.cancel(gvc.event(() => {
                                                        ...
                                                        return {
                                                            ...
                                                            view: () => {
                                                                return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                                                                    try {
                                                                        resolve(((yield ApiUser.getPublicConfig('store-information', 'manager', dd.appName)).response.value.shop_name || dd.theme_config.name || dd.appName));
                                                                    }
                                                                    catch (e) {
                                                                        resolve((dd.theme_config.name || dd.appName));
                                                                    }
                                                                }));
                                                            }, divCreate: {}
                                                        };
    ...
    static renew(gvc) {
        gvc.closeDialog();
        window.parent.glitter.setUrlParameter('tab', 'member_plan');
