                    ...
                    return {
                        ...
                        onCreate: () => {
                            if (ids.container && vm.loading) {
                                ApiUser.getPublicConfig('notify_setting', 'manager').then((data) => {
                                    vm.dataList = (() => {
                                            ...
                                            try {
                                                ...
                                                return defaultData.map((d) => {
                                                    ...
                                                    d.list = d.list.map((item) => {
                                                        ...
                                                        return findItem !== null && findItem !== void 0 ? findItem : item;
                                                    });
                                                    return d;
                                                });
                                            }
