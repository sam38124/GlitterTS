                                        ...
                                        return gvc.bindView({
                                            ...
                                            view: () => {
                                                ...
                                                try {
                                                    ...
                                                    const imageUrl = passType.includes(vm.type) ? dd.data : (_b = (_a = vm.link.find((data) => { var _a; return (_a = data === null || data === void 0 ? void 0 : data.tag) === null || _a === void 0 ? void 0 : _a.includes(dd.title); })) === null || _a === void 0 ? void 0 : _a.data) !== null && _b !== void 0 ? _b : noImageURL;
                                                    function itemClick() {
                                                        if (vm.type == 'folder') {
                                                            vm.tag = dd.title;
