...
var e = {
  ...
  lightBoxDestory: function () {
    e.lb=e.lb ?? []
    e.lb.map(function (dd){
      dd.destroy()
    })
  },
  // END: GLightbox
  ...
  flatPicker: function () {
    ...
    if (e.isVariableDefined(picker)) {
      ...
      element.forEach(function (item) {
        var mode =
          item.getAttribute("data-mode") == "multiple" ? "multiple" : item.getAttribute("data-mode") == "range" ? "range" : "single";
  ...
  avatarImg: function () {
    if (e.isVariableDefined(e.select("#avatarUpload"))) {
      ...
      avtReset.addEventListener("click", function () {
        avtPreview.src = "/https://storage.googleapis.com/squarestudio/img/1660293609766.png";
      });
    }
  },
  // END: Avatar Image
