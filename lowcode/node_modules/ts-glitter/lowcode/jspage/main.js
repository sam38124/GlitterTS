...
<div class="spinner-border text-dark" role="status">
  <span class="visually-hidden">Loading...</span>
                                            ...
                                            switch (mode) {
                                                ...
                                                case `code`:
                                                    return ` <textArea class="form-control " style="overflow-x: scroll;height: calc(100vh - 200px);" onchange="${gvc.event((e) => {
    ...
    <i class="fa-regular fa-circle-minus text-danger me-2" style="font-size: 20px;cursor: pointer;" onclick="${gvc.event(() => {
                                                ...
                                                case `initialCode`:
                                                    return `
                                                <textarea class="form-control " style="height: calc(100vh - 200px);" onchange="${gvc.event((e) => {
...
`;
                                                case `defaultStyle`:
                                                    return gvc.map([
                                                        ...
                                                        glitter.htmlGenerate.editeText({
                                                            gvc: gvc,
                                                            title: '頁面區塊Style',
                                                            placeHolder: `請輸入區塊Style`,
                                                            default: viewModel.data.page_config.styleText,
                                                            callback: (text) => {
                                                                viewModel.data.page_config.styleText = text;
                                                            }
                                                        }),
                                                        glitter.htmlGenerate.editeText({
                                                            gvc: gvc,
                                                            title: '頁面區塊Class',
                                                            placeHolder: `請輸入區塊Class`,
                                                            default: viewModel.data.page_config.classText,
                                                            callback: (text) => {
                                                                viewModel.data.page_config.classText = text;
                                                            }
                                                        }),
                                                        glitter.htmlGenerate.editeText({
                                                            gvc: gvc,
  ...
  h2{font-size:25px;}                                                              
                                                                `,
                                                            default: viewModel.data.page_config.globalStyle,
                                                            callback: (text) => {
                                                                viewModel.data.page_config.globalStyle = text;
                                                            }
                                                        }),
                                                        `<button class="btn btn-warning w-100 mt-2" style="color: black;" onclick="${gvc.event(() => {
                                                            glitter.htmlGenerate.saveEvent();
