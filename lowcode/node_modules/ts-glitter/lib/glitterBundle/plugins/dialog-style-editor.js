...
const editor_elem_js_1 = require("./editor-elem.js");
const style_attr_js_1 = require("./style-attr.js");
...
${gvc.map([
                ...
                `
${editor_elem_js_1.EditorElem.h3("設計樣式")}
${gvc.bindView(() => {
...
${design.styleList.map((dd, index) => {
                                var _a, _b;
                                let title = (_b = ((_a = style_attr_js_1.styleAttr.find((d2) => {
                                    return dd.tag === d2.tag;
                                })) !== null && _a !== void 0 ? _a : {}).title) !== null && _b !== void 0 ? _b : "尚未設定";
                                return `
    ${editor_elem_js_1.EditorElem.toggleExpand({
                                    gvc: gvc, title: editor_elem_js_1.EditorElem.minusTitle(title, gvc.event(() => {
                                                ...
                                                return {
                                                    ...
                                                    view: () => {
                                                        return `<input class="form-control w-100" style="height: 40px;" placeholder="關鍵字搜尋" onfocus="${gvc.event(() => {
                                                            ...
                                                            var _a;
                                                            title = e.value;
                                                            dd.tag = ((_a = style_attr_js_1.styleAttr.find((d2) => {
...
${gvc.bindView(() => {
                                                return {
                                                    bind: id,
                                                    view: () => {
                                                        return style_attr_js_1.styleAttr.filter((d2) => {
...
${gvc.bindView(() => {
                                            return {
                                                bind: styleContainer,
                                                view: () => {
                                                    let data = (style_attr_js_1.styleAttr.find((d2) => {
                                                        return dd.tag === d2.tag;
                                                    }));
                                                    if (data) {
...
${editor_elem_js_1.EditorElem.plusBtn("添加特徵", gvc.event((e, event) => {
