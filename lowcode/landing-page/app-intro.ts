...
font-family: 'Noto Sans';
        ...
        `
        //     <div style="background: #FFF9F2;padding-top: 67px;padding-bottom: 55px;gap:175px;" class="d-flex align-items-center justify-content-center" >
        // <div class="d-flex align-items-center justify-content-center" style="max-width: 1100px;">
        // <img src="${new URL('./icon/step1.svg',import.meta.url).href}" style="width: 495px">
        //     </div>
        //     <div class="d-flex flex-column" style="gap: 12px;width: 469px;max-width: 100%;">
        // <div style="width: 469px"><span style="color: #FFB400; font-size: 42px; font-weight: 700; line-height: 58.80px; word-wrap: break-word">隨時隨地</span><span style="color: #393939; font-size: 42px;  font-weight: 700; line-height: 58.80px; word-wrap: break-word">掌握銷售狀況</span></div>
        // <div style="color: #393939;
        // font-size: 20px;
        // font-style: normal;
        // font-weight: 500;
        // line-height: 140%; /* 28px */
        // letter-spacing: 1.2px;">透過APP隨時查看店鋪銷售數據、訂單狀態、處理退換貨、管理庫存，所有訂單資訊一目了然。</div>
        // </div>
        // </div>
    }
}
...
(window as any).glitter.setModule(import.meta.url, AppIntro);