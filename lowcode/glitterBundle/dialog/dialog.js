        ...
        onCreateView: () => {
            ...
            try {
                switch (gBundle.type) {
                    case 'dataLoading':
                        return html `
                            <div class="dialog-box" style="${gBundle.obj.BG ? `background:${gBundle.obj.BG}` : ''} ">
                                <div class="dialog-content">
                                    <div class="spinner-border fs-1"></div>
                                    <div class="mt-3 fs-6 fw-500">${(_a = gBundle.obj.text) !== null && _a !== void 0 ? _a : Language.text('please_wait')}
                                    </div>
                                </div>
                            </div>`;
                    case 'infoMessage':
                        return html `
                            <div class="dialog-box">
                                <div class="dialog-content position-relative pb-5">
                                    ...
                                    <div class="my-3 fs-6 fw-500" style="white-space: normal; overflow-wrap: anywhere;">
                                        ${(_b = gBundle.obj.text) !== null && _b !== void 0 ? _b : '系統提示訊息'}
                                    </div>
                        ...
                        return html `
                            <div class="dialog-box">
                                <div class="dialog-content position-relative pb-5">
                                    ...
                                    <div class="my-3 fs-6 fw-500" style="white-space: normal; overflow-wrap: anywhere;">
                                        ${(_c = gBundle.obj.text) !== null && _c !== void 0 ? _c : '發生錯誤'}
                                    </div>
                                    <div class="dialog-absolute" onclick="${gvc.event(() => {
                            gBundle.obj && gBundle.obj.callback && gBundle.obj.callback(true);
                            gvc.closeDialog();
                        })}">
                        ...
                        return html `
                            ...
                            >
                                <div class="dialog-content">
                                    ...
                                    <div class="mt-3 fs-6 fw-500" style="white-space: normal; word-break: break-all;;">
                                        ${(_d = gBundle.obj.text) !== null && _d !== void 0 ? _d : '成功'}
                                    </div>
                                </div>
                            </div>
                        `;
                            ...
                            <div class="dialog-box">
                                <div class="dialog-content position-relative pb-5" style="width: 270px;">
                                    ...
                                    <div class="my-3 fs-6 fw-500 text-center"
                                         style="white-space: normal; overflow-wrap: anywhere;">${gBundle.title}
                                    </div>
                        ...
                        return html `
                            <div class="dialog-box">
                                <div class="dialog-content position-relative"
                                     style="width: 494px;${(document.body.clientWidth < 800) ? `padding:36px 64px 26px !important;` : `padding:25px !important;`}max-width: calc(100% - 40px);">
                                    ...
                                    <div class="mt-3 mb-4 fs-6 text-center"
                                         style="white-space: normal; font-weight: 400; overflow-wrap: anywhere;">
                                        ${gBundle.title}
                                    </div>
