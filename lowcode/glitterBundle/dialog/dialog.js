                ...
                case 'dataLoading':
                    return html `<div class="dialog-box" style="${gBundle.obj.BG ? `background:${gBundle.obj.BG}` : ''} ">
                        <div class="dialog-content" >
                            ...
                            <div class="mt-3 fs-6 fw-500">${(_a = gBundle.obj.text) !== null && _a !== void 0 ? _a : Language.text('please_wait')}</div>
                        </div>
                    </div>`;
                case 'infoMessage':
                    return html `
                        <div class="dialog-box">
                            <div class="dialog-content position-relative pb-5">
                                ...
                                <div class="my-3 fs-6 fw-500" style="white-space: normal; overflow-wrap: anywhere;">${(_b = gBundle.obj.text) !== null && _b !== void 0 ? _b : '系統提示訊息'}</div>
                    ...
                    return html `
                        <div class="dialog-box">
                            <div class="dialog-content position-relative pb-5">
                                ...
                                <div class="my-3 fs-6 fw-500" style="white-space: normal; overflow-wrap: anywhere;">${(_c = gBundle.obj.text) !== null && _c !== void 0 ? _c : '發生錯誤'}</div>
                    ...
                    return html `
                        ...
                        >
                            <div class="dialog-content">
                                ...
                                <div class="mt-3 fs-6 fw-500" style="white-space: normal; word-break: break-all;;">${(_d = gBundle.obj.text) !== null && _d !== void 0 ? _d : '成功'}</div>
                            </div>
                        </div>
                    `;
                case 'checkYesOrNot':
                    return html `
                        <div class="dialog-box">
                            <div class="dialog-content position-relative pb-5" style="width: 270px;">
                                ...
                                <div class="my-3 fs-6 fw-500 text-center" style="white-space: normal; overflow-wrap: anywhere;">${gBundle.title}</div>
