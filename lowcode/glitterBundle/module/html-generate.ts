                                                                                    ...
                                                                                    return {
                                                                                        ...
                                                                                        divCreate: {
                                                                                            style: `position: relative;${gvc.glitter.htmlGenerate.styleEditor(dd, gvc, dd, {}).style()};${
                                                                                                (dd as any).visible === false ? `display:none;` : ``
                                                                                            }`,
...
`;
                                ...
                                gvc.bindView(() => {
                                    ...
                                    function getData() {
                                        if (dd.type === 'code') {
                                            data = codeComponent
                                                .render(gvc, dd, setting as any, HtmlGenerate.hover_items, subData, {
...
${e.line}
    ...
    public static selectWidget(cf: { dd: any; gvc: GVC; widgetComponentID: string; event: any; root: boolean }) {
        const dd = cf.dd;
        const gvc = cf.gvc;
