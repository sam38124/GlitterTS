                                            ...
                                            function loadWebResource() {
                                                ...
                                                try {
                                                    if ((widget.data.elem === 'link') && (widget.data.attr.find((dd: any) => {
                                                        ...
                                                        setTimeout(() => {
                                                            gvc.glitter.addStyleLink(widget.data.attr.find((dd: any) => {
                                                                return dd.attr === 'href'
                                                            }).value, document)
                                                        })
                                                        return true
                                                    } else if (((widget.data.elem === 'script')) && widget.data.attr.find((dd: any) => {
                                                        return dd.attr === 'src'
                                                    })) {
                                                        waitAddScript.push(widget.data.attr.find((dd: any) => {
                                                            return dd.attr === 'src'
                                                        }).value)
                                                        return true
                                                    }
            ...
            return gvc.bindView({
                ...
                view: () => {
                    if (loading) {
                        ...
                        return (option.setting ?? container).map((dd, index) => {
                            try {
...
`
                                                            ...
                                                            gvc.bindView(() => {
                                                                ...
                                                                function getData() {
                                                                    if (dd.type === 'code') {
                                                                        data = codeComponent.render(gvc, dd, container as any, HtmlGenerate.hover_items, subData, {
                                                                        ...
                                                                        data = widgetComponent.render(gvc, dd, container as any, HtmlGenerate.hover_items, subData, {
                                                                            widgetComponentID: gvc.glitter.getUUID(),
                                                                            root: root
                                                                        })
                                                                            .editor()
...
${e.line}
    ...
    public static renderWidgetSingle(cf: {
        widget: any,
        gvc: GVC,
        option: any,
        container: any
        ...
        function getHtml() {
            if (((cf.widget.data.elem === 'link') && (cf.widget.data.attr.find((dd: any) => {
                return cf.widget.attr === 'rel' && cf.widget.value === 'stylesheet'
            }))) || (((cf.widget.data.elem === 'script')) && cf.widget.data.attr.find((dd: any) => {
                        ...
                        function getHtml() {
                            return new Promise(async (resolve, reject) => {
                                ...
                                if (cf.widget.gCount === 'multiple') {
                                    ...
                                    resolve(data.map((subData: any) => {
                                        let option: any = []
                                        const widgetComponentID = gvc.glitter.getUUID()
                                        addCreateOption(option, widgetComponentID)
                                        return (widgetComponent.render(gvc, widget as any, container as any, HtmlGenerate.hover_items, subData, {
                                            option: option,
                                    ...
                                    const widgetComponentID = gvc.glitter.getUUID()
                                    addCreateOption(option, widgetComponentID)
                                    resolve(widgetComponent.render(gvc, widget as any, container as any, HtmlGenerate.hover_items, (widget as any).subData || sub_data, {
                                        option: option,
                                        widgetComponentID: widgetComponentID,
                                        root: root
                                    }, document)
                                ...
                                function render(subData: any) {
                                    return gvc.bindView(() => {
                                        ...
                                        return {
                                            ...
                                            divCreate: {
                                                style: `position: relative;${gvc.glitter.htmlGenerate.styleEditor(widget, gvc, widget, {}).style()};${((widget as any).visible === false) ? `display:none;` : ``}`,
    ...
    public static getEditorSelectSection(cf: {
        ...
        const gvc = cf.gvc;
        const widget = (window.parent as any).glitter.share.findWidgetIndex(cf.id).widget;
        return [(() => {
            if (widget && widget.type === 'container' && widget.data.setting && widget.data.setting.length === 0) {
                ...
                return html`
                    ...
                    (window.parent as any).glitter.getModule(new URL(gvc.glitter.root_path + 'editor/add-component.js').href, (AddComponent: any) => {
    ...
    public static deleteWidget(container_items: any, item: any) {
        ...
        const gvc = (window.parent as any).glitter.pageConfig[0].gvc;
        ...
        if (container_items.length === 0 && (!(container as any).className.includes('editor_it_MainView'))) {
            container.recreateView()
        }
        (window as any).glitter.share.editorViewModel.selectItem = undefined;
        gvc.notifyDataChange(['right_NAV', 'MainEditorLeft']);
    }
