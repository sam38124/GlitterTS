                                                                            ...
                                                                            key: "onclick", value: (() => {
                                                                                ...
                                                                                function selectEvent(event: any) {
                                                                                    try {
                                                                                        ...
                                                                                        if ((dd as any).selectEditEvent && (dd as any).selectEditEvent()) {
                                                                    ...
                                                                    return gvc.bindView(() => {
                                                                        ...
                                                                        return {
                                                                            ...
                                                                            divCreate: {
                                                                                ...
                                                                                class: `${dd.class ?? ''} ${(dd.hashTag) ? `glitterTag${dd.hashTag}` : ''} ${(hover.indexOf(dd.id) !== -1) && isEditMode() ? ` selectComponentHover` : ``}
