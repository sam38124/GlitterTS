...
${addNewlineAfterSemicolon(obj.initial)}
                        ...
                        if (obj.dontRefactor) {
                            ...
                            const cb = array.filter((dd, index) => {
...
${(_a = obj.initial) !== null && _a !== void 0 ? _a : ""}
                        ...
                        const array = event.data.data.value.split('\n');
                        const data = array.filter((dd, index) => {
                            return index !== 0 && index !== (array.length - 1);
                        }).join('\n');
                        obj.initial = data;
                        obj.callback(data);
...
`;
    ...
    static folderLineItems(obj) {
        ...
        return gvc.bindView(() => {
            ...
            return {
                bind: parId,
                view: () => {
                    return obj.viewArray.map((dd, index) => {
  ...
  padding: 0;
        ...
        return gvc.glitter.innerDialog((gvc) => {
            ...
            <div class="dropdown-menu mx-0 position-fixed pb-0 border p-0 show "
                ...
                1900: 1600
                    ...
                    <h3 style="font-size:15px;font-weight:500;" class="m-0">
                        ${title !== null && title !== void 0 ? title : `代碼編輯`}</h3>
                    <div class="flex-fill"></div>
                    <div class="hoverBtn p-2" data-bs-toggle="dropdown"
                         aria-haspopup="true" aria-expanded="false"
                         style="color:black;font-size:20px;"
    ...
    static btnGroup(obj) {
        ...
        let interval = undefined;
        return html `
            <div class="position-relative btn-group dropend subBt my-auto ms-1 ${(_a = obj.classS) !== null && _a !== void 0 ? _a : ""}" style="${(_b = obj.style) !== null && _b !== void 0 ? _b : ""}"
