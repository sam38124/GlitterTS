                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <button
                                                            ...
                                                            type="button"
                                                            onclick="${obj.gvc.event(() => {
                                                                (window as any).glitter.getModule(obj.gvc.glitter.root_path + `backend-manager/bg-widget.js`, async (BgWidget: any) => {
...
${obj.structEnd ? obj.structEnd : '})()'}`,
    ...
    public static richTextBtn(obj: {
        ...
        return html`
            <div class="fw-normal mt-2 fs-6" style="color: black; margin-bottom: 5px; white-space: normal;">
                ${obj.title}
            </div>
            <div
                    class="w-100"
            ...
            <button
                    ...
                    onclick="${par.gvc.event(() => {
                        ...
                        NormalPageEditor.toggle({
                            visible: true,
                            view: html`
                                <div class="p-2" style="overflow-y:auto;">${par.dialog(gvc)}</div>`,
                            title: par.editTitle || '',
                        });
