...
${obj.structEnd ? obj.structEnd : '})()'}`,
    ...
    public static richText(obj: {
        ...
        return gvc.bindView(() => {
            ...
            gvc.addStyleLink([new URL(`../../jslib/froala/css/plugins/code_view.css` , import.meta.url).href,
...
return false
                                        ...
                                        'image.beforePasteUpload':(e:any, images:any)=>{
                                            ...
                                            glitter.share.wait_up_f_timer=setTimeout(()=>{
                                                const dialog = new ShareDialog(obj.gvc.glitter);
                                                dialog.dataLoading({visible: true});
                                                saasConfig.api.uploadFileAll( glitter.share.wait_up_f.map((dd:any)=>{
                                                    return dd.file
                                                    ...
                                                    console.log(`res.links-->`,res.links)
