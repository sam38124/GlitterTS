...
export class PaymentPage {
    ...
    static main(obj) {
        ...
        obj.ogOrderData.pos_info = obj.ogOrderData.pos_info || {
            payment: [{ method: 'cash', total: 0 }],
        };
        obj.ogOrderData.orderID = obj.ogOrderData.orderID || `${Date.now()}`;
        obj.ogOrderData.use_rebate = Number(obj.ogOrderData.use_rebate) || 0;
        const payments = (_a = obj.ogOrderData.pos_info.payment) !== null && _a !== void 0 ? _a : [];
        payments.forEach((payment) => {
            payment.paied = payment.total > 0;
        });
        obj.ogOrderData.pos_info.payment = payments;
        return gvc.bindView(() => {
                ...
                view: () => __awaiter(this, void 0, void 0, function* () {
                    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const orderDetail = yield (() => __awaiter(this, void 0, void 0, function* () {
                            ...
                            const shipmentSupport = PaymentPage.shipment_support(orderDetail);
                            const shipmentValid = shipmentSupport.some((dd) => dd.value === userInfo.shipment);
                            if (!shipmentValid) {
                                userInfo.shipment = 'now';
                            }
                            obj.ogOrderData.lineItems = obj.ogOrderData.lineItems.filter((dd) => orderDetail.lineItems.some((d1) => {
                        ...
                        resolve(html ` <div
                            ...
                            : `padding:24px;border-radius: 10px;background: #FFF;box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.08);margin-top:32px;`}"
                                    >
                                        <div class="d-none d-sm-flex" style="padding:15px 0;background: #F6F6F6;border-radius: 10px;font-weight: 700;">
                                ...
                                return orderDetail.lineItems
                                    ...
                                    return html `
                                        ...
                                        : ''}
                                                                    ...
                                                                    <div class="col-2 d-flex align-items-center justify-content-center">${document.body.clientWidth < 800 ? `x` : ''}${data.count}</div>
                            ...
                            return {
                                ...
                                divCreate: {
                                    ...
                                    ${BgWidget.mainCard(BgWidget.textArea({
                            gvc: gvc,
                            title: '',
                            ...
                            if (['FAMIC2C', 'HILIFEC2C', 'OKMARTC2C', 'UNIMARTC2C'].includes(obj.ogOrderData.user_info.shipment)) {
                                return html `<div class="mb-2" style="margin-top: 14px;font-size: 18px;font-weight: 700;letter-spacing: 0.72px;">門市選擇</div>
                                                <div
                                                    class="btn  w-100 text-white"
                                                    style="background: ${decodeURI(gvc.glitter.getUrlParameter('CVSStoreName') || '') ? `#393939` : `#d6293e`};"
                                                    onclick="${gvc.event(() => {
                                    PaymentPage.storeHistory(obj.ogOrderData);
                            ...
                            if (obj.ogOrderData.user_info.shipment === 'now') {
                                ...
                                return html ` ${PaymentPage.spaceView()}
                                                <div class="mb-2" style="margin-top: 14px;font-size: 18px;font-weight: 700;letter-spacing: 0.72px;">配送資訊</div>
                                    ...
                                    return html `<div class="mb-2 col-${dd.col} ps-0">
                                                                <div>
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        type="${dd.type}"
                                                                        value="${obj.ogOrderData.user_info[dd.key] || ''}"
                                                                        onchange="${gvc.event((e, event) => {
                                        ...
                                        ${[
                            {
                                title: '小計總額',
                                hint: '',
                                value: (Number(orderDetail.total) + Number(orderDetail.discount) - Number(orderDetail.shipment_fee) + Number(orderDetail.use_rebate)).toLocaleString(),
                            },
                            ...(() => {
                            ...
                            ...(() => {
                                return orderDetail.voucherList.map((dd) => {
                                    return {
                                        hint: dd.title,
                                        value: html `<div class="d-flex align-items-center" style="gap:5px;">
                            ...
                            .map((dd) => {
                            return html ` <div class="w-100" style="justify-content: flex-start; align-items: center; gap: 10px; display: inline-flex;">
                                                    <div style="flex: 1 1 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; display: inline-flex">
                                                        <div style="align-self: stretch; color: #393939; font-size: 18px;  text-transform: uppercase; letter-spacing: 0.72px; word-wrap: break-word">
                                                            ${dd.title}
                                                        </div>
                                                        <div
                            ...
                            .join('')}
                                        <div class="my-1"></div>
                                        ${PosWidget.buttonSnow('新增優惠折扣', gvc.event(() => {
                            ...
                            return {
                                ...
                                view: () => {
                                            ...
                                            view: () => {
                                                if (obj.ogOrderData.pos_info.payment.length === 1 && !obj.ogOrderData.pos_info.payment[0].paied) {
                                                    ...
                                                    return html `<div class="w-100 d-flex flex-column">
                                                                    ...
                                                                    ${obj.ogOrderData.pos_info.payment
                                                        .map((dd, index) => {
                                                        return html ` <div class="d-flex align-items-center justify-content-center w-100 mt-lg-4 mt-2" style="height:50px;">
                                                                                <div class="d-flex" style="flex:68;color:#36B;cursor: pointer;" onclick="${gvc.event(() => { })}">
                                                                                    ${(() => {
                                                            switch (dd.method) {
                                                                case 'cash':
                                                                    return `現金`;
                                    ...
                                    function paymentNext(pre_order) {
                                        ...
                                        const passData = JSON.parse(JSON.stringify(orderDetail));
                                        ...
                                        if (obj.ogOrderData.pos_info.payment.length === 1 &&
                                            ...
                                            if (obj.ogOrderData.pos_info.payment.find((dd) => dd.method === 'cash')) {
                                            ...
                                            else if (obj.ogOrderData.pos_info.payment.find((dd) => dd.method === 'creditCard')) {
                                            ...
                                            else if (obj.ogOrderData.pos_info.payment.find((dd) => dd.method === 'line')) {
                                    ...
                                    view.push(html `
                                                    <div style="margin-top: 32px;gap:15px;" class="d-flex align-items-center">
                                                        <div
    ...
    static enterCodeEvent(gvc, orderDetail, code, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            const dialog = new ShareDialog(gvc.glitter);
            orderDetail.code_array = orderDetail.code_array || [];
            orderDetail.code_array = orderDetail.code_array.filter((dd) => dd !== code);
            orderDetail.code_array.push(code);
            dialog.dataLoading({ visible: true });
            const od = yield this.checkout({
            ...
            dialog.dataLoading({ visible: false });
            const isValidCode = od && od.voucherList.some((dd) => dd.code === code);
            if (!isValidCode) {
                orderDetail.code_array = orderDetail.code_array.filter((dd) => dd !== code);
                ...
                gvc.closeDialog();
                orderDetail.code_array = od.voucherList.filter((item) => item.code.length > 0).map((item) => item.code);
    ...
    static scanVoucher(gvc, orderDetail, reload) {
        ...
        gvc.glitter.innerDialog((gvc) => {
            function next() {
                return __awaiter(this, void 0, void 0, function* () {
                    yield PaymentPage.enterCodeEvent(gvc, orderDetail, c_vm.value, reload);
                });
            }
            return html `
                ...
                gvc.glitter.runJsInterFace('start_scan', {}, (res) => {
                    ...
                    next();
                            ...
                            <div class="d-flex align-items-center justify-content-center w-100" style="margin-top: 24px;font-size: 16px;font-weight: 700;letter-spacing: 0.64px;">
                                <div
                                    class="flex-fill"
    ...
    static selectInvoice(gvc, orderDetail, vm, passData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            function next() {
                const { invoice_select, value } = c_vm;
                if (invoice_select === 'carry') {
                    if (!value) {
                ...
                else if (invoice_select === 'company') {
                    if (!value) {
                ...
                if (orderDetail.user_info.shipment === 'normal') {
                    ...
                    ['CVSAddress', 'CVSOutSide', 'CVSStoreID', 'CVSStoreName', 'LogisticsSubType'].forEach((dd) => {
                        passData.user_info[dd] = decodeURIComponent(gvc.glitter.getUrlParameter(dd));
                    });
                }
                gvc.glitter.closeDiaLog();
                dialog.dataLoading({ visible: true, text: `訂單成立中` });
                ...
                passData.invoice_select = invoice_select;
                passData.use_rebate = orderDetail.use_rebate;
                ...
                ApiShop.toPOSCheckout(passData).then((res) => __awaiter(this, void 0, void 0, function* () {
                    dialog.dataLoading({ visible: false });
                    if (!res.result) {
                        const errorMessage = invoice_select === 'company' ? '請確認統編是否輸入正確' : invoice_select === 'carry' ? '請確認載具是否輸入正確' : '開立異常，請確認發票配號是否足夠';
                        dialog.errorMessage({ text: errorMessage });
                    }
                    else {
                        handleSuccessfulCheckout(res);
                    }
                }));
            }
            function handleSuccessfulCheckout(res) {
                PaymentPage.clearHistory();
                const glitter = gvc.glitter;
                const invoice = res.response.data.invoice;
                if (invoice && (PayConfig.deviceType === 'pos' || ConnectionMode.on_connected_device) && c_vm.invoice_select !== 'carry' && c_vm.invoice_select !== 'nouse') {
                    POSSetting.config.pickup_number++;
                    printInvoice(invoice, res.response.data.orderID, glitter);
                }
                orderDetail.lineItems = [];
                gvc.glitter.share.clearOrderData();
                vm.type = 'menu';
                gvc.glitter.innerDialog((gvc) => createSuccessDialog(gvc), 'orderFinish', { dismiss: () => { } });
            }
            function printInvoice(invoice, orderID, glitter) {
                if (PayConfig.deviceType === 'pos') {
                    IminModule.printInvoice(invoice, orderID, glitter.share.staff_title);
                }
                else {
            ...
            function createSuccessDialog(gvc) {
                return html `
                <div class="w-100 h-100 d-flex align-items-center justify-content-center" onclick="${gvc.event(() => gvc.closeDialog())}">
                    <div
                    ...
                    >
                        ...
                        <div style="text-align: center; color: #393939; font-size: 16px; font-weight: 400; line-height: 160%; margin-top: 24px;">訂單新增成功！</div>
                    </div>
                </div>
            `;
            }
            const invoiceTypeResponse = yield ApiShop.getInvoiceType();
            const isNoInvoice = invoiceTypeResponse.response.method === 'nouse';
            const totalPayment = orderDetail.pos_info.payment.reduce((accumulator, payment) => accumulator + payment.total, 0);
            const isPaymentLessThanTotal = totalPayment < orderDetail.total;
            if (isNoInvoice || isPaymentLessThanTotal) {
                ...
                gvc.glitter.innerDialog((gvc) => {
                    return html `
                            ...
                            return html `
                                                    <div class="col-6  mb-4">
                                                        <div
                                                            ...
                                                            style="padding:  20px;border-radius: 10px;background: #F6F6F6;${c_vm.invoice_select == btn.value
                                ? `color:#393939;border-radius: 10px;border: 3px solid #393939;box-shadow: 2px 2px 15px 0px rgba(0, 0, 0, 0.20);`
                                : 'color:#8D8D8D;'} "
                                                            onclick="${gvc.event(() => {
                        ...
                        if (c_vm.invoice_select === 'carry') {
                            return html `<div class="d-flex w-100 align-items-center mt-3" style="border:1px solid grey;height: 50px;">
                                            <input
                                                class="form-control h-100"
                                                style="border: none;"
