                ...
                view: () => {
                    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const orderDetail = yield (() => __awaiter(this, void 0, void 0, function* () {
                            ...
                            if (!PaymentPage.shipmentSupport(orderDetail).find((dd) => {
                                            ...
                                            return {
                                                ...
                                                view: () => {
                                                    return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                                                        var _a;
                                                        const formList = FormCheck.initialRegisterForm((_a = (yield ApiUser.getPublicConfig('custom_form_register', 'manager')).response.value.list) !== null && _a !== void 0 ? _a : []);
                                                        let need_check = {};
                                                        ...
                                                        resolve(form_array_view.join(`<div class="my-4 border"></div>`) +
                                                            html `<div class="d-flex align-content-end justify-content-end pt-3">
                                                                ...
                                                                const [email_count, phone_count] = yield Promise.all([
                                        ...
                                        value: html `<div class="d-flex align-items-center" style="gap:5px;">
                                            ...
                                            dialog.checkYesOrNot({
                                                ...
                                                callback: (response) => {
                                                    if (response) {
                                                        if (dd.id === 0) {
                                                            obj.ogOrderData.voucherList = obj.ogOrderData.voucherList.filter((dd) => {
                                                                return dd.id !== 0;
                                                            });
                                                            gvc.notifyDataChange(id);
                                                        }
