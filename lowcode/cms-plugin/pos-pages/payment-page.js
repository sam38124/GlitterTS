...
text-transform: uppercase;">NT.${parseInt(data.sale_price, 10).toLocaleString()}</div>`
                                    : ``}
                                                            ...
                                                            <div class="col-2 d-none d-sm-flex align-items-center justify-content-start">$${parseInt(data.sale_price, 10).toLocaleString()}</div>
                                        ...
                                        return {
                                            ...
                                            view: () => {
                                                return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                                                    ...
                                                    const form_array_view = [html ` <div style="display:flex; gap: 12px; flex-direction: column;">${loopForm(data, userData)}</div>`];
