...
line-height: normal;
letter-spacing: 0.64px;
text-transform: uppercase;">NT.${parseInt(data.sale_price as any, 10).toLocaleString()}    ${document.body.clientWidth < 800 ? `x` : ``} ${data.count}</div>`
                                                                                    : ``}
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            return {
                                                                ...
                                                                view: () => {
                                                                    return new Promise(async (resolve) => {
                                                                        ...
                                                                        // 預設用戶表單
                                                                        const form_array_view: any = [html`
...
background: #EAEAEA;box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.15);`,
                            ...
                            >
                                ...
                                <div class="mb-2" style="font-size: 18px;font-weight: 700;letter-spacing: 0.72px;">
                                    配送方式
                                </div>
                                ${EditorElem.select({
                                    title: '',
                                                                        ...
                                                                        return html`
                                                                            ...
                                                                            >
                                                                                <div style="width: 28px;height: 28px;">
                                                                                    ${drawIcon(obj.ogOrderData.pos_info.payment.find((dd: any) => {
                                                                                        return dd.method === btn.value
                                                                                    }) !== undefined, btn.value)}
                                                                                </div>
...
${
                                                                    obj.ogOrderData.pos_info.payment.map((dd: any, index: number) => {
                                                                        return html`
                                                                            <div class="d-flex align-items-center justify-content-center w-100 mt-lg-4 mt-2"
                                                                                ...
                                                                                <div class="d-flex" style="flex:34;">
                                                                                    ${(!dd.paied) ? BgWidget.save(gvc.event(() => {
                                                                                        switch (dd.method) {
                                                                                            case 'cash':
                                            ...
                                            const total = obj.ogOrderData.pos_info.payment.map((dd: any) => {
                                                return dd.total
                                                ...
                                                <div class="d-flex" style="gap:18px;">
                                                    ${
                                                            ([
                                                                ...
                                                                return html`
                                                                    <div style="flex:1;height: 87px; padding: 14px 16px;background: white; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.08); border-radius: 10px; border: 1px #DDDDDD solid; flex-direction: column; justify-content: center; align-items: center; gap: 4px; display: inline-flex">
                                                                        <div style="text-align: center; color: #393939; font-size: 16px; font-weight: 400; line-height: 22.40px; letter-spacing: 0.64px; word-wrap: break-word">
                                                                            ${dd.title}
                                                                        </div>
                                                                        <div style="color: ${dd.color}; font-size: 24px;  font-weight: 700; text-transform: uppercase; letter-spacing: 0.96px; word-wrap: break-word">
                                                                            ${dd.value}
                                                                        </div>
                                                                    </div>`
                                                            }).join('')
                                            ...
                                            function paymentNext(pre_order: boolean) {
                                                ...
                                                //只有一種付款方式時結帳付款
                                                if (obj.ogOrderData.pos_info.payment.length === 1 && obj.ogOrderData.pos_info.payment.find((dd: any) => {
                                                    return !dd.paied
                                                })) {
                                                    if (obj.ogOrderData.pos_info.payment.find((dd: any) => {
                                                    ...
                                                    } else if (obj.ogOrderData.pos_info.payment.find((dd: any) => {
                                                    ...
                                                    <div
                                                            ...
                                                            onclick="${gvc.event(() => {
                                                                if ((total - parseInt(orderDetail.total as any, 10)) < 0) {
                                                                    ...
                                                                    return;
                                                                } else if ((obj.ogOrderData.pos_info.payment.length > 1) && (obj.ogOrderData.pos_info.payment.find((dd: any) => {
                                                                    return !dd.paied
                                                                }))) {
                                                                    dialog.errorMessage({
                                                                        text: `請結清所有款項`
                                                                    ...
                                                                    return;
                                                                } else if (orderDetail.lineItems.find((dd: any) => {
                                                                    return dd.pre_order
                                                                })) {
                                                                    dialog.errorMessage({
                                                                        text: `庫存不足，請建立預購單`
    ...
    public static async selectInvoice(gvc: GVC, orderDetail: any, vm: any, passData: any) {
        ...
        if ((await ApiShop.getInvoiceType()).response.method === 'nouse'
            || (orderDetail.pos_info.payment.map((dd: any) => {
                return dd.total
