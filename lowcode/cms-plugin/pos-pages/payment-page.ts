            ...
            return {
                ...
                view: async () => {
                    ...
                    const orderDetail = await (async () => {
                        ...
                        if (
                            !PaymentPage.shipment_support(orderDetail).find((dd) => {
                    ...
                    return html` <div
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="d-flex flex-column" style="${document.body.offsetWidth < 800 ? `` : `padding-top: 26px;`}">
                                    ${(() => {
                                                    ...
                                                    return html`
                                                        <div class="d-flex" style="">
                                                            <div class="col-8 col-sm-6 d-flex align-items-center">
                                                                ...
                                                                <div class="d-flex flex-column" style="font-size: 16px;font-style: normal;font-weight: 500;letter-spacing: 0.64px;margin-left: 12px;">
                                                                    ${data.title}
                                                                    <span
                                                                        style="color: #949494;
                                                                                font-size: 16px;
...
text-transform: uppercase;">NT.${parseInt(data.sale_price as any, 10).toLocaleString()}</div>`
                                                            ...
                                                            <div class="col-2 d-none d-sm-flex align-items-center justify-content-start">$${parseInt(data.sale_price as any, 10).toLocaleString()}</div>
                            ...
                            ${gvc.bindView(() => {
                                ...
                                return {
                                    ...
                                    <div class="w-100 d-flex align-items-center justify-content-center" style="cursor:pointer;flex:1; height: 65px; ${
                                        vm.type === 'old'
...
background: #FFF;`
                                    ...
                                    <div class="w-100 d-flex align-items-center justify-content-center"
                                         style="cursor:pointer;flex:1; height: 65px;${
                                             vm.type === 'new'
                                                                            ...
                                                                            BgWidget.selectDropDialog({
                                                                                ...
                                                                                custom_line_items: (data: any) => {
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        >
                                                                                            <div style="color: white; font-size: 16px;  font-weight: 700; word-wrap: break-word">${data.tag_name}</div>
                                                                                        </div>
                                                                                    </div>`;
                                                                                },
                                                                                default: [''],
  ...
  <div style="color: #8D8D8D; font-size: 16px;  font-weight: 400; word-wrap: break-word">${(() => {
      ...
      if (leadData.og.condition.type === 'total') {
          ...
          return `*單筆消費達${condition_val}`;
                                                ...
                                                .map((dd) => {
                                                    return html` <div style="align-self: stretch; justify-content: flex-start; align-items: center; gap: 2px; display: flex">
                                                        <div style="color: #393939; font-size: 18px;  font-weight: 400; word-wrap: break-word;min-width: 113px;">${dd.title}</div>
                                                        <div class="flex-fill"></div>
                                                        <div style="color: #393939; font-size: 18px;  font-weight: 400; word-break: break-all;white-space: normal;text-align: right;">${dd.value}</div>
                                                    </div>`;
                                                })
                                                .join('')}
                                        </div>`;
                                                    ...
                                                    return {
                                                        ...
                                                        view: () => {
                                                            return new Promise(async (resolve) => {
                                                                ...
                                                                // 預設用戶表單
                                                                const form_array_view: any = [html` <div style="display:flex; gap: 12px; flex-direction: column;">${loopForm(data, userData)}</div>`];
...
background: #EAEAEA;box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.15);`,
                        ...
                        >
                            ...
                            <div style="margin-top: 24px;font-size: 18px;font-weight: 700;letter-spacing: 0.72px;">付款方式</div>
                            ${gvc.bindView({
                                bind: 'payment',
                                    ...
                                    return btnArray
                                        .map((btn) => {
                                            return html`
                                                ...
                                                >
                                                    <div style="width: 28px;height: 28px;">${drawIcon(vm.paySelect == btn.value, btn.value)}</div>
                    ...
                    <div class="dialog-box">
                        <div class="dialog-content position-relative pb-5" style="width: 452px;max-width: calc(100% - 20px);">
                            ...
                            <div style="font-size: 18px;font-style: normal;font-weight: 400;line-height: 160%;letter-spacing: 0.72px;">
                                本次結帳金額為 <span style="font-size: 28px;font-style: normal;font-weight: 700;line-height: 160%;">$${orderDetail.total.toLocaleString()}</span>
                            </div>
