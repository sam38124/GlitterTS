                                        ...
                                        .map((data) => {
                                            ...
                                            return html`
                                                                                                        ...
                                                                                                        option: [
                                                                                                            {
                                                                                                                ...
                                                                                                                value: gvc.event(() => {
                                                                                                                    function next() {
                                                                                                                        ...
                                                                                                                        if (addItem) {
                                                                                                                            addItem.count += parseInt(`${count ?? 0}`, 10);
                                                                                                                        } else {
                                                ...
                                                >
                                                    <div
                                                        class="w-100"
                                                        style="border-radius: 10px 10px 0 0;;padding-bottom: 116px;background: 50%/cover no-repeat url('${data.content.preview_image[0] ??
                                                        image ??
                                                        image}');"
                                                    ></div>
