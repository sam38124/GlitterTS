...
export class PosHomePage {
    public static main(gvc: GVC) {
        ...
        return gvc.bindView(() => {
            ...
            ApiShop.ecDataAnalyze('order_today,hot_products_today,sales,orders,orders_per_month,recent_active_user,recent_sales,recent_orders,hot_products,order_avg_sale_price,sales_per_month_1_year,orders_per_month_1_year'.split(',')).then(async (res) => {
                vm.loading = false
