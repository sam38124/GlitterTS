                        ...
                        return html `
                            ...
                            return html `
                                                <div style="justify-content: flex-start; align-items: center; display: inline-flex">
                                                    ${dd.map((dd) => {
                                return `<div style="height:56px;width:95px;flex-direction: column; justify-content: center; align-items: center; gap: 10px; display: inline-flex" onclick="${gvc.event(() => {
                                    if (dd === '取消') {
                                        gvc.closeDialog();
                                        return;
                                    }
                    ...
                    view: () => {
                        return html `
                            ...
                            event.stopPropagation();
                                ...
                                ${gvc.glitter.share.store_list.filter((dd) => {
...
${(() => {
                                    ...
                                    return btnArray
                                        ...
                                        return html `
                                                <div
                                                        style="flex:1;display: flex;flex-direction: column;justify-content: center;align-items: center;padding: 15px 15px;border-radius: 10px;background: #F6F6F6;${method.method === btn.value
