...
export class PosFunction {
        ...
        gvc.glitter.innerDialog((gvc) => {
            ...
            return gvc.bindView(() => {
                return {
                    bind: c_vm.id,
                    view: () => {
                        return html ` <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 42px; display: inline-flex">
                            <div style="align-self: stretch; height: 100px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 18px; display: flex">
                                <div style="align-self: stretch; justify-content: center; align-items: flex-start; gap: 16px; display: inline-flex">
                                    <div style="text-align: center">
                                        <span style="color: #FFB400; font-size: 42px; font-family: Lilita One; font-weight: 400; word-wrap: break-word">SHOPNE</span
                                        ><span style="color: #FFB400; font-size: 42px; font-family: Lilita One; font-weight: 400; letter-spacing: 2.52px; word-wrap: break-word">X</span>
                                    </div>
                                ...
                                <div
                                    style="align-self: stretch; text-align: center; color: #393939; font-size: 24px; font-family: Noto Sans; font-weight: 700; line-height: 33.60px; letter-spacing: 2.40px; word-wrap: break-word"
                                >
                                    請輸入員工密碼
                                </div>
                            </div>
                            ...
                            .map((dd) => {
                            return html ` <div style="justify-content: flex-start; align-items: center; display: inline-flex">
                                                ${dd
                                .map((dd) => {
                                return html `<div
                                                            style="height:56px;width:95px;flex-direction: column; justify-content: center; align-items: center; gap: 10px; display: inline-flex"
                                                            onclick="${gvc.event(() => {
                                    if (dd === '取消') {
                                        gvc.closeDialog();
                                        return;
                                ...
                                .join(html `<div class="" style="border-right: 1px #DDDDDD solid;height:56px;"></div>`)}
                                            </div>`;
                        })
                            .join(html `<div class="" style="border-top: 1px #DDDDDD solid;height:1px; width: 100%;"></div>`)}
                                </div>
                            </div>
                        </div>`;
                    },
    ...
    static selectUserSwitch(gvc) {
        ...
        gvc.glitter.innerDialog((gvc) => {
            ...
            const mem_ = gvc.glitter.share.member_auth_list.filter((dd) => {
                        ...
                        return html ` <div
                            ...
                            return html `
                                ...
                                PosFunction.switchUser(this_gvc, dd.user);
                                            ...
                                            >
                                                <img
                                                    src="https://assets.imgix.net/~text?bg=7ED379&amp;txtclr=ffffff&amp;w=100&amp;h=100&amp;txtsize=40&amp;txt=${dd.config
                                .name}&amp;txtfont=Helvetica&amp;txtalign=middle,center"
                                                ...
                                                <div
                                                    ...
                                                    style="text-align: center; font-size: 16px; font-style: normal; font-weight: 700; background: #393939; color: white; line-height: 140%;"
                                                    onclick="${gvc.event(() => {
                        ...
                        return html ` <div
                            ...
                            return html `
                                ...
                                gvc.closeDialog();
                                            ...
                                            >
                                                <img
                                                    src="https://assets.imgix.net/~text?bg=7ED379&amp;txtclr=ffffff&amp;w=100&amp;h=100&amp;txtsize=40&amp;txt=${dd.name}&amp;txtfont=Helvetica&amp;txtalign=middle,center"
                                                    class="rounded-circle"
                                                    width="48"
                                                    alt="undefined"
                                                    style="width:40px;height:40px;"
        ...
        gvc.glitter.innerDialog((gvc) => {
            ...
            return gvc.bindView(() => {
                return {
                    bind: c_vm.id,
                    view: () => {
                        return html ` <div style="flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 20px; display: inline-flex">
                            ...
                            <div class="border w-100 p-3 rounded-3 border d-flex align-items-center justify-content-end" style="gap: 20px;">
    ...
    static selectPaymentMethod(obj) {
                    ...
                    view: () => {
                        try {
                            return [
                                ...
                                "
                                >
                                    總金額${PosWidget.bigTitle('$' + obj.orderData.total.toLocaleString())}
                                </div>`,
                                html `<div class="d-flex align-items-center justify-content-center w-100 mt-lg-4 mt-3" style="">
                                ...
                                paymentMethod
                                    .map((dd, index) => {
                                    return html ` <div class="d-flex align-items-center justify-content-center w-100 mt-lg-4 mt-1" style="height:60px;">
                                        ...
                                        PosFunction.setMoney(gvc, (money) => {
                                            ...
                                            <div class="d-flex" style="flex:68;">${!dd.paied ? `尚未付款` : `已付款`}</div>
                            ...
                            return [
                                ...
                                html `<div class="w-100 d-flex align-items-center" style="gap:5px;">
                                    ...
                                    return btnArray
                                        ...
                                        return html `
                                                    <div
                                                        style="flex:1;display: flex;flex-direction: column;justify-content: center;align-items: center;padding: 15px 15px;border-radius: 10px;background: #F6F6F6;${method.method ===
                                            btn.value
    ...
    static manualDiscount(gvc, orderDetail, reload) {
        const glitter = gvc.glitter;
        const dialog = new ShareDialog(glitter);
        const vm = {
            order: {},
                        ...
                        return [
                            ...
                            html `<div class="d-flex align-items-center justify-content-center w-100" style="margin-top: 24px;font-size: 16px;font-weight: 700;letter-spacing: 0.64px;">
                                ...
                                if (orderDetail.voucherList && Array.isArray(orderDetail.voucherList)) {
                                    const i = orderDetail.voucherList.findIndex((item) => item.id === 0);
                                    if (i !== -1) {
                    ...
                    view: () => {
                        try {
                            return [
                                ...
                                html `<div
                                    style="color: #8D8D8D; text-align: center; font-size: 16px; font-style: normal; font-weight: 400; margin-top: 8px; margin-bottom: 24px; line-height: normal;
                                "
                                >
                                    請注意，暫存訂單將保留 1 天，逾時則需重新建立。
                                </div>`,
                                html `<div class="d-flex align-items-center justify-content-center w-100 mt-lg-4 mt-1" style="">
                                    <div class="d-flex" style="flex:160;">${PosWidget.fontBold('暫存時間')}</div>
                                    <div class="d-flex" style="flex:94;">${PosWidget.fontBold('商品數量')}</div>
                                    <div class="d-flex" style="flex:54;">${PosWidget.fontBold('總金額')}</div>
                                    <div class="d-flex" style="flex:34;"></div>
                                </div>`,
                                TempOrder.getTempOrders()
                                    ...
                                    try {
                                        return html ` <div class="d-flex align-items-center justify-content-center w-100 mt-lg-4 mt-1" style="height:40px;">
                                                <div
                                                    class="d-flex"
                                                    style="flex:160;color:#36B;cursor: pointer;"
                                                    onclick="${gvc.event(() => {
                                            ...
                                            .reduce((a, b) => a + b)}
                                                ...
                                                <div class="d-flex" style="flex:54;">${dd.subtotal.toLocaleString()}</div>
                                                <div class="d-flex" style="flex:34;">
                                                    <i
