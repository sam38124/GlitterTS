        ...
        function getDatalist() {
            return vm.dataList.map((dd: any) => {
                return [
                    ...
                    {
                        key: '表單標籤',
                        value: `<span class="fs-7">${dd.content.tag.map((dd: any) => {
...
${BgWidget.searchPlace(gvc.event((e, event) => {
                                    ...
                                    ${
                                            gvc.bindView(() => {
                                                return {
                                                    ...
                                                    divCreate: () => {
                                                        return {
                                                            class: `mt-2 d-flex align-items-center p-2 py-3 ${(!vm.dataList || !vm.dataList.find((dd: any) => {
                                                                return dd.checked
                                                            })) ? `d-none` : ``}`,
                            ...
                            filter: html`
                                ...
                                gvc.bindView(() => {
                                    return {
                                        ...
                                        divCreate: () => {
                                            return {
                                                class: `d-flex align-items-center p-2 mt-2 py-3 ${(!vm.dataList || !vm.dataList.find((dd: any) => {
                                                    return dd.checked
                                                })) ? `d-none` : ``}`,
                                                style: `height:40px;gap:10px;margin-top:10px;`
                                            }
    ...
    public static formSettingDetail(cf: {
        formID: string,
        gvc: GVC,
        vm: any
    }) {
