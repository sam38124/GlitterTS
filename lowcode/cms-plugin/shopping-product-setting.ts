                        ...
                        html`
                            ...
                            <div class="d-flex flex-column flex-column-reverse  ${(obj.single) ? `flex-column-reverse`:`flex-sm-row`} w-100 p-0" style="gap:10px;">
                                <div class="leftBigArea d-flex flex-column flex-fill" style="gap: 24px;">
                                    ${!obj.single ? BgWidget.mainCard(gvc.bindView(() => {
                                    ...
                                    ${BgWidget.mainCard(html`
                                        <div class="d-flex flex-column" style="gap:18px;">
                                            ...
                                            <div class="w-100 row m-0"
                                                 style="color:#393939;">
                                                <input class="col-6" style="display: flex;height: 40px;padding: 10px 18px;align-items: center;gap: 10px;border-radius: 10px;border: 1px solid #DDD;"
                                                       placeholder="請輸入商品重量"
                                                       onchange="${gvc.event((e) => {
                        ...
                        html`
                            ...
                            <div class="d-flex flex-column flex-column-reverse flex-md-row w-100 " style="gap:10px;">
                                <div class="d-flex flex-column" style="gap: 24px;">
                                    ...
                                    ${(postMD.specs.length == 0) ? `` : BgWidget.mainCard(
...
"
                                                                                                        ...
                                                                                                        ${
                                                                                                                [{
                                                                                                                    ...
                                                                                                                    return `<div style="color:#393939;font-size: 16px;font-weight: 400;width: 20%;padding-right: 10px;">
                                                                                                        ...
                                                                                                        view: () => {
                                                                                                            return html`
                                                                                                                <div style="background-color: white;position:relative;display: flex;padding: 8px 0px;align-items: center;border-radius: 10px;width:100%;">
                                                                                                                    <div style="flex:1 0 0;font-size: 16px;font-weight: 400;gap:14px;display: flex;align-items: center;padding-left: ${postMD.specs.length > 1 ? `32px` : `18px`};">
...
color: ${((data as any).checked) ? `#393939` : `#DDD`};font-size: 18px;"
                                                                                                                        ...
                                                                                                                        <div style="background:50%/cover url('${getPreviewImage(data.preview_image)}');height: 40px;width: 40px;border-radius: 10px;border: 1px solid #DDD;"></div>
                                                                                                                        <div style="cursor: pointer;"
                                                                                                                    ...
                                                                                                                    ${['sale_price', 'stock'].map((dd) => {
                                                                                                                        return ` <div style="color:#393939;font-size: 16px;font-weight: 400;width: 20%;padding-right: 12px;">
