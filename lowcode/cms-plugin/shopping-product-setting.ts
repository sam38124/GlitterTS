...
export class ShoppingProductSetting {
    public static main(gvc: GVC) {
        ...
        const vm: {
            id: string;
            status: 'list' | 'add' | 'replace' | 'editSpec';
            dataList: any;
            query: string;
            last_scroll: number
        } = {
                        ...
                        html`
                            ...
                            <div class="d-flex flex-column flex-column-reverse  ${(obj.single) ? `flex-column-reverse` : `flex-sm-row`} w-100 p-0"
                                ...
                                <div class="leftBigArea d-flex flex-column flex-fill" style="gap: 24px;">
                                    ${!obj.single ? BgWidget.mainCardMbp0(gvc.bindView(() => {
                                            ...
                                            view: () => {
                                                return html`
                                                    ...
                                                    <div
                                                            ...
                                                            style="min-width:135px;135px;height:135px;cursor:pointer;background: 50%/cover url('${variant.preview_image || "https://nationalityforall.org/wp-content/themes/nfa/dist/images/default_image.jpg"}');"
                                                    >
                                                        <div
                                                    ...
                                                    <div style="width: 136px;text-align: center;color: #36B;cursor: pointer;"
                                                         onclick="${obj.gvc.event(() => {
                                        ...
                                        <div class="w-100" style="display: flex;gap: 18px;flex-direction: column;">
                                            ...
                                            <div class="d-flex w-100" style="gap:18px;">
                                                <div class="d-flex w-50 flex-column" style="gap: 8px;">
                                                    ...
                                                    })}" value="${variant.sale_price || '0'}" type="number">
                                                </div>
                                                <div class="d-flex w-50 flex-column" style="gap: 8px;">
                                                    <div>比較價格*</div>
                                                    <input style="width: 100%;border-radius: 10px;border: 1px solid #DDD;height: 40px;padding: 0px 18px;"
                                                    ...
                                                    })}" value="${variant.compare_price || '0'}" type="number">
                                                </div>
                                            </div>
                                            <div class="d-flex w-100" style="gap:18px;">
                                                <div class="d-flex w-50 flex-column" style="gap: 8px;">
                                                    ...
                                                    })}" value="${variant.stock || 0}" type="number">
                                                </div>
                                                <div class="d-flex w-50 flex-column" style="gap: 8px;">
                                                    <div>利潤</div>
                                                    <input style="width: 100%;border-radius: 10px;border: 1px solid #DDD;height: 40px;padding: 0px 18px;"
                                                           ...
                                                           placeholder="-" value="${variant.profit}" type="number">
                                                </div>
                                            </div>
                                        </div>
                                    `)}
                                    ${BgWidget.mainCardMbp0(html`
                                        ${gvc.bindView(() => {
                                            ...
                                            return {
                                                ...
                                                divCreate: {
                                                    class: `d-flex flex-column`, style: `gap:12px;`
                                                }
                                            }
                                        })}
                                    `)}
                                                                ...
                                                                ${variant.show_understocking != "false"
                                                                        ? `<div class="w-100 align-items-center" style="display: flex;padding-left: 8px;align-items: flex-start;gap: 14px;align-self: stretch;margin-top: 8px;">
                                                                          ...
                                                                          <div class="flex-fill d-flex flex-column" style="gap: 8px">
                                                                              <div>庫存數量</div>
                                                                              <input class="w-100" value="${variant.stock ?? "0"}" style="padding: 9px 18px;border-radius: 10px;border: 1px solid #DDD;" placeholder="請輸入庫存數量" onchange="${gvc.event((e) => {
                                                                            variant.stock = e.value;
                                                                        })}">
                                                                          </div>
                                                                          <div class="flex-fill d-flex flex-column" style="gap: 8px">
                                                                              <div>安全庫存</div>
                                                                              <input class="w-100" value="${variant.save_stock ?? "0"}" style="padding: 9px 18px;border-radius: 10px;border: 1px solid #DDD;" placeholder="請輸入安全庫存" onchange="${gvc.event((e) => {
                                ...
                                <div class="${obj.single ? `d-none` : ``}" style="min-width:300px; max-width:100%;">
                                    ${BgWidget.mainCardMbp0(html`
                                        ${gvc.bindView({
                                            bind: "right",
                                            view: () => {
                                                let rightHTML = postMD.variants.map((data: any) => {
                                                    if (!data.editable) {
                                                        return html`
                                                            <div class="d-flex align-items-center"
                                                                ...
                                                                <div class="rounded-3"
                                                                     style="width: 30px;height: 30px;background:50%/cover url('${data.preview_image || "https://nationalityforall.org/wp-content/themes/nfa/dist/images/default_image.jpg"}')"></div>
        ...
        function updateVariants() {
            ...
            postMD.variants = postMD.variants.filter((variant) => {
                ...
                for (const b of variant.spec) {
                    if ((!postMD.specs[index] || !postMD.specs[index].option.find((dd: any) => {
                        return dd.title === b
                    }))) {
                        pass = false
                        break
                                ...
                                <div class="d-flex flex-column" style="gap: 24px;">
                                    ${BgWidget.mainCardMbp0(html`
                                        <div class="d-flex flex-column">
                                            ...
                                            <input class="w-100 mt-2" value="${postMD.title ?? ""}"
                                    ...
                                    ${(postMD.specs.length == 0) ? `` : BgWidget.mainCardMbp0(
                                                                    ...
                                                                    return [
                                                                        gvc.bindView({
                                                                            ...
                                                                            view: () => {
                                                                                    ...
                                                                                    function editDialog(type: string) {
                                                                                        ...
                                                                                        switch (type) {
                                                                                            case "price" : {
                                                                                                inputTemp = 0;
                                                                                                return html`
                                                                                                    <div style="cursor: pointer;display: flex;width: 569px;padding-bottom: 20px;flex-direction: column;align-items: center;gap: 24px;border-radius: 10px;background: #FFF;max-width: calc(100vw - 20px);">
                                                                                            ...
                                                                                            case "volume" : {
                                                                                                ...
                                                                                                return html`
                                                                                                    <div style="display: flex;width: 569px;padding-bottom: 20px;flex-direction: column;align-items: center;gap: 24px;border-radius: 10px;background: #FFF;cursor: pointer;max-width: calc(100vw - 20px);">
                                                                                                        <div style="font-size: 16px;font-weight: 700;display: flex;padding: 12px 0px 12px 20px;align-items: center;align-self: stretch;border-radius: 10px 10px 0px 0px;background: #F2F2F2;">
                                                                                                            編輯販售價格
                                                                                                        </div>
                                                                                                        <div class="w-100 d-flex flex-column"
                                                                                            ...
                                                                                            case "delete" : {
                                                                                                return html`
                                                                                                    <div style="cursor: pointer;position:relative;display: flex;width: 432px;height: 255px;border-radius: 10px;background: #FFF;background: #FFF;align-items: center;justify-content: center;max-width: calc(100vw - 20px);">
                                                                                                        <div style="display: inline-flex;flex-direction: column;align-items: center;gap: 24px;">
                                                                                                            ...
                                                                                                            <div class="w-100 justify-content-center d-flex"
                                                                                                                ...
                                                                                                                <div style="display: flex;padding: 6px 18px;align-items: center;gap: 8px;border-radius: 10px;background: #393939;color:white;font-weight: 700;"
                                                                                                                     onclick="${gvc.event(() => {
                                                                                                                         postMD.specs[0].option.map((option: any) => {
                                                                                                                             option.sortQueue = option.sortQueue.filter((data: any) => !data.select);
                                                                                                                         })
                                                                                                                         saveQueue("delete", "")
                                                                                                                     })}">
                                                                                                                    確定
                                                                                            ...
                                                                                            case "shipment_type" : {
                                                                                                ...
                                                                                                return html`
                                                                                                    <div style="display: flex;width: 569px;padding-bottom: 20px;flex-direction: column;align-items: center;gap: 24px;border-radius: 10px;background: #FFF;font-size: 16px;max-width: calc(100vw - 20px);">
                                                                                                        <div style="font-size: 16px;font-weight: 700;display: flex;padding: 12px 0px 12px 20px;align-items: center;align-self: stretch;border-radius: 10px 10px 0px 0px;background: #F2F2F2;">
                                                                                                            更改運費計算方式
                                                                                                        </div>
                                                                                                        ${gvc.bindView({
                                                                                ...
                                                                                return html`
                                                                                    <div style="border-radius: 10px;border: 1px solid #DDD;width: 100%;display: flex;height: 40px;padding: 8px 0px 8px 18px;align-items: center;">
                                                                                        <i class="${(selected.length) ? `fa-solid fa-square-check` : `fa-regular fa-square`}"
...
"
                                                                                        ...
                                                                                        ${(document.body.clientWidth < 800) ? `<div  style="color:#393939;font-size: 16px;font-weight: 400;" class="me-3">
                                                                                                   販售價格*
                                                                                                </div>` : `${['販售價格*', '存貨數量*', '運費計算方式'].map((dd) => {
                                                                        ...
                                                                        gvc.bindView(() => {
                                                                            ...
                                                                            return {
                                                                                bind: vm.id,
                                                                                view: () => {
                                                                                    return postMD.specs[0].option.map((spec: any) => {
                                                                                        const viewList = [];

                                                                                        if (postMD.specs.length > 1) {
                                                                                            let isCheck = !(postMD.variants.filter((dd) => {
                                                                                                return (dd.spec[0] === spec.title)
                                                                                            }).find((dd) => {
                                                                                                return !(dd as any).checked
                                                                                            }))
                                                                                            viewList.push(html`
                                                                                                <div style="display: flex;padding: 8px 0px;align-items: center;border-radius: 10px;background: #FFF;width:100%;">
                                                                                                    <i class="${(isCheck) ? `fa-solid fa-square-check` : `fa-regular fa-square`}"
...
"
                                                                                                    ...
                                                                                                    <div style="flex:1 0 0;font-size: 16px;font-weight: 400;gap:${(document.body.clientWidth < 800) ? 10 : 24}px;display: flex;">
                                                                                                        <div style="background:50%/cover url('${getPreviewImage(postMD.variants.filter((dd) => {
                                                                                                            return dd.spec[0] === spec.title
                                                                                                        })[0].preview_image)}');height: 60px;width: 60px;border-radius: 10px;border: 1px solid #DDD;"></div>
                                                                                                        <div style="display: flex;align-items: center;gap: 8px;cursor: pointer;white-space: nowrap;"
                                                                                                             onclick="${gvc.event(() => {
                                                                                                                 spec.expand = !spec.expand
                                                                                                                 gvc.notifyDataChange(vm.id)
                                                                                                             })}">
                                                                                                            ${spec.title}
                                                                                                            ${spec.expand ? `<i class="fa-regular fa-chevron-up"
                                                                                                        ></i>` : `<i class="fa-regular fa-chevron-down"
                                                                                                        ></i>`}
                                                                                                    ...
                                                                                                    ${
                                                                                                            [{
                                                                                                                ...
                                                                                                                return `<div style="color:#393939;font-size: 16px;font-weight: 400;width:  ${document.body.clientWidth > 800 ? `20%;` : 'auto;max-width:140px;'}padding-right: ${document.body.clientWidth > 800 ? `10px` : '0px'};">
                                                                                                                <input style="height: 40px;width:100%;padding: 0px 18px;border-radius: 10px;border: 1px solid #DDD;background: #FFF;font-size: 13px;"
                                                                                        ...
                                                                                        if (spec.expand || postMD.specs.length === 1) {
                                                                                            viewList.push(postMD.variants.filter((dd) => {
                                                                                                return dd.spec[0] === spec.title
                                                                                            }).map((data, index) => {
                                                                                                ...
                                                                                                return gvc.bindView({
                                                                                                    ...
                                                                                                    view: () => {
                                                                                                        return html`
                                                                                                            <div style="background-color: white;position:relative;display: flex;padding: 8px 0px;align-items: center;border-radius: 10px;width:100%;">
                                                                                                                <div style="flex:1 0 0;font-size: 16px;font-weight: 400;gap:14px;display: flex;align-items: center;padding-left: ${(postMD.specs.length > 1 && document.body.clientWidth > 800) ? `32px` : `12px`};"
                                                                                                                     onclick="${gvc.event(() => {
                                                                                                                         postMD.variants.map((dd: any) => {
                                                                                                                             dd.editable = false
                                                                                                                         });
                                                                                                                    ...
                                                                                                                    <i class="${((data as any).checked) ? `fa-solid fa-square-check` : `fa-regular fa-square`}"
...
color: ${((data as any).checked) ? `#393939` : `#DDD`};font-size: 18px;"
                                                                                                                    ...
                                                                                                                    <div style="background:50%/cover url('${getPreviewImage(data.preview_image)}');height: 50px;width: 50px;border-radius: 10px;border: 1px solid #DDD;"></div>
                                                                                                                    <div style="cursor: pointer;"
                                                                                                                ...
                                                                                                                ${['sale_price', 'stock'].filter((dd) => {
                                                                                                                    return (dd === 'sale_price') || document.body.clientWidth > 800
                                                                                                                }).map((dd) => {
                                                                                                                    return ` <div style="color:#393939;font-size: 16px;font-weight: 400;width:   ${document.body.clientWidth > 800 ? `20%;` : 'auto;max-width:140px;'}padding-right: ${document.body.clientWidth > 800 ? `12px` : '0px'};">
                                                                                                    ...
                                                                                                    divCreate: {class: `w-100 ${viewID} ${(index === 0 && postMD.specs.length > 1) ? `border-top` : ``}`}
                                                                                                })
                                    ...
                                    ${BgWidget.mainCardMbp0(
                                            gvc.bindView({
                                                ...
                                                view: () => {
                                                    ...
                                                    return ['product', 'addProduct', 'giveaway'].map((dd, index) => {
                                                        return `<div class="d-flex align-items-center" style="gap:6px;cursor: pointer;"
                                                             onclick="${gvc.event(() => {
                                            ...
                                            obj.gvc.bindView(() => {
                                                ...
                                                return {
                                                    ...
                                                    view: () => {
                                                        return [
                                                            EditorElem.h3('商品系列'),
                                                            postMD.collection.map((dd, index) => {
                                                                return `<span style="font-size: 14px;">${dd}</span>`
                                                            }).join(`<div class="my-1"></div>`),
                                                            html`
                                                                <div class="w-100 mt-3">
                                                                    ${BgWidget.darkButton(`設定商品系列`, gvc.event(() => {
                ...
                divCreate: {
                    class: `d-flex`, style: `font-size: 16px;color:#393939;position: relative;padding-bottom:80px;`
                }
            }
        })
    }

    public static specInput(gvc: GVC, temp: any, cb: {
        cancel: () => void,
        save: () => void
    }) {
        const html = String.raw
        ...
        return html`
            <div class="bg-white w-100">${[html`
                ...
                <div class="d-flex w-100 justify-content-end align-items-center w-100 mt-2 bg-white"
                     style="gap:14px;">
