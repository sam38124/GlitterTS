...
export class ShoppingProductSetting {
    static select_language = (window.parent as any).store_info.language_setting.def;

    static main(gvc: GVC, type: 'product' | 'addProduct' | 'giveaway' | 'hidden' = 'product') {
                                                                                            ...
                                                                                            switch (check.select) {
                                                                                                ...
                                                                                                case 'check':
                                                                                                    return {
                                                                                                        page: 0,
                                                                                                        limit: 1000,
                                                                                                        id_list: vm.dataList.filter((item: any) => item.checked).map((item: { id: number }) => item.id),
                                                                                                        productType: type,
                                                                                                    };
                                                                                                case 'all':
                                                                                                default:
                                              ...
                                              view: () => {
                                                  ...
                                                  return html`
                                                      ...
                                                      <div
                                                          ...
                                                          style="min-width:135px;135px;height:135px;cursor:pointer;background: 50%/cover url('${variant[
    ...
    static async editProduct(obj: { vm: any; gvc: GVC; type?: 'add' | 'replace'; defData?: any; initial_data?: any; product_type?: 'product' | 'addProduct' | 'giveaway' | 'hidden' }) {
        let postMD: {
            label: any;
        ...
        (window.parent as any).glitter.share.clickGoBackFirst = true;
        (window.parent as any).glitter.share.checkData = () => {
            if ((window.parent as any).glitter.share.clickGoBackFirst) {
                return true;
            }
                            ...
                            ${BgWidget.container1x2(
                                {
                                    html: [
                                                                                    ...
                                                                                    view: () => {
                                                                                        ...
                                                                                        if (editSpectPage[specIndex].type == 'show') {
                                                                                            ...
                                                                                            return html` <div class="d-flex flex-column " style="gap:6px;align-items: flex-start;padding: 12px 0;">
                                                                                                <div style="font-size: 16px;">${(dd.language_title as any)[sel_lan()] || dd.title}</div>
                                                                                                ${(() => {
                                                                                                    let returnHTML = ``;
                                        ...
                                        !postMD.productType.giveaway
                                            ? BgWidget.mainCard(
                                                  html` <div class="mb-2 position-relative" style="font-weight: 700;">商品最低購買數量</div>
                                                      ${gvc.bindView(
                                                          (() => {
                                                              const id = gvc.glitter.getUUID();
                                                              return {
...
${language_data.seo.content ?? ''}</textarea
                                ...
                                },
                                {
                                    html: html` <div class="summary-card p-0">
                                        ${[
                                            BgWidget.mainCard(
                                                html` <div class="mb-2" style="font-weight: 700;">${BgWidget.infoInsignia(this.getProductTypeString(postMD))}</div>
                    ...
                    const si = setInterval(() => {
                        ...
                        if (editorView) {
                            ...
                            editorView.addEventListener('click', (e) => {
                                ...
                                if (
                                    (window.parent as any).glitter.share.clickGoBackFirst &&
                                    ...
                                    (window.parent as any).glitter.share.clickGoBackFirst = false;
                                }
                            });
                        }
                    }, 500);
    ...
    static putEvent(postMD: any, gvc: GVC, vm: any) {
        const dialog = new ShareDialog(gvc.glitter);
    ...
    static postEvent(postMD: any, gvc: GVC, vm: any) {
        const dialog = new ShareDialog(gvc.glitter);
        dialog.dataLoading({ text: '商品上傳中...', visible: true });
        postMD.type = 'product';
        postMD.variants.map((dd: any) => {
