    ...
    public static main(gvc: GVC) {
        ...
        return gvc.bindView(() => {
            ...
            return {
                ...
                view: async () => {
                    try {
                        let [initial, res, member_auth, store_list,work_status]: any = await Promise.all([POSSetting.initial(gvc), ApiUser.checkAdminAuth({
                            app: gvc.glitter.getUrlParameter('app-id'),
                            token: GlobalUser.saas_token,
                                                                    ...
                                                                    <div class="d-flex align-items-center px-sm-2"
                                                                        ...
                                                                        line-height: normal;">
                                                                                ...
                                                                                <div class="text-info fw-bold">
                                                                                    ${glitter.share.store_list.find((dd: any) => {
