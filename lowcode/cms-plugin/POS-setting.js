                            ...
                            return html `
                                ...
                                view: () => {
                                    ...
                                    return vm.categories.map((data) => {
                                        return html `
                                                        <div style="font-size: 18px;;width:131px;height:51px;white-space: nowrap;display: flex;padding: 12px 24px;justify-content: center;align-items: center;border-radius: 10px;box-shadow: 0px 0px 7px 0px rgba(0, 0, 0, 0.10);${(data === null || data === void 0 ? void 0 : data.select) ? `background: #393939;color: #FFF;` : `background: #FFF;color#393939;`}"
                                                             onclick="${gvc.event(() => {
                                                                ...
                                                                <div class="d-flex flex-column"
                                                                    ...
                                                                    <div class="w-100 align-items-center justify-content-end"
                                                                         style="font-size: 16px;font-weight: 700;text-align: right;">
                                                                            NT.${(_d = data.content.min_price) !== null && _d !== void 0 ? _d : 0}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        `;
                                ...
                                view: () => {
                                    ...
                                    return html `
                                        ...
                                        let tempData = [
                                            {
                                                left: `小計總額`,
                                                right: (_a = orderDetail.subtotal) !== null && _a !== void 0 ? _a : 0
                                            },
                                            { left: `活動折扣`, right: (_b = orderDetail.discount) !== null && _b !== void 0 ? _b : 0 }
                                        ];
