                        ...
                        html: [
                            BgWidget.mainCard(html `
                                ...
                                return html ` <div class="d-flex align-items-center justify-content-end">
                                                                <div class="tx_normal_14 " style="text-align: end;">${dd.title} ${(_a = dd.description) !== null && _a !== void 0 ? _a : ''}</div>
                                ...
                                view: () => {
                                    ...
                                    return BgWidget.mainCard(html `
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="col-3 text-center d-flex align-items-center justify-content-center">${(_a = invoiceData.invoice_data.invoiceAmount) !== null && _a !== void 0 ? _a : 0}</div>
                                        ...
                                        return BgWidget.mainCard(html `
                                            ...
                                            return html `
                                                                            <div style="display: flex;flex-direction: column;align-items: flex-start;gap: 12px;align-self: stretch;color:#393939;">
                                                                                ...
                                                                                <div style="color:#393939;font-size: 16px;font-weight: 400;line-height: 140%;">${(_a = data.value) !== null && _a !== void 0 ? _a : ''}</div>
                                                                            </div>
                                                                        `;
                                        })
                                            .join('')}
