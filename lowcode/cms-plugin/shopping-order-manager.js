                                ...
                                return html `
                                    ...
                                    if (vm.mode == "read") {
                                        return viewModel.map((item) => {
                                            return html `
                                                                                                <div>${item[0]}: ${orderData.orderData.user_info[item[1]]}
                                                                                                </div>
                                                                                            `;
                                        }).join("");
                                    }
                        ...
                        return {
                            ...
                            divCreate: {
                                class: ` fw-normal`,
                                                    ...
                                                    `)}
                                                    ${(() => {
                        if (orderData.orderData.custom_form_format && orderData.orderData.custom_form_format.filter((dd) => {
                                ...
                                return html `
                                    ...
                                    return gvc.bindView({
                                        ...
                                        view: () => {
                                            ...
                                            return newOrder.productArray.map((product, productIndex) => {
                                                return gvc.bindView({
