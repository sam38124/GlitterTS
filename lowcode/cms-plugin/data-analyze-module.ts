                        ...
                        ApiShop.ecDataAnalyze(
                            ...
                            function loop() {
                                if ((window as any).ApexCharts) {
                                    ...
                                    vm.sum_pos = Math.floor((res.response.order_avg_sale_price.countArrayPos ?? []).slice(0, 7).reverse().reduce((acc: any, val: any) => acc + val, 0) / 7);
                                    vm.sum_web = Math.floor((res.response.order_avg_sale_price.countArrayWeb ?? []).slice(0, 7).reverse().reduce((acc: any, val: any) => acc + val, 0)/7);
                                    gvc.notifyDataChange([vm.list_id,vm.sum_id])
                                    const options = {
                                            chart: {height: globalStyle.chart_width, type: 'area', zoom: {enabled: !1}},
                                            dataLabels: {enabled: false},
                                            ...
                                            series: [
                                                {
                                                    name: '平均',
                                                    data: array.map((dd:any)=>{return dd || 0}),
                                                },
                                            ],
                                            title: {text: '', align: 'center'},
                                            xaxis: {categories: GlobalStruct.getPastDays(7)},
                        ...
                        ApiShop.ecDataAnalyze(
                            ...
                            function loop() {
                                if ((window as any).ApexCharts) {
                                    ...
                                    vm.sum_pos = Math.floor((res.response.order_avg_sale_price_year.countArrayPos ?? []).slice(0, 12).reverse().reduce((acc: any, val: any) => acc + val, 0)/12);
                                    vm.sum_web = Math.floor((res.response.order_avg_sale_price_year.countArrayWeb ?? []).slice(0, 12).reverse().reduce((acc: any, val: any) => acc + val, 0)/12);
                                    gvc.notifyDataChange([vm.list_id,vm.sum_id])
                                    const options = {
                                            chart: {height: globalStyle.chart_width, type: 'area', zoom: {enabled: !1}},
                                            dataLabels: {enabled: false},
                        ...
                        ApiShop.ecDataAnalyze(
                            ...
                            function loop() {
                                if ((window as any).ApexCharts) {
                                    ...
                                    vm.sum = array.reduce((acc: any, val: any) => acc + val, 0);
                                    vm.sum_pos = (res.response.orders_per_month_2_weak.countArrayPos ?? []).slice(0, 7).reverse().reduce((acc: any, val: any) => acc + val, 0);
                                    vm.sum_web = (res.response.orders_per_month_2_weak.countArrayWeb ?? []).slice(0, 7).reverse().reduce((acc: any, val: any) => acc + val, 0);
                                    gvc.notifyDataChange([vm.list_id,vm.sum_id])
                                    const options = {
                                            chart: {height: globalStyle.chart_width, type: 'area', zoom: {enabled: !1}},
                                            dataLabels: {enabled: false},
                        ...
                        ApiShop.ecDataAnalyze(
                            ...
                            function loop() {
                                if ((window as any).ApexCharts) {
                                    ...
                                    vm.sum = array.reduce((acc: any, val: any) => acc + val, 0);
                                    vm.sum_pos = (res.response.orders_per_month_1_year.countArrayPos ?? []).slice(0, 12).reverse().reduce((acc: any, val: any) => acc + val, 0);
                                    vm.sum_web = (res.response.orders_per_month_1_year.countArrayWeb ?? []).slice(0, 12).reverse().reduce((acc: any, val: any) => acc + val, 0);
                                    gvc.notifyDataChange([vm.list_id,vm.sum_id])
                                    const options = {
                                            chart: {height: globalStyle.chart_width, type: 'area', zoom: {enabled: !1}},
                                            dataLabels: {enabled: false},
