                ...
                html: [
                    BgWidget.mainCard(html`
                        <div class="d-flex flex-column guide5-4">
                            <div style="font-weight: 700;" class="">${cat_title}名稱
                                        ...
                                        return html`
                                            <div class="d-flex align-items-center justify-content-end ">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div style="color: #393939; font-weight: 700;">${cat_title}簡述
                                                                                                                    ...
                                                                                                                    (urlArray) => {
                                                                                                                        if (urlArray.length > 0) {
                                                                                                                            const imgHTML = urlArray
                                                                                                                                    ...
                                                                                                                                    .join('');
                                                                                                                            editor.html.set(
                                                                                                                                    editor.html.get(0).replace(mark, html`
                                        ...
                                        view: async () => {
                                                ...
                                                if (tags && tags.length > 0) {
                                                    for (const item of tags) {
                                                        ...
                                                        const textImage =
                                                            data && data.value
                                                                ? html`<span
                                                                            style="font-size: ${item.font_size ?? '14'}px; color: ${item.font_color ?? '#393939'}; background: ${item.font_bgr ?? '#fff'}"
                                                                    >${data.value}</span
                                                                    >`
                                                                : html`#${item.title}#`;
                                                        // : html`<img
                                            ...
                                            return html`
                                                <div class="d-flex align-items-center justify-content-end mb-3">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div style="color: #393939; font-weight: 700;">${cat_title}詳細描述
                                                            ${BgWidget.languageInsignia(sel_lan(), 'margin-left:5px;')}
                                                        </div>
                                                    </div>
                                                    <div class="flex-fill"></div>
                                                                                                                    ...
                                                                                                                    return html`
                                                                                                                        <div>
                                                                                                                            ${BgWidget.editeInput({
                                                                                                                                ...
                                                                                                                                title: tag.title,
                                                                                                                                default: (() => {
                                                                                                                                    const docIndex = language_data.content_json.findIndex((c: any) => c.id === item.id);
                                                                                                                                    if (docIndex === -1) {
                                                                                                                                        return '';
                                                                                                                                    }
                                                                                                                                    ...
                                                                                                                                    const keyIndex = language_data.content_json[docIndex].list.findIndex(
                                                                                                                                            (l: any) => l.key === tag.key
                                                                                                                                    );
                                                                                                                                    if (keyIndex === -1) {
                                                                                                                                        return '';
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    >
                                                                                        <svg
                                                                                                ...
                                                                                                xmlns="http://www.w3.org/2000/svg"
                                                                                        >
                                                                                            <rect x="0.5" y="8" width="4"
                                                                                                  height="4" rx="2"
                                                                                                  fill="#393939"/>
                                                                                            <rect x="7.5" y="8" width="4"
                                                                                                  height="4" rx="2"
                                                                                                  fill="#393939"/>
                                                                                            <rect x="14.5" y="8" width="4"
                                                                                                  height="4" rx="2"
                                                                                                  fill="#393939"/>
                                                                                        </svg>
                                                                                        ${selectFunRow
                            ...
                            return {
                                ...
                                view: () => {
                                    try {
                                        ...
                                        return html`
                                            <div style="font-weight: 700;" class="mb-3">搜尋引擎列表
                                                ${BgWidget.languageInsignia(sel_lan(), 'margin-left:5px;')}
                                            </div>
                                            ${[
                                                html`
                                                    <div class="tx_normal fw-normal mb-2" style="">${cat_title}網址
                                                    </div>`,
                                                html`
                                                    <div
                                                                        ...
                                                                        ${BgWidget.multiCheckboxContainer(
                                                                                ...
                                                                                [
                                                                                    ...
                                                                                    },
                                                                                    {
                                                                                        ...
                                                                                        name: '結束時間',
                                                                                        innerHtml: html`
                                                                                            <div class="d-flex mt-0 mt-md-1 ${document.body.clientWidth < 768 ? 'flex-column' : ''}"
                                                                                                 style="gap: 12px">
                                                                                                <div class="d-flex flex-column">
                            ...
                            BgWidget.mainCard(
                                    html`
                                        ...
                                        <div class="${postMD.shopee_id ? `d-flex` : `d-none`} align-items-center mt-1"
                                             style="gap:6px;">
                                            <img src="https://deo.shopeemobile.com/shopee/shopee-mobilemall-live-sg/assets/icon_favicon_1_32.0Wecxv.png"
                                    ...
                                    obj.gvc.bindView(() => {
                                        ...
                                        return {
                                            ...
                                            view: () => {
                                                return [
                                                    html`
                                                        <div class="mb-2" style="font-weight: 700;">${cat_title}分類
                                                        </div>`,
                                                    postMD.collection
                                                            .map((dd) => {
                                                                return html`<span
