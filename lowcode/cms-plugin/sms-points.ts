                ...
                [
                    BgWidget.mainCard(
                        [
                            ...
                            BgWidget.grayNote(
                                [`*透過SMS Points來進行手機簡訊發送`, `*1塊台幣可以換取10點SMS Points`, `*最少儲值金額500元`, `*SMS Points購買後無法退費，請購買前瞭解會員權益需知`]
                                    .map((dd) => {
                                                ...
                                                return data.response.data.map((dd: any) => {
                                                    return [
                                                        ...
                                                        },
                                                        {
                                                            key: '異動金額',
                                                            value: `${
                                                                dd.money > 0 ? `<span class="fs-7 text-success">+ ${dd.money}</span>` : `<span class="fs-7 text-danger">- ${dd.money * -1}</span>`
                                                            }`,
                                                        },
                                                        {
                                                            key: '異動原因',
