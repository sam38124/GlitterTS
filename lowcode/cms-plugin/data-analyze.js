...
export class DataAnalyze {
    static main(gvc) {
        return gvc.bindView(() => {
            ...
            ApiShop.ecDataAnalyze('active_recent_2weak,active_recent_year,recent_register,order_today,sales_per_month_1_year'.split(',')).then((res) => __awaiter(this, void 0, void 0, function* () {
                vm.loading = false;
                ...
                view: () => {
                    try {
                        ...
                        return html `
                                ...
                                >
                                    ...
                                    >
                                        <div style="flex: 1 1 0; align-self: stretch; flex-direction: column; justify-content: center; align-items: flex-start; gap: 8px; display: inline-flex;">
                                            <div style="align-self: stretch; color: #393939; font-size: 20px; font-family: Noto Sans; font-weight: 700; word-wrap: break-word;">
                                                營運狀況總覽
                                            </div>
                                            <div style="align-self: stretch; color: #8D8D8D; font-size: 16px; font-family: Noto Sans; font-weight: 400; word-wrap: break-word;">
                                                查看目前的業務情形
                                            </div>
                            ...
                            .map((dd) => {
                            return html `
                                                            <div class="col-sm-4 col-lg-4 col-12 px-0 px-sm-2">${dd}
                                                            </div>`;
                        })
                            .join('')}
                                        </div>
