                                                    ...
                                                    ${[
                                                        ...
                                                        .map((dd) => {
                                                            return html` <div class="d-flex align-items-center justify-content-end">
                                                                <div class="tx_normal_14 " style="text-align: end;">${dd.title} ${dd.description ?? ''}</div>
                                        ...
                                        gvc.bindView({
                                            ...
                                            view: () => {
                                                ...
                                                return BgWidget.mainCard(html`
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="col-3 d-flex align-items-center ">${invoiceData.create_date.split('T')[0]}</div>
                                                        <div class="col-3 text-center d-flex align-items-center justify-content-center" style="color: #4D86DB;">${invoiceData.invoice_no}</div>
                                                        <div class="col-3 text-center d-flex align-items-center justify-content-center">${invoiceData.invoice_data.invoiceAmount ?? 0}</div>
                                    ...
                                    html: html` <div class="summary-card">
                                        ${[
                                            BgWidget.mainCard(html`
                                                ...
                                                <div>${orderData.orderData.orderSource == 'pos' ? 'POS' : '線上'}</div>
                                            `),
                                            BgWidget.mainCard(
                                                html`
                                                                ...
                                                                gvc.bindView({
                                                                    ...
                                                                    view: () => {
                                                                        ...
                                                                        if (orderData.orderData.user_info.shipment !== 'now') {
                                                                            view.push(html` <div style="font-size: 16px;font-weight: 700;color:#393939">收件人資料</div>
                                                                                <div class="d-flex flex-column" style="gap:8px;">
                                                                    ...
                                                                    .map((data) => {
                                                                        return html`
                                                                            <div style="display: flex;flex-direction: column;align-items: flex-start;gap: 12px;align-self: stretch;color:#393939;">
                                                                                ...
                                                                                <div style="color:#393939;font-size: 16px;font-weight: 400;line-height: 140%;">${data.value ?? ''}</div>
                                                                            </div>
                                                                        `;
                                                                    })
                                                                    .join('')}
