            ...
            if (postMD.product_category === 'kitchen' && postMD.variants.length > 1) {
                postMD.variants.forEach((variant) => {
                    ...
                    variant.sale_price = variant.spec
                        .map((specValue, index) => { var _a, _b; return parseInt((_b = (_a = postMD.specs[index].option.find((opt) => opt.title === specValue)) === null || _a === void 0 ? void 0 : _a.price) !== null && _b !== void 0 ? _b : '0', 10); })
                        .reduce((acc, cur) => acc + cur, 0);
                    Object.assign(variant, {
                        weight: parseFloat((_a = postMD.weight) !== null && _a !== void 0 ? _a : '0'),
                        v_height: parseFloat((_b = postMD.v_height) !== null && _b !== void 0 ? _b : '0'),
                        v_width: parseFloat((_c = postMD.v_width) !== null && _c !== void 0 ? _c : '0'),
                        v_length: parseFloat((_d = postMD.v_length) !== null && _d !== void 0 ? _d : '0'),
                            ...
                            return gvc.bindView({
                                ...
                                onCreate: () => {
                                    if (priceVM.loading) {
                                        ...
                                        if (isDesktop) {
                                            scrollDiv === null || scrollDiv === void 0 ? void 0 : scrollDiv.addEventListener('scroll', () => {
