                                                                                            ...
                                                                                            function replaceProducts(oriData: any, replaceData: any) {
                                                                                                replaceData.forEach((data: any) => {
                                                                                                    ...
                                                                                                    data.content.variants.forEach((variant: any) => {
                                                                                                        let index = findProduct.content.variants.findIndex((item: any) => item.spec.join('') == variant.spec.join(''));
                                                                                                        if (index !== -1) {
                                                                                                                                    ...
                                                                                                                                    return html`
                                                                                                                                        <div class="d-flex w-100 align-items-center flex-column"
                                                                                                                                            ...
                                                                                                                                            ${newOrder.productTemp
                                                                                                                                                    .map((product: any, productIndex: number) => {
                                                                                                                                                        const variants = product.content.variants;
                                                                                                                                                        product.content.live_model = product.content.live_model??{};
                                                                                                                                                        ...
                                                                                                                                                        return gvc.bindView({
                                                                                                                                                            ...
                                                                                                                                                            view: () => {
                                                                                                                                                                function drawRow(variant?: any) {
                                                                                                                                                                    ...
                                                                                                                                                                    let showModel: any = variant ? variant.live_model : (product.content.specs.length > 0) ? product.content.live_model : variants[0].live_model;
                                                                                                                                                                    //單一規格 或是規格的細項走
                                                                                                                                                                    if (!variant && product.content.specs.length > 0) {
                                                                                                                                                                        ...
                                                                                                                                                                        variants.map((variant: any) => {
                                                                                                                                                                            ...
                                                                                                                                                                            showModel.available_Qty += parseInt(variant.live_model.available_Qty) ?? parseInt(variant.stock);
                                                                                                                                                                                    ...
                                                                                                                                                                                    return html`
                                                                                                                                                                                        <svg
                                                                                                                                                                                                ...
                                                                                                                                                                                                onclick="${gvc.event(() => {
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if (variants.every((dd: any) => dd.selected !== true)) {
    ...
    public static replace(gvc: GVC, vm: any, group_buy?: boolean) {
        ...
        return BgWidget.container(html`
                                            ...
                                            ${gvc.bindView({
                                                ...
                                                view: () => {
                                                    ...
                                                    return html`
                                                            ...
                                                            <div class="d-flex flex-grow-1" style="gap:68px;">
                                                                ${dataSet.map((data, index) => {
                                                                    if (index != 0) {
                                                                        return html`
                                                                            <div class="d-flex align-items-center"
                                                                                 style="${data.align ?? ''}width:10%;font-size: 16px;font-style: normal;font-weight: 700;">
                                                                                ${data.text}
                                                                            </div>
                                                                        `
                                                                    }
                                                        ...
                                                        ` : viewModel.cartList.map((cart: any) => {
                                                                            ...
                                                                            function drawOrderRaw(index: number) {
                                                                                ...
                                                                                switch (index) {
                                                                                    case 3: {
                                                                                        return html`
                                                                                            <div class="d-flex align-items-center "
                                                                                                 style="${data.color ?? ''}${data.align ?? ''}width:10%;font-size: 16px;font-style: normal;font-weight: 700;">
                                                                                                ${showData[index]}
                                                                                            </div>
                                                                                        `
                                                                                    }
                                                                            ...
                                                                            <div class="d-flex flex-column">
                                                                                <div class="d-flex align-items-center w-100 "
                                                                                    ...
                                                                                    <div class="d-flex flex-column w-100"
                                                                                         style="gap: 8px;">
                                                                                        ${item.content.variants.map((variant: any) => {
                                                                                            return html`
                                                                                                <div class="d-flex align-items-center w-100">
                                                                                                    <div class="d-flex"
            ...
            <div class="update-bar-container" style="">
                ...
                ${(viewModel.formData.status==1)?BgWidget.save(
                        gvc.event(async () => {
                ...
                ${(viewModel.formData.status==2)?BgWidget.save(
                        gvc.event(async () => {
