...
export class AccountInfo {
    static main(gvc) {
        ...
        return gvc.bindView(() => {
            ...
            >
              ${(() => {
                        if (['account_edit', 'account_edit', 'order_list', 'voucher-list', 'rebate',
                            'wishlist'].includes(gvc.glitter.getUrlParameter('page')) && document.body.clientWidth < 800) {
                            return ``;
                        }
                        else {
                            return html ` <div
                            ...
                            view: () => {
                                return new Promise((resolve, reject) => {
                                    switch (gvc.glitter.getUrlParameter('page')) {
                                        case 'rebate':
                                            gvc.glitter.getModule(gvc.glitter.root_path + `public-components/user-manager/um-rebate.js`, (res) => {
                                        ...
                                        case 'account_edit':
                                            ...
                                            break;
                                        case 'order_list':
                                            gvc.glitter.getModule(gvc.glitter.root_path + `public-components/user-manager/um-orderlist.js`, (res) => {
                                                resolve(res.main(gvc, {}, {}));
                                            });
                                            break;
                                        case 'wishlist':
                                            gvc.glitter.getModule(gvc.glitter.root_path + `public-components/user-manager/um-wishlist.js`, (res) => {
                                                resolve(res.main(gvc, {}, {}));
                                            });
                                            break;
                                        case 'voucher-list':
                                            gvc.glitter.getModule(gvc.glitter.root_path + `public-components/user-manager/um-voucher.js`, (res) => {
                                                resolve(res.main(gvc, {}, {}));
                                            });
                                            break;
                                    }
