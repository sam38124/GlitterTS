...
export class SeoBlog {
    public static main(gvc: GVC) {
        ...
        async function getSEOData() {
            ...
            return await ApiUser.getPublicConfig(`article_seo_data_${vm.language}`, 'manager')
        }
                            ...
                            view: () => {
                                ...
                                return BgWidget.mainCard(html`
                                    <div class="d-flex flex-column" style="gap:18px;">
                                        ${BgWidget.editeInput({
                                            gvc: gvc,
                                            title: '目錄標題'+BgWidget.languageInsignia(vm.language as any,'margin-left:5px;'),
...
(window as any).glitter.setModule(import.meta.url, SeoBlog);