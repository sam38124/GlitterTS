                                                ...
                                                function getDatalist() {
                                                    return data.response.data.map((dd: any) => {
                                                        return [
                                                            ...
                                                            {
                                                                key: '買受人',
                                                                value: html` <div style="padding-left: 5px;">${Tool.truncateString(dd.invoice_data.original_data.CustomerName ?? '', 7)}</div>`,
                                                            },
                                                            {
                                                                key: '發票日期',
                                                    ...
                                                    <div class="row">
                                                        ${[
                                                            ...
                                                            BgWidget.editeInput({
                                                                ...
                                                                title: '買受人姓名',
                                                                default:
                                                                    invoiceData.invoice_data.original_data.CustomerName === '無名氏' || !invoiceData.invoice_data.original_data.CustomerName
                                                                        ? `無姓名`
                                                                                                ...
                                                                                                >
                                                                                                    ...
                                                                                                    <div class="d-flex align-items-center justify-content-center w-100" style="gap: 14px;">
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            style="padding: 6px 18px;border-radius: 10px;border: 1px solid #DDD;font-weight: 700;"
                                                                                                            onclick="${gvc.event(() => {
                                                                                                                ApiShop.voidInvoice(invoiceData.invoice_no, reason, invoiceData.create_date).then(
                                                                                                                    (r) => {
                                                                                                                        vm.type = 'list';
                                                                                                                        glitter.closeDiaLog();
                                                                                                                    }
