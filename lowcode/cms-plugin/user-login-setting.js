                                        ...
                                        view: () => {
                                            return [
                                                EditorElem.editeInput({
                                                    gvc: gvc,
                                                    title: '寄件者名稱',
                                                    default: keyData[dd.config.name],
                                                    callback: (text) => {
                                                        keyData[dd.config.name] = text;
                                                    },
                                                ...
                                                EditorElem.editeInput({
                                                    gvc: gvc,
                                                    title: '信件標題',
                                                    default: keyData[dd.config.title],
                                                    callback: (text) => {
                                                        keyData[dd.config.title] = text;
                                                    },
                                                    placeHolder: '請輸入信件標題'
                                                }),
                                                EditorElem.h3('信件內容'),
                                                EditorElem.richText({
                                                    gvc: gvc,
                                                    def: keyData[dd.config.content],
                                                    callback: (text) => {
                                                        keyData[dd.config.content] = text;
                                                    },
                                                    style: 'height:100px;'
                                                })
                                            ].join('');
