        ...
        return [
            ...
            gvc.bindView(() => {
                ...
                return {
                    bind: vm.id,
                    view: () => {
                        return vm.data.map((dd: any, index: number) => {
                                        ...
                                        return [
                                            ...
                                            ${gvc.bindView(() => {
                                                ...
                                                return {
                                                    bind: cVm.id,
                                                    view: () => {
                                                        // {"index": 0, "name": "1", "value": "1"}

                                                        return dd.form_config.option.map((d1: any, index: number) => {
                                                            return html`
...
${BgWidget.cancel(gvc.event(() => {
  ...
  ` : ``}
            ...
            BgWidget.plus_btn('新增一個欄位', gvc, option.map((dd: any, index) => {
                dd.callback = () => {
                    switch (dd.key) {
                        case 'input':
                            vm.data.push({
