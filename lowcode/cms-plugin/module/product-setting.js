...
export class ProductSetting {
    static showBatchEditDialog(obj) {
        ...
        const topGVC = window.parent.glitter.pageConfig[window.parent.glitter.pageConfig.length - 1].gvc;
              ...
              <div class="overflow-scroll scrollbar-appear flex-fill" style="padding:24px 32px;">
                <div class="d-flex " style="margin-bottom:24px;gap:24px;">
                  ${(() => {
                        ...
                        titleArray = insertSubStocks(titleArray, stockList
                            .map((item, index) => {
    ...
    static showBatchEditDialogWithLive(obj) {
        const selected = obj.selected;
        const topGVC = window.parent.glitter.pageConfig[window.parent.glitter.pageConfig.length - 1].gvc;
        topGVC.glitter.innerDialog((gvc) => {
                              ...
                              ${titleArray
                                ...
                                return html `
                                    ...
                                    switch (index) {
                                        ...
                                        default: {
                                            return variant.live_model[(_b = title.key) !== null && _b !== void 0 ? _b : ''];
                                        }
                                    }
                                })()}
                                    </div>
