                                                    ...
                                                    return data.response.data.map((dd: any) => {
                                                        return [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                value: html` <div class="text-center" style="">${dd.allowance_data.invoiceAmount ?? 0}</div>`,
                                                            },
                                                            {
                                                                key: '發票日期',
                        ...
                        html`
                            <div class="title-container">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="align-items-center" style="gap:10px;color: #393939;font-size: 24px;font-weight: 700;">#${allowanceData.order_id}</div>
                                ...
                                view: () => {
                                    if (orderData) {
                                        ...
                                        return [
                                                ...
                                                <div style="display: flex;flex-direction: column;align-items: flex-start;gap: 18px;align-self: stretch;color:#393939;font-size: 16px;font-weight: 400;">
                                                    ...
                                                    <div class="w-100" style="display: flex;align-items: flex-start;gap: 18px;">
                                                        ...
                                                        ${BgWidget.editeInput({
                                                            gvc: gvc,
                                                            title: '買受人姓名',
                                                            default: orderData.orderData?.user_info?.email == 'no-email' ? '紙本發票無姓名' : orderData.orderData?.user_info?.name ?? '',
                                                            readonly: true,
                                                    ...
                                                    <div class="w-100" style="display: flex;align-items: flex-start;gap: 18px;">
                                                        ${BgWidget.editeInput({
                                                            gvc: gvc,
                                                            title: '買受人電話',
                                                            default: orderData.orderData?.user_info?.email == 'no-email' ? '紙本發票無電話' : orderData.orderData?.user_info?.phone ?? '',
                                                        ...
                                                        ${BgWidget.editeInput({
                                                            gvc: gvc,
                                                            title: '買受人地址',
                                                            default: orderData.orderData?.user_info?.email == 'no-email' ? '紙本發票無地址' : orderData.orderData?.user_info?.phone ?? '',
                                                    ...
                                                    <div class="w-100" style="display: flex;align-items: flex-start;gap: 18px;">
                                                        ${BgWidget.editeInput({
                                                            gvc: gvc,
                                                            title: '買受人電子信箱',
                                                            default: orderData.orderData?.user_info?.email == 'no-email' ? '紙本發票無電子信箱' : orderData.orderData?.user_info?.email ?? '',
                                            ...
                                            BgWidget.mainCard(html` <div style="font-size: 16px;font-weight: 700;margin-bottom:18px;">折讓列表</div>
                                                        ...
                                                        return html`
                                                            <div class="d-flex w-100 align-items-center" style="">
                                                                <div class="col-7 d-flex align-items-center">
                                                                    <img src="${target!.preview_image}" style="width: 40px;height: 40px;border-radius: 5px;margin-right:12px;" />
                                                                    ${item.ItemName}
                                                                </div>
                                                ...
                                                <div class="d-flex flex-row-reverse" style="width: 100%;">
                                                    <div class="col-1 text-end" style="font-weight: 700;">${allowanceData.allowance_data.invoiceAmount}</div>
                                                    <div class="col-1"></div>
                                                                                            ...
                                                                                            >
                                                                                                ...
                                                                                                <div class="d-flex align-items-center justify-content-center w-100" style="gap: 14px;">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        onclick="${gvc.event(() => {
                                                                                                            ApiShop.voidAllowance(allowanceData.invoice_no, allowanceData.allowance_no, reason).then(
                                                                                                                (r) => {
...
${reason}</textarea
    ...
    public static createOrder(gvc: GVC, vm: any) {
        ...
        gvc.addStyle(html`
            input[type="number"]::-webkit-outer-spin-button, input[type="number"]::-webkit-inner-spin-button { -webkit-appearance: none; margin: 0; } /* 適用於 Firefox */ input[type="number"] {
                    ...
                    view: () => {
                        ...
                        if (viewModel.searchData) {
                            ...
                            return [
                                ...
                                `),
                                html` <div style="margin-top: 24px;"></div>`,
                                BgWidget.mainCard(html` <div style="font-size: 16px;font-weight: 700;margin-bottom:18px;">需折讓商品列表</div>
                                    <div class="d-flex w-100 align-items-center">
                                    ...
                                    ${gvc.bindView({
                                        ...
                                        view: () => {
                                            ...
                                            return html`
                                                ${itemArray
                                                    .map((item: any) => {
                                                        let invoiceItem = invoiceArray.find((item2: any) => item2.ItemName.split('/')[0] === item.title);
                                                ...
                                                <div class="d-flex flex-row-reverse" style="width: 100%;">
                                                    <div class="col-1 text-end" style="font-weight: 700;">${viewModel.allowanceInvoiceTotalAmount}</div>
                                                    <div class="col-1"></div>
