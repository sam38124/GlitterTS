                                        ...
                                        return data.response.data.map((dd) => {
                                            ...
                                            return [
                                                ...
                                                },
                                                {
                                                    ...
                                                    value: html ` <div class="text-center" style="">${(_a = dd.allowance_data.invoiceAmount) !== null && _a !== void 0 ? _a : 0}</div>`,
                                                },
                                                {
                                                    key: '發票日期',
                                ...
                                return [
                                    ...
                                    BgWidget.mainCard(html ` <div style="font-size: 16px;font-weight: 700;margin-bottom:18px;">折讓列表</div>
                                        ...
                                        return itemArray.map((item) => {
                                            var _a;
                                            let target = orderData.orderData.lineItems.find((lineItem) => {
                                            ...
                                            return html `
                                                            <div class="d-flex w-100 align-items-center" style="">
                                                                ...
                                                                <div class="col-2 text-center">${(_a = target.spec.join(',')) !== null && _a !== void 0 ? _a : '單一規格'}</div>
...
${(_0 = allowanceData.allowance_data.allowanceReason) !== null && _0 !== void 0 ? _0 : ''}</textarea
                                                >
                                                <div style="margin-top: 18px;margin-bottom: 12px;">折讓備註</div>
                                                <textarea style="width: 100%; border-radius: 10px;border: 1px solid #DDD;padding: 5px;" rows="3" disabled>
${(_1 = allowanceData.allowance_data.remark) !== null && _1 !== void 0 ? _1 : ''}</textarea
                                                >
                                                ...
                                                <textarea
                                                    ...
                                                    disabled
                                                >
${(_2 = allowanceData.allowance_data.voidReason) !== null && _2 !== void 0 ? _2 : ''}</textarea
                                                >
                                            `),
