...
export class ShoppingShipmentSetting {
    static main(gvc) {
        ...
        function save(next) {
            ...
            saasConfig.api.setPrivateConfig(saasConfig.config.appName, `glitter_shipment`, shipmentArray).then((r) => {
                    ...
                    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        resolve(gvc.bindView({
                            ...
                            view: () => {
                                ...
                                ].join(''), undefined, `padding-bottom:240px;gap:24px;color:#393939;width:100%;color:#393939;display:flex;`);
                            },
