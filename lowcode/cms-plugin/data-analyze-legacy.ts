                                            ...
                                            if (element) {
                                                ...
                                                const options = {
                                                        ...
                                                        series: [
                                                            {
                                                                name: '訂單量',
                                                                data: vm.data.orders_per_month_2_week.countArray ?? [],
                                                            },
                                                        ],
                                                        title: { text: '', align: 'center' },
                                                        grid: {
                                            ...
                                            if ((window as any).ApexCharts) {
                                                ...
                                                const options = {
                                                        ...
                                                        series: [
                                                            {
                                                                name: '會員數量',
                                                                data: vm.data.recent_register.count_2_week_register ?? [],
                                                            },
                                                        ],
                                                        title: { text: '', align: 'center' },
                                                        xaxis: { categories: getPastDays(14) },
                                            ...
                                            if ((window as any).ApexCharts) {
                                                ...
                                                const options = {
                                                        ...
                                                        series: [
                                                            {
                                                                name: '每日不重複瀏覽人數',
                                                                data: vm.data.active_recent_2week.count_array ?? [],
                                                            },
                                                        ],
                                                        title: { text: '', align: 'center' },
                                                        xaxis: { categories: getPastDays(14) },
