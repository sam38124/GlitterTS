...
export class UserLoginSetting {
    public static main(gvc: GVC,widget:any) {
        ...
        return BgWidget.container(html`
            ...
            ${gvc.bindView(() => {
                ...
                return {
                    bind: id,
                    view: () => {
                        UserLoginSetting.setDefValue(keyData)
                        return [
                            {
                                title: '信箱驗證',
                                config:{
                                ...
                                src: 'https://d3jnmi1tfjgtti.cloudfront.net/file/252530754/1716359434406-281769.png'
                            },
                            {
                                title: '歡迎信件', 
                                config:{
                                    name:'name',
                                    title:'will_come_title',
                                    content:'will_come_content'
                                },
                                src: 'https://d3jnmi1tfjgtti.cloudfront.net/file/234285319/1716741763880-door-open-duotone.svg'
                            },
                            {
                                title: '忘記密碼',
                                config:{
                                ...
                                src: 'https://d3jnmi1tfjgtti.cloudfront.net/file/234285319/1716741937976-lock-open-solid.svg'
                            }
                        ].map((dd) => {
                            return html`
                                <div class="col-12 col-md-4 mb-3">
                                    <div class="w-100"
                                        ...
                                        <div style="align-self: stretch; justify-content: flex-start; align-items: center; gap: 28px; display: inline-flex">
                                            <img style="width: 36px;max-height: 46px;" src="${dd.src}">
                                            ...
                                            <div class="ms-auto" style="right: 0px;top: 0px;">
                                                <div class="btn-sm bt_primary bt_c39 fs-sm fw-500"
                                                                ...
                                                                view: () => {
                                                                    return [
                                                                        EditorElem.editeInput({
                                                                            gvc: gvc,
                                                                            title: '寄件者名稱',
                                                                            default: (keyData as any)[dd.config.name],
                                                                            callback: (text) => {
                                                                                (keyData as any)[dd.config.name] = text
                                                                            },
                                                                        ...
                                                                        EditorElem.editeInput({
                                                                            gvc: gvc,
                                                                            title: '信件標題',
                                                                            default: (keyData as any)[dd.config.title],
                                                                            callback: (text) => {
                                                                                (keyData as any)[dd.config.title] = text
                                                                            },
                                                                            placeHolder: '請輸入信件標題'
                                                                        }),
                                                                        EditorElem.h3('信件內容'),
                                                                        EditorElem.richText({
                                                                            gvc: gvc,
                                                                            def: (keyData as any)[dd.config.content],
                                                                            callback: (text) => {
                                                                                (keyData as any)[dd.config.content] = text
                                                                            },
                                                                            style:'height:100px;'
                                                                        })
                                                                    ].join('')
                                                                ...
                                                                if(response){
                                                                    ...
                                                                    save(()=>{
                                                                        setTimeout(()=>{
                                                                            ...
                                                                            widget.event('success', {visible: false, title: '變更完成'})
                                                                        },1000) 
                                                                    })
                                                                }
                                                            }
        ...
        `, undefined, 'width:calc(100% - 56px);min-height:calc(100vh);')
    }

    public static legacy(gvc: GVC) {
        const saasConfig: {
            config: any,
            api: any
        } = (window as any).parent.saasConfig
...
<img src="https://ci3.googleusercontent.com/meips/ADKq_NbTVurv9Myfyz9PhnR6e2VliLt0CFlSGZQ-llBSyYXgCJk484f6C9PtRc3NQ--UqTVQLrUbxo9QnW7Jeol11m54Ffyk3C_-YGtSYbBtM-pocpNiNcD8mIkv3bNN3eh5HpLh1tiKiOpQakyoPqKg8tioAtjIe3HfGjshqtJap0HP0qao4Rdp96g8T6NDAFRUjXK3PAB6N0Hki6PwEBf3ccdaPkQ3EqMHTw-WD8MjTbiKIoAM=s0-d-e1-ft#https://cdn.shopify.com/shopifycloud/shopify/assets/themes_support/notifications/spacer-1a26dfd5c56b21ac888f9f1610ef81191b571603cb207c6c0f564148473cab3c.png" class="m_-6935525929279934079spacer CToWUd" height="1" style="min-width:600px;height:0" data-bit="iit">
    ...
    public static setDefValue(keyData: {
        verify: 'normal' | 'mail' | 'phone',
        verify_forget: 'mail'
        name: string,
        content: string
        ...
        keyData.will_come_content = keyData.will_come_content || html`
            <table style="height:100%!important;width:100%!important;border-spacing:0;border-collapse:collapse">
                <tbody>
                <tr>
                    <td style="font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,&quot;Roboto&quot;,&quot;Oxygen&quot;,&quot;Ubuntu&quot;,&quot;Cantarell&quot;,&quot;Fira Sans&quot;,&quot;Droid Sans&quot;,&quot;Helvetica Neue&quot;,sans-serif">
                        <table class="m_-6935525929279934079header"
                               style="width:100%;border-spacing:0;border-collapse:collapse;margin:40px 0 20px">
                            <tbody>
                            <tr>
                                <td style="font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,&quot;Roboto&quot;,&quot;Oxygen&quot;,&quot;Ubuntu&quot;,&quot;Cantarell&quot;,&quot;Fira Sans&quot;,&quot;Droid Sans&quot;,&quot;Helvetica Neue&quot;,sans-serif">
                                    <center>
                                        ...
                                        <table class="m_-6935525929279934079container"
                                               style="width:560px;text-align:left;border-spacing:0;border-collapse:collapse;margin:0 auto">
                                            <tbody>
                                            <tr>
                                                <td style="font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,&quot;Roboto&quot;,&quot;Oxygen&quot;,&quot;Ubuntu&quot;,&quot;Cantarell&quot;,&quot;Fira Sans&quot;,&quot;Droid Sans&quot;,&quot;Helvetica Neue&quot;,sans-serif">
                                                    ...
                                                    <table style="width:100%;border-spacing:0;border-collapse:collapse">
                                                        <tbody>
                                                        <tr>
                                                            <td class="m_-6935525929279934079shop-name__cell"
                                                                style="font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,&quot;Roboto&quot;,&quot;Oxygen&quot;,&quot;Ubuntu&quot;,&quot;Cantarell&quot;,&quot;Fira Sans&quot;,&quot;Droid Sans&quot;,&quot;Helvetica Neue&quot;,sans-serif">
                                                                <h1 style="font-weight:normal;font-size:30px;color:#333;margin:0">
                                                                    <a href="https://glitter-ai.com/?page=index"><span
                                                                            class="il">Glitter</span>.AI</a>
                                                                </h1>
                                                            </td>
                                        ...
                                        <table class="m_-6935525929279934079container"
                                            ...
                                            <tr>
                                                <td style="font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,&quot;Roboto&quot;,&quot;Oxygen&quot;,&quot;Ubuntu&quot;,&quot;Cantarell&quot;,&quot;Fira Sans&quot;,&quot;Droid Sans&quot;,&quot;Helvetica Neue&quot;,sans-serif">
                                                    ...
                                                    <h2 style="font-weight:normal;font-size:24px;margin:0 0 10px">歡迎造訪
                                                        <span class="il">Glitter</span>.AI</h2>
                                                    <p style="color:#777;line-height:150%;font-size:16px;margin:0">
                                                        你已啟用顧客帳號。下次向我們購買商品時可登入以加快結帳程序。</p>

                                                    <table style="width:100%;border-spacing:0;border-collapse:collapse;margin-top:20px">
                                                        <tbody>
                                                        <tr>
                                                            <td style="font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,&quot;Roboto&quot;,&quot;Oxygen&quot;,&quot;Ubuntu&quot;,&quot;Cantarell&quot;,&quot;Fira Sans&quot;,&quot;Droid Sans&quot;,&quot;Helvetica Neue&quot;,sans-serif">
                                                                <table class="m_-6935525929279934079button m_-6935525929279934079main-action-cell"
                                                                       style="border-spacing:0;border-collapse:collapse;float:left;margin-right:15px">
                                                                    <tbody>
                                                                    <tr>
                                                                        <td style="font-family:-apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,&quot;Roboto&quot;,&quot;Oxygen&quot;,&quot;Ubuntu&quot;,&quot;Cantarell&quot;,&quot;Fira Sans&quot;,&quot;Droid Sans&quot;,&quot;Helvetica Neue&quot;,sans-serif;border-radius:4px"
                                                                            align="center" bgcolor="#FD6A58"><a
                                                                                ...
                                                                                target="_blank"
                                                                                data-saferedirecturl="https://www.google.com/url?q=https://homee.cc/_t/c/A1030004-178DF593BC260730-3276808C?l%3DAAC31U1HQyLV6yRc418Ol6ZTVtd35pqHBs7MfVIFQDr5cyyO2sIEDkhWHwZOWThosKbnlo0vxspUzXz95nAfGCAefk7ZV5q%252F4OcvJNHMWdazV7L3oV%252FeYRwJeFSZL8IjeY9FoC4%252FftsbMqiOvv3N3fuybzH6h87aaIKXJB3xQLvRDdoUEc%252Bls9WXIWwMVLjXOm2TaM0mO0WY2bk%253D%26c%3DAABphhQuF%252Fv1oMua9CSFTngouEXUusFfuKKA%252B2VsQyoM2b7GLOICMbafbOHbq9R6gAbjuFK%252BvnPtv5UjwCIQGNQ92Tn4ZBbwZKMj8Z3tN3K1GfGK8g4OdJMbcjXvYu33KJPpHD8FHNoIR1E9%252BxLb67yVIoHfOsdRfTFnkGTlPXqCushhfwL9%252BLJjZhI0vabSZ0edxj1olnSwMe32VLib6ljdCUeFYftICVKoS%252FoQwo5BfFKozF64R1mOrnNPoMop1Jxl7XGbxVIJegWLjoR01AgtwLRdehnioWNe%252FQS2efaSSVfSFbKA%252BgjAgwB7EChxgqD1T2Df4aecH%252F5PN7dZ1Ljh9MOxgxAxYNE%253D&amp;source=gmail&amp;ust=1704369669126000&amp;usg=AOvVaw2lf2J55g8YoRh8zhgbNpwz">造訪我們的商店</a>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                        ...
                        <img src="https://ci3.googleusercontent.com/meips/ADKq_NbTVurv9Myfyz9PhnR6e2VliLt0CFlSGZQ-llBSyYXgCJk484f6C9PtRc3NQ--UqTVQLrUbxo9QnW7Jeol11m54Ffyk3C_-YGtSYbBtM-pocpNiNcD8mIkv3bNN3eh5HpLh1tiKiOpQakyoPqKg8tioAtjIe3HfGjshqtJap0HP0qao4Rdp96g8T6NDAFRUjXK3PAB6N0Hki6PwEBf3ccdaPkQ3EqMHTw-WD8MjTbiKIoAM=s0-d-e1-ft#https://cdn.shopify.com/shopifycloud/shopify/assets/themes_support/notifications/spacer-1a26dfd5c56b21ac888f9f1610ef81191b571603cb207c6c0f564148473cab3c.png"
                             class="m_-6935525929279934079spacer CToWUd" height="1" style="min-width:600px;height:0"
                             data-bit="iit">
...
(window as any).glitter.setModule(import.meta.url, UserLoginSetting)