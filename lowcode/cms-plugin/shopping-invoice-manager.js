                            ...
                            if (orderData_) {
                                ...
                                let tax_total = (() => {
                                    ...
                                    orderData.lineItems
                                        .filter((product) => {
                                        var _a;
                                        product.tax = (_a = product.tax) !== null && _a !== void 0 ? _a : '5';
                          ...
                          <div class="row p-0">
                            ${[
                                            ...(orderData.user_info.invoice_type !== 'company'
                                                ? [
                                                    BgWidget.editeInput({
                                                        gvc: gvc,
                                                        title: '買受人姓名',
                                                        default: (_a = orderData.user_info.name) !== null && _a !== void 0 ? _a : '',
                                                ...
                                                : [
                                                    BgWidget.editeInput({
                                                        gvc: gvc,
                                                        title: '公司抬頭',
                                                        default: (_b = orderData.user_info.company) !== null && _b !== void 0 ? _b : '',
                                                        placeHolder: '請輸入公司抬頭',
                                                        callback: data => {
                                                    ...
                                                    BgWidget.editeInput({
                                                        gvc: gvc,
                                                        title: '公司統編',
                                                        default: (_c = orderData.user_info.gui_number) !== null && _c !== void 0 ? _c : '',
                                                        placeHolder: '請輸入公司統編',
                                                        callback: data => {
                                            ...
                                            BgWidget.editeInput({
                                                gvc: gvc,
                                                title: '買受人電話',
                                                default: (_d = orderData.user_info.phone) !== null && _d !== void 0 ? _d : '',
                                            ...
                                            BgWidget.editeInput({
                                                gvc: gvc,
                                                title: '買受人地址',
                                                default: (_e = orderData.user_info.address) !== null && _e !== void 0 ? _e : '',
                                            ...
                                            BgWidget.editeInput({
                                                gvc: gvc,
                                                title: '買受人電子信箱',
                                                default: (_f = orderData.user_info.email) !== null && _f !== void 0 ? _f : '',
                                            ...
                                            BgWidget.select({
                                                ...
                                                default: orderData.user_info.print_invoice === '1' ||
                                                    orderData.user_info.invoice_type === 'company'
                                                    ? 'Y'
                                                    : 'N',
                                                options: [
                                            ...
                                            BgWidget.select({
                                                ...
                                                callback: text => { },
                                                default: (() => {
                                                    return orderData.lineItems.find((product) => {
                                                        return `${product.tax}` === '0';
                                                    })
                                                        ? `免稅`
                                                        : `應稅`;
                                            ...
                                            BgWidget.editeInput({
                                                ...
                                                title: '稅率',
                                                default: (() => {
                                                    const tax5 = orderData.lineItems.find((product) => {
                                                        var _a;
                                                        product.tax = (_a = product.tax) !== null && _a !== void 0 ? _a : '5';
                                                        return `${product.tax}` === '5';
                                                    });
                                                    const tax0 = orderData.lineItems.find((product) => {
                                                        var _a;
                                                        product.tax = (_a = product.tax) !== null && _a !== void 0 ? _a : '5';
                                                        return `${product.tax}` === '0';
                                                    });
...
${reason}</textarea
                        ...
                        <textarea
                          ...
                          disabled
                        >
${(_j = (_h = (_g = invoiceData.invoice_data) === null || _g === void 0 ? void 0 : _g.remark) === null || _h === void 0 ? void 0 : _h.invoice_mark) !== null && _j !== void 0 ? _j : ''}</textarea
                        >
                        ...
                        <textarea
                          ...
                          disabled
                        >
${(_m = (_l = (_k = invoiceData.invoice_data) === null || _k === void 0 ? void 0 : _k.remark) === null || _l === void 0 ? void 0 : _l.financial_mark) !== null && _m !== void 0 ? _m : ''}</textarea
                        >
                        <div
                        ...
                        <textarea
                          ...
                          disabled
                        >
${(_q = (_p = (_o = invoiceData.invoice_data) === null || _o === void 0 ? void 0 : _o.remark) === null || _p === void 0 ? void 0 : _p.voidReason) !== null && _q !== void 0 ? _q : ''}</textarea
                        >
                      `),
                                                        ...
                                                        >
                                                          <div class="d-flex flex-column" style="font-size: 14px;">
                                                            ...
                                                            <div class="d-flex">
                                                              ...
                                                              <div>${(_a = orderData.total) !== null && _a !== void 0 ? _a : 0}</div>
                                                            </div>
                                                            <div class="d-flex">
...
${reason}</textarea
                                        ...
                                        `;
                                            ...
                                            if (invoiceData.invoice_data.original_data.Print === '1' &&
                                                window.parent.glitter.share.PayConfig.posType === 'SUNMI') {
                                                v_ = [
