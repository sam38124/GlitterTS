            ...
            reader.onload = (e) => __awaiter(this, void 0, void 0, function* () {
                ...
                data.forEach((row, index) => {
                    ...
                    if (index != 0) {
                        ...
                        variantData.sale_price = (_j = row[16]) !== null && _j !== void 0 ? _j : 0;
                        variantData.compare_price = (_k = row[17]) !== null && _k !== void 0 ? _k : 0;
                        variantData.profit = (_l = row[18]) !== null && _l !== void 0 ? _l : 0;
                        const shipmentTypeMap = {
                            "依材積計算": "volume",
                            "不計算運費": "none"
                        };
                        variantData.shipment_type = shipmentTypeMap[row[19]] || "weight";
                        variantData.v_length = (_m = row[20]) !== null && _m !== void 0 ? _m : 0;
                        variantData.v_width = (_o = row[21]) !== null && _o !== void 0 ? _o : 0;
                        variantData.v_height = (_p = row[22]) !== null && _p !== void 0 ? _p : 0;
                        variantData.weight = (_q = row[23]) !== null && _q !== void 0 ? _q : 0;
                        variantData.show_understocking = (row[25] == "追蹤") ? "true" : "false";
                        variantData.stock = (_r = row[26]) !== null && _r !== void 0 ? _r : 0;
                        variantData.save_stock = (_s = row[27]) !== null && _s !== void 0 ? _s : 0;
                        variantData.barcode = (_t = row[28]) !== null && _t !== void 0 ? _t : "";
                                        ...
                                        return BgWidget.container(html `
                                            ...
                                            gvc.glitter.innerDialog((gvc) => {
                                                return gvc.bindView({
                                                    ...
                                                    view: () => {
                                                        return html `
                                                                                    <div style="display: flex;width:100%;padding: 12px 485px 12px 20px;align-items: center;border-radius: 10px 10px 0px 0px;background: #F2F2F2;color:#393939;font-size: 16px;font-weight: 700;">
                                                                                        匯入商品
                                                                                    </div>
                                            ...
                                            gvc.glitter.innerDialog((gvc) => {
                                                return html `
                                                    ...
                                                    view: () => {
                                                        ...
                                                        let disableCircle = html `
                                                                                                    <div style="border-radius: 20px;border: 1px solid #DDD;background: #DDD;width: 16px;height: 16px;"></div>`;
                                                        return html `
