                                        ...
                                        function getDatalist() {
                                            return data.response.data.map((dd) => {
                                                return [
                                                    ...
                                                    {
                                                        key: '商品',
                                                        value: `<img class="rounded border me-4 " alt="" src="${dd.content.preview_image[0] || 'https://jmva.or.jp/wp-content/uploads/2018/07/noimage.png'}" style="width:40px;height:40px;">` + dd.content.title
                                                    },
                                                    {
                                                        key: '狀態',
