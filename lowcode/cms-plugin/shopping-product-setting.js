...
export class ShoppingProductSetting {
                        ...
                        case 'list':
                            ...
                            return BgWidget.container(html `
                                ...
                                vm.status = 'add';
                                    ...
                                    ${BgWidget.mainCardMbp0(BgWidget.tableV2({
                                gvc: gvc,
                                getData: (vmi) => {
                                    ApiShop.getProduct({
                                        page: vmi.page - 1,
    ...
    static editProductSpec(obj) {
        ...
        `);
            ...
            bind: "right",
            view: () => {
                let rightHTML = postMD.variants.map((data) => {
                    if (!data.editable) {
                        return html `
                                                            <div class="d-flex align-items-center"
            ...
            function updateVariants() {
                ...
                postMD.variants = postMD.variants.filter((variant) => {
                    ...
                    for (const b of variant.spec) {
                        if ((!postMD.specs[index] || !postMD.specs[index].option.find((dd) => {
                            return dd.title === b;
                        }))) {
                            pass = false;
                            break;
                        ...
                        return [BgWidget.containerMax(html `
                            ...
                            <div class="d-flex flex-column flex-column-reverse flex-md-row w-100 p-0" style="gap:10px;">
                                ...
                                return {
                                    ...
                                    ${(postMD.specs.length == 0) ? `` : BgWidget.mainCardMbp0(`<div style="font-size: 16px;font-weight: 700;color:#393939;margin-bottom: 18px;">規格設定</div>` +
                                obj.gvc.bindView(() => {
                                    var _a;
...
"
                                                            ...
                                                            gvc.bindView(() => {
                                                                ...
                                                                return {
                                                                    bind: vm.id,
                                                                    view: () => {
                                                                        return postMD.specs[0].option.map((spec) => {
                                                                            const viewList = [];
                                                                            if (postMD.specs.length > 1) {
                                                                                        ...
                                                                                        view: () => {
                                                                                            return html `
                                                                                                ...
                                                                                                obj.vm.status = 'editSpec';
                                                                                                                    ...
                                                                                                                    <i class="${(data.checked) ? `fa-solid fa-square-check` : `fa-regular fa-square`}"
...
color: ${(data.checked) ? `#393939` : `#DDD`};font-size: 18px;"
                                    ...
                                    view: () => {
                                        ...
                                        try {
                                            let view = [
                                                ...
                                                (() => {
                                                    const href = (() => {
                                                        return `https://${window.parent.glitter.share.editorViewModel.domain}/products?product_id=${postMD.id}`;
                                                    })();
                                            ...
                                            if (toggle) {
                                                view = view.concat(html `
                                                    ...
                                                    postMD.seo.content = e.innerText;
                                                                    ...
                                                                    <textarea rows="4"
                                                                              value="${(_d = postMD.seo.keywords) !== null && _d !== void 0 ? _d : ''}"
                                                                              style="width: 100%;padding: 9px 18px;border-radius: 10px;border: 1px solid #DDD;"
                                                                              onchange="${gvc.event((e) => {
                                                    postMD.seo.keywords = e.innerText;
                                                })}">${(_e = postMD.seo.keywords) !== null && _e !== void 0 ? _e : ""}</textarea>
                                                                `);
                                            }
                                            return view.join('');
                                        }
                                ...
                                <div style="min-width:260px; max-width:100%;">
                                    ${BgWidget.mainCardMbp0(`  <div style="font-weight: 700;" class="mb-2">商品狀態</div>` +
                                EditorElem.select({
                                    gvc: obj.gvc,
                                    title: '',
                                    def: postMD.status,
