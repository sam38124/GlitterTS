                            ...
                            BgWidget.container(html `
                                ...
                                html: [
                                    BgWidget.mainCard(html `
                                        ...
                                        title: '',
                                        type: 'text',
                                        default: (_e = language_data.title) !== null && _e !== void 0 ? _e : '',
                                        placeHolder: '請輸入商品名稱',
                                        callback: (text) => {
                                            ...
                                            return {
                                                ...
                                                view: () => __awaiter(this, void 0, void 0, function* () {
                                                    return html ` <div class="d-flex align-items-center justify-content-end ">
                                                                    ...
                                                                    ${BgWidget.grayNote('將顯示於商品標題下方，快速表示商品內容')}
                                                                    <div class="my-3">
                                                                        ${gvc.bindView((() => {
                                                        var _b;
                                                        const id = gvc.glitter.getUUID();
                                    ...
                                    postMD.specs.length
                                        ? BgWidget.mainCard(obj.gvc.bindView(() => {
                                            ...
                                            return {
                                                ...
                                                view: () => {
                                                    let returnHTML = html `
                                                                      <div style="font-size: 16px;font-weight: 700;gap:2px;" class="d-flex flex-column">
                                                                          <div class="d-flex align-items-center">前台規格顯示文字 ${BgWidget.languageInsignia(sel_lan(), 'margin-left:5px;')}</div>
                                                                          ${BgWidget.grayNote(`未設定則參照預設`)}
                                                                      </div>
                                                                  `;
                                                    let editSpectPage = [];
                                                    if (postMD.specs.length > 0) {
                                                        ...
                                                        postMD.specs.map((d, index) => {
                                                            ...
                                                            d.option = (_c = d.option) !== null && _c !== void 0 ? _c : [];
                                                            specs_in_line.push(html ` <div class="d-flex flex-column">
                                                                ...
                                                                var _b;
                                                                d.language_title = (_b = d.language_title) !== null && _b !== void 0 ? _b : {};
                                                                return html ` <div class="d-flex align-items-center mt-2" style="gap:10px;">
                                                                                              <div class="fw-500">${d.title}</div>
                                                                                              <input
                                                                                                  class="form-control"
                                                                                                  placeholder="${d.title}"
...
${(_d = language_data.seo.content) !== null && _d !== void 0 ? _d : ''}</textarea
                                ...
                                html: html ` <div class="summary-card p-0">
                                    ...
                                    BgWidget.mainCard(html ` <div class="mb-2" style="font-weight: 700;">銷售管道</div>
                                        ...
                                        { key: 'pos', name: 'POS' },
                                    ], (_f = postMD.channel) !== null && _f !== void 0 ? _f : [], (text) => {
                                        postMD.channel = text;
                                    }, { single: false })}`),
