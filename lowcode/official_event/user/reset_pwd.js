...
TriggerEvent.createSingleEvent(import.meta.url, () => {
    return {
        fun: (gvc, widget, object, subData, element) => {
            ...
            object.oldPwd = (_f = object.oldPwd) !== null && _f !== void 0 ? _f : {};
            return {
                editor: () => {
                    return [
                        TriggerEvent.editer(gvc, widget, object.oldPwd, {
                            hover: false,
                            option: [],
                            title: "取得舊密碼"
                        }),
                ...
                event: () => {
                    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
                        var _a;
                        const oldPwd = yield TriggerEvent.trigger({
                            gvc: gvc, widget: widget, clickEvent: object.oldPwd
                        });
                        ...
                        if (resetPwd !== confirmPwd) {
                            ...
                            (_a = ApiUser.resetPwdCheck(oldPwd, resetPwd)) === null || _a === void 0 ? void 0 : _a.then((r) => __awaiter(void 0, void 0, void 0, function* () {
