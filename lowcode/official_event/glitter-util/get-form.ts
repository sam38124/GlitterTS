...
TriggerEvent.createSingleEvent(import.meta.url, () => {
    return {
        fun: (gvc, widget, object, subData,element) => {
            ...
            object.formFROM = object.formFROM ?? "code"
                                                ...
                                                return {
                                                    ...
                                                    view: () => {
                                                        return [
                                                            ...
                                                            <div class="add_item_button ${(vm.page === 'form') ? `add_item_button_active` : ``}" onclick="${
                                                                gvc.event(() => {
                                                                    vm.page = 'form'
                                                                    gvc.notifyDataChange(id)
                                                                })
                                                            }">資料填寫</div>
                                                            <div class=" add_item_button ${(vm.page === 'setting') ? `add_item_button_active` : ``}" onclick="${
                                                                gvc.event(() => {
                                                                    vm.page = 'setting'
                                                                    gvc.notifyDataChange(id)
                                                                })
