...
export function appCreate(gvc, viewModel, id) {
    ...
    function save(key, next) {
        ...
        saasConfig.api.setPrivateConfig(saasConfig.config.appName, `glitter_appPost_${key}`, vmk[key]).then((r) => {
    ...
    function getHtml(key) {
        ...
        const id = glitter.getUUID();
        let load = false;
        saasConfig.api.getPrivateConfig(saasConfig.config.appName, `glitter_appPost_${key}`).then((r) => {
