...
function styleList(gvc, viewModel, id) {
    var _a;
    const glitter = gvc.glitter;
    viewModel.initialStyle = (_a = viewModel.initialStyle) !== null && _a !== void 0 ? _a : [];
    return `${gvc.bindView(() => {
        ...
        return {
            ...
            view: () => {
                return EditorElem.arrayItem({
                    ...
                    gvc: gvc,
                    title: '文字區塊內容',
                    array: viewModel.initialStyle.map((dd, index) => {
                        return {
                                    ...
                                    view: () => {
                                        return gvc.map([
                                            ...
                                            EditorElem.arrayItem({
                                                ...
                                                gvc: gvc,
                                                title: '群組連結',
                                                array: dd.src.links.map((d2, index) => {
                                                    return {
