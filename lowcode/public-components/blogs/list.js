        ...
        return obj.gvc.bindView(() => {
            ...
            function loadData() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    vm.collection = (yield ApiUser.getPublicConfig('blog_collection', 'manager')).response.value;
                    vm.seo = (yield ApiUser.getPublicConfig(`article_seo_data_${Language.getLanguage()}`, 'manager')).response.value;
                    ...
                    Article.get({
                        ...
                        vm.loading = false;
                        vm.pageSize = Math.ceil(res.response.total / parseInt(vm.limit, 10));
...
color:${theme_color.solid_text};" >${dd.title}</div>`;
              ...
              <div class="spinner-border"></div>
                        ...
                        map_v.push(html `<div class="d-flex align-items-center justify-content-center flex-column w-100 mx-auto">
                <lottie-player
...
BlogList.pageSplitV2 = (gvc, countPage, nowPage, callback) => {
    const generator = (n) => {
