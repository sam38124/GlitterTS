...
export class CheckoutIndex {
    static main(gvc, widget, subData) {
      ...
      `);
                ...
                new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (onlineData.interaction) {
                        ...
                        data.lineItems.forEach((lineItem) => {
                            let product = onlineData.interaction.content.item_list.find((item) => {
        ...
        function formatterFormElement(dd) {
            dd.col = '4';
            ...
            return (gvc.bindView((() => {
                return {
                    ...
                    <div class="${gClass(['price-row', 'text-2'])}">
                      ...
                      <div>
                        ${Currency.convertCurrencyText(vm.cartData.total - vm.cartData.shipment_fee + vm.cartData.discount + vm.cartData.use_rebate)}
                      </div>
                    </div>
                    <div class="${gClass(['price-row', 'text-2'])}">
                          ...
                          <div class="${gClass(['price-row', 'text-2'])}">
                            ${(() => {
                                      ...
                                      ${vm.rebateConfig.title} ${Language.text('discount')}`;
                                        ...
                                        ${info.limit.toLocaleString()} ${Language.text('point')}
                                        ${vm.rebateConfig.title}`;
                                                    }
                                                    else {
                    ...
                    <div class="${gClass(['price-row', 'text-2', 'bold'])}">
                      ...
                      <div class="${gClass('total_amount')}">${Currency.convertCurrencyText(vm.cartData.total)}</div>
                            ...
                            if (!widget.share.custom_form_checkout) {
                                const res = yield ApiUser.getPublicConfig('custom_form_checkout', 'manager');
                                widget.share.custom_form_checkout = FormCheck.initialCheckOutForm((_b = res.response.value.list) !== null && _b !== void 0 ? _b : []);
                                vm.cartData.custom_form_format = widget.share.custom_form_checkout.filter((dd) => {
                                    return !['name', 'email', 'phone'].includes(dd.key);
                                });
                            }
                    ...
                    ${gvc.bindView((() => {
                                ...
                                <div
                                  ...
                                  style="${document.body.clientWidth > 800 &&
                                                ...
                                                : `gap:20px;`} padding-left:${padding > 0
                                                ? padding
                                                : 10}px;padding-right:${padding > 0 ? padding : 10}px;"
                                >
                                  <div
                                    style="${document.body.clientWidth > 800
                                                ? `width:calc(66% - 10px);`
                                      ...
                                      ${html ` <section>
                                        ...
                                        <div class="row mt-3 mx-1 mx-sm-0 my-md-3">
                                          ...
                                          <div class="col-12 col-md-6 mb-2">
                                            <label class="${gClass('label')}"
                                              >${Language.text('shipping_method')}</label
                                            >
                                            ${gvc.bindView({
                                                bind: ids.shipping,
                                                view: () => {
                                          ...
                                          ${(() => {
                                                ...
                                                return [
                                                    ...
                                                    'black_cat_freezing',
                                                    'black_cat_ice',
                                                ].includes(vm.cartData.user_info.shipment);
                                            })()
                                                ? gvc.bindView(() => {
                                                    const id = gvc.glitter.getUUID();
                                                    gvc.addStyle(`
                                                ...
                                                <button
                                                  ...
                                                  onclick="${gvc.event(() => {
                                                    ApiDelivery.storeMaps({
                                                        ...
                                                        if (ApplicationConfig.device_type === 'ios') {
                                                            glitter.runJsInterFace('post_form', {
                                                            ...
                                                            document.querySelector(`#${form_id} #submit`).click();
                                                        }
                                                    }));
                                                })}"
                                                >
                                          ...
                                          onclick="${gvc.event(() => {
                                                ApiUser.getUserData(GlobalUser.token, 'me').then(res => {
                                                    ...
                                                    [
                                                        ...
                                                        vm.cartData.user_info[dd.key] =
                                                            dd.refer || vm.cartData.user_info[dd.key];
                                                    });
                                                    this.storeLocalData(vm.cartData);
                                                    ...
                                                    view: () => __awaiter(this, void 0, void 0, function* () {
                                                        try {
                                                            ...
                                                            vm_info.list = [
                                                                ...
                                                                return ((dd.key !== 'name' && dd.key !== 'phone' && dd.key !== 'email') ||
                                                                    !vm.cartData.user_info_same ||
                                                                    !widget.share.custom_form_checkout.find((d1) => {
                                          ...
                                          >
                                            ${(() => {
                                                    if (verify.length > 0) {
                                                        return verify
                                                            .map(dd => {
                                                            return html `<div class="text-danger" style="font-size: 13px;">
                                                      ${dd}
                                                    </div>`;
                                                        })
                                                            .join('');
                                                    ...
                                                    <button
                                                      ...
                                                      onclick="${gvc.event(() => {
                                                            ...
                                                            function next() {
                                                                ...
                                                                if (vm.cartData.user_info_same) {
                                                                    vm.cartData.user_info.name = vm.cartData.customer_info.name;
                                                                    vm.cartData.user_info.phone =
                                                                        vm.cartData.customer_info.phone;
                                                                    vm.cartData.user_info.email =
                                                                        vm.cartData.customer_info.email;
                                                                }
                                                                if (verify.length > 0) {
                                                                    return;
                                                                }
                                                                ...
                                                                for (const item of vm.cartData.lineItems) {
                                                                    ...
                                                                    if (max_qty > 0 &&
                                                                        count + item.buy_history_count > max_qty) {
                                                                        dialog.errorMessage({
                                                                ...
                                                                vm.cartData.user_info.note =
                                                                    ((_a = vm.cartData.user_info.note) !== null && _a !== void 0 ? _a : '') +
                                                                        ((_b = check_out_sub.note) !== null && _b !== void 0 ? _b : '');
                                                                ApiShop.toCheckout({
                                                                    ...
                                                                    if (res.response.off_line || res.response.is_free) {
                                                                        ...
                                                                        if (res.response.returnCode == '0000' &&
                                                                            ...
                                                                            if (glitter.share.is_application) {
                                                                                ...
                                                                                location.href =
                                                                                    res.response.result_object.payment_url;
                                                                            }
                                                                        }
                                                                        else {
                                                                            const id = gvc.glitter.getUUID();
    ...
    static getPaymentMethod(cartData) {
        ...
        if (cartData.payment_info_custom && cartData.payment_info_custom.length > 0) {
            cartData.payment_info_custom.map((item) => {
