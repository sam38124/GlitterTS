                                                                                            ...
                                                                                            <div class="d-flex flex-column border-bottom p-lg-3 px-1 py-3 gap-3">
                                                                                                <div class="d-flex w-100   position-relative"
                                                                                                    ...
                                                                                                    <div class="d-flex flex-sm-row    flex-column w-100 position-relative"
                                                                                                        ...
                                                                                                        <span class="d-flex align-items-start flex-column d-lg-none fw-bold pe-3"
                                ...
                                view: () => __awaiter(this, void 0, void 0, function* () {
                                    try {
                                        ...
                                        vm_info.list = [
                                            ...
                                            return (dd.key !== 'name' && dd.key !== 'phone' && dd.key !== 'email') || (!vm.cartData.user_info_same || (!(widget.share.custom_form_checkout.find((d1) => {
