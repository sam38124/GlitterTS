                                      ...
                                      ${html` <section>
                                        ...
                                        <div class="row mt-3 mx-1 mx-sm-0 my-md-3">
                                                  ...
                                                  onclick="${gvc.event(() => {
                                                    ApiDelivery.storeMaps({
                                                      ...
                                                      if (ApplicationConfig.device_type === 'ios') {
                                                        ...
                                                        $('body').append(
                                                          `<div id="${form_id}">${res.response.form}</div>`
                                                        );
                                          ...
                                          ${(() => {
                                            ...
                                            if (ship_method && ship_method.system_form) {
                                              return (ship_method.system_form ?? []).includes(
                                                        ...
                                                        function next() {
                                                          ...
                                                          ApiShop.toCheckout({
                                                            ...
                                                            return_url: (() => {
                                                              ...
                                                              if (
                                                                ApplicationConfig.device_type === 'ios' &&
                                                            ...
                                                            if (res.response.off_line || res.response.is_free) {
                                                              ...
                                                              if (
                                                                ...
                                                                (
                                                                  document.querySelector(`#${id} #submit`) as any
                                                                ).click();
                                                              }
                                                            }
                                                          });
