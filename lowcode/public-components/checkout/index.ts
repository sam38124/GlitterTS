                    ...
                    view: async () => {
                        try {
                            ...
                            if (!widget.share.receipt_form) {
                                ...
                                widget.share.receipt_form = FormCheck.initialRecipientForm(res.response.value.list ?? []);
                                                ...
                                                view: async () => {
                                                    try {
                                                        ...
                                                        vm_info.list = [
                                                            ...
                                                            return (dd.key !== 'name' && dd.key !== 'phone' && dd.key !== 'email') || (!vm.cartData.user_info_same || (!(widget.share.custom_form_checkout.find((d1: any) => {
