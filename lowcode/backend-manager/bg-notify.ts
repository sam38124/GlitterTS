                                                                    ...
                                                                    callback: (response) => {
                                                                        if (response) {
                                                                            ...
                                                                            ApiUser.deleteSubscribe({
                                                                                email: vm.dataList.filter((dd: any) => {
                                                                                    return dd.checked
                                                                                }).map((dd: any) => {
                                                                                    return dd.email
                                                                                }).join(`,`)
                        ...
                        return {
                            ...
                            view: () => {
                                return [
                                    ...
                                    EditorElem.h3(`<div class="d-flex align-items-center">信件內文<button class=" btn ms-2 btn-primary-c ms-2" style="height: 30px;width: 60px;" onclick="${
                                            obj.gvc.event(() => {
