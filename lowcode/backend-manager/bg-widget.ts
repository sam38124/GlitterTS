                                                        ...
                                                        vm.edit_mode
                                                            ...
                                                            : {
                                                                  ...
                                                                  value: html`
                                                                      ...
                                                                      >
                                                                          <div style="font-size: 16px; font-family: Noto Sans; font-weight: 400; word-wrap: break-word">選擇</div>
                                                                      </div>
                                                                  `,
                                                              },
                                                        {
                                                            key: '標籤',
                                                            value: html` <div class="d-flex flex-shrink-0" style="width:${elementLength}px;font-size: 16px;font-style: normal;font-weight: 700;">
                                                                ${BgWidget.editeInput({
                                                                    gvc: gvc,
                                                                    title: ``,
                                                                    placeHolder: '請輸入標籤',
                ...
                if (vm.edit_mode) {
                    return html` <div class="w-100 justify-content-end d-flex " style="gap:10px;">
                        ${BgWidget.cancel(
                            ...
                            html` <div class=" d-flex align-items-center justify-content-center cursor_pointer" style="color: #36B; font-size: 16px; font-weight: 400;">
                                <div>添加語句</div>
...
${obj.default ?? ''}</textarea
                                        ...
                                        return gvc.bindView({
                                            ...
                                            view: () => {
                                                ...
                                                return vm.tableData[0]
                                                    .map((dd, index: number) => {
                                                        return html` <div class="${ids.headerCell} ${ids.textClass} tb_v3 tx_700" style="min-width: ${widthList[index]}px;">${dd.key}</div>`;
                                                    })
                                                    .join('');
                                            },
                                            divCreate: {
        ...
        return obj.gvc.bindView({
            ...
            view: () => {
                ...
                return html` <div class="c_select" style="position: relative; ${obj.style ?? ''}">
                        ...
                        >
                            <div style="font-size: 15px; cursor: pointer; color: #393939;">
                                ${defData ? defData.value : BgWidget.grayNote(obj.placeholder ?? '（點擊選擇項目）', 'font-size: 16px;')}
                            </div>
                        </div>
                        ${vm.show
                            ? html` <div class="c_dropdown">
                                      ...
                                      <div class="c_dropdown_main" style="gap: 8px; padding: 12px;">
                                          ${obj.gvc.map(
                                              obj.options.map((opt) => {
                                                  ...
                                                  return html` <div class="d-flex align-items-center ${vm.random}-opt" onclick="${obj.gvc.event(() => call())}">
    ...
    static variantDialog(obj: { gvc: GVC; default: string[]; title: string; callback: (value: any, status?: number) => void }) {
                        ...
                        return html` <div class="bg-white shadow rounded-3" style="width: 100%; overflow-y: auto;">
                            ...
                            <div class="c_dialog">
                                <div class="c_dialog_body">
                                    <div
                                        class="c_dialog_main"
                                        style="${obj.d_main_style || ''};gap: 24px; ${obj.height ? `height:${obj.height}px;max-height: 100vh;` : `height:auto;max-height: 500px;`} "
                                    >
                                        ${obj.innerHTML(gvc) ?? ''}
                                    </div>
                    ...
                    >
                        <div class=" shadow rounded-3" style="width: 100%; overflow-y: auto;">
                            <div class="c_dialog" style="background-color: #393939;">
                                <div class="c_dialog_body">
                                    <div class="c_dialog_main" style="${obj.style ? obj.style : `gap: 24px; height: ${obj.height ? `${obj.height}px` : 'auto'}; max-height: 500px;padding:20px;`}">
                                        ${obj.innerHTML && obj.innerHTML(gvc)}
                                    </div>
                                </div>
                            </div>
                        ...
                        return html` <div class="bg-white shadow rounded-3" style="width: 100%; max-height: 100%; overflow-y: auto; position: relative;">
                            ...
                            <div class="c_dialog h-100">
                                <div class="c_dialog_body h-100">
                                    <div class="c_dialog_main h-100" style="max-height: 100%; padding: 0; gap: 24px; z-index: 1; position: relative;">${obj.innerHTML(gvc) ?? ''}</div>
    ...
    static imageLibraryDialog(obj: { gvc: GVC; title: string; innerHTML: (gvc: GVC) => string; footer_html: (gvc: GVC) => string; closeCallback?: () => void; closeTarget?: string }) {
                        ...
                        return html` <div class="bg-white shadow rounded-3 h-100 d-flex flex-column" style="width: 100%; ">
                            ...
                            <div class="c_dialog flex-fill">
                                <div class="c_dialog_body d-flex flex-column h-100">
                                    <div class="c_dialog_main flex-fill" style="gap: 24px;max-height:100%; ">${obj.innerHTML(gvc) ?? ''}</div>
