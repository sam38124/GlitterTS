...
export class BgCustomerMessage {
    static leftNav(gvc) {
        ...
        return html ` <div
            ...
            ></div>
            <div id="BgCustomerMessage" class="position-fixed left-0 top-0 h-100 bg-white shadow-lg " style="width:480px;z-index: 99999;left: -100%;">
                                ...
                                return {
                                    ...
                                    view: () => {
                                        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                                            ...
                                            const dialog = new ShareDialog(gvc.glitter);
                                            resolve(html ` <div class="position-relative bgf6 d-flex align-items-center justify-content-between m-n2 p-2 border-bottom shadow">
                    ...
                    return [
                      ...
                      <div class="d-flex align-items-center pe-3 w-100" style="gap:10px;display: flex;align-items: center;">
                        ...
                        <img src="${chatRoom.type === 'user'
                                            ...
                                            : `https://d3jnmi1tfjgtti.cloudfront.net/file/252530754/1704269678588-43.png`}" class="rounded-circle border" style="background: white;" width="40" alt="Albert Flores">
                        ...
                        gvc.bindView(() => {
                            ...
                            return {
                                ...
                                <span class="mt-2">載入中...</span>
                                    ...
                                    return html ` <div class="chatContainer p-3" style="overflow-y: auto;height: calc(${cf.containerHeight} - 220px);background: white;padding-bottom:80px !important;">
                                            ${vm.data
                                        .map((dd, index) => {
                                        ...
                                        if (cf.user_id !== dd.user_id) {
                                            return html ` <div class="d-flex align-items-start ${vm.data[index + 1] && vm.data[index + 1].user_id === dd.user_id ? `mb-1` : `mb-3`}">
                                                            <img
                                            ...
                                            return html ` <div
                                                            class="d-flex align-items-start justify-content-end ${vm.data[index + 1] && vm.data[index + 1].user_id === dd.user_id ? `mb-1` : `mb-3`}"
                                                        >
                ...
                view: () => {
                    ...
                    return html `
                        <div class=" card rounded-3">
                            <div class="p-3 rounded-top" style="width: 100%;white-space: normal;background: ${BgCustomerMessage.config.color};">
                                <div class="text-white fw-bold" style=" font-size: 20px;">${(_a = BgCustomerMessage.config.title) !== null && _a !== void 0 ? _a : ''}</div>
                                <p class=" text-white mt-2 mb-4" style=" font-size: 16px;line-height: 22px;font-weight: 300;">${((_b = BgCustomerMessage.config.content) !== null && _b !== void 0 ? _b : '').replace(/\n/g, `<br>`)}</p>
                                <button
                ...
                onCreate: () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const roBotView = `<div class="position-fixed  rounded-3 shadow-lg " style="${gvc.glitter.ut.frSize({
                        sm: css `
                            ...
                            overflow: hidden;
                            background: white;
                        `)}">${BgCustomerMessage.robotMessage(gvc, (text) => __awaiter(this, void 0, void 0, function* () {
                        vm.viewType = 'message';
                        if (text) {
                        ...
                        view: gvc.bindView(() => {
                            return {
                                ...
                                view: () => {
                                    ...
                                    >
                                        <i class="${open ? `fa-sharp fa-regular fa-xmark` : `fa-solid fa-message-dots `}" style=" color: white;font-size: 30px;"></i>
                                        ${gvc.bindView(() => {
                                        const id = gvc.glitter.getUUID();
                                        let unread = 0;
                                        return {
