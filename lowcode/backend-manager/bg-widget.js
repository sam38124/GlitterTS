...
export class BgWidget {
    ...
    static darkButton(text, event, obj) {
        ...
        return html `
            <button class="btn btn-black ${size.btn} ${(_a = obj === null || obj === void 0 ? void 0 : obj.class) !== null && _a !== void 0 ? _a : ''}" type="button" style="${(_b = obj === null || obj === void 0 ? void 0 : obj.style) !== null && _b !== void 0 ? _b : ''}"
                    onclick="${event}">
        ...
        ;
        static;
        darkButton(text, string, event, string, obj ?  : { icon: string, textStyle: string, class: string, style: string });
        {
            return html `
                <button type="button" class="btn btn-black ${(_d = obj === null || obj === void 0 ? void 0 : obj.class) !== null && _d !== void 0 ? _d : ''}" style="${(_e = obj === null || obj === void 0 ? void 0 : obj.style) !== null && _e !== void 0 ? _e : ''}"
                        onclick="${event}">
                    <i class="${obj && obj.icon && obj.icon.length > 0 ? obj.icon : 'd-none'}"></i>
                    <span class="tx_700_white" style="${(_f = obj === null || obj === void 0 ? void 0 : obj.textStyle) !== null && _f !== void 0 ? _f : ''}">${text}</span>
                </button>`;
                >>>  >>>  >
                e84d9bea2f7e2a93022f8c0514b4dc09be5fe539;
        }
        static;
        redButton(text, string, event, string, obj ?  : { icon: string, textStyle: string });
        {
            return html `
                <button class="btn btn-red" type="button" onclick="${event}">
                    <i class="${obj && obj.icon && obj.icon.length > 0 ? obj.icon : 'd-none'}"></i>
                    <span class="tx_700_white" style="${(_g = obj === null || obj === void 0 ? void 0 : obj.textStyle) !== null && _g !== void 0 ? _g : ''}">${text}</span>
                </button>`;
        }
        static;
        plusButton(obj, {
        ...
        static;
        switchButton(gvc, GVC, def, boolean, callback, (value) => void );
        {
            return html `
        ...
        static;
        switchTextButton(gvc, GVC, def, boolean, text, {
            left: string,
            right: string
        }, callback, (value) => void );
        {
            return html `
                <div style="display: flex; align-items: center;">
                    <div class="tx_normal me-2">${(_h = text.left) !== null && _h !== void 0 ? _h : ''}</div>
                ...
                callback(e.checked);
                    ...
                    <div class="tx_normal">${(_j = text.right) !== null && _j !== void 0 ? _j : ''}</div>
                </div>`;
        }
        static;
        goBack(event, string);
        ...
        static;
        horizontalLine(css ?  : { color: string, size: number, margin: number });
        {
            return html `
                <div class="w-100"
                     style="margin: ${(_k = css === null || css === void 0 ? void 0 : css.margin) !== null && _k !== void 0 ? _k : 1}rem 0; border-bottom: ${(_l = css === null || css === void 0 ? void 0 : css.size) !== null && _l !== void 0 ? _l : 1}px solid ${(_m = css === null || css === void 0 ? void 0 : css.color) !== null && _m !== void 0 ? _m : '#DDD'}"></div>`;
        }
        static;
        editeInput(obj, {
            gvc: GVC,
        ...
        {
            obj.title = (_o = obj.title) !== null && _o !== void 0 ? _o : '';
            return html `
                <div style="${(_p = obj.divStyle) !== null && _p !== void 0 ? _p : ''}">
                    ${obj.title ? html `
                        <div class="tx_normal fw-normal" style="${(_q = obj.titleStyle) !== null && _q !== void 0 ? _q : ''}">${obj.title}</div>` : ``}
                    <div class="d-flex w-100 align-items-center border rounded-3 ${obj.readonly ? `bgw-input-readonly` : ``}"
                        ...
                        <input
                                ...
                                style="${(_r = obj.style) !== null && _r !== void 0 ? _r : ''}"
                                type="${(_s = obj.type) !== null && _s !== void 0 ? _s : 'text'}"
                ...
                if (obj.pattern) {
                    ...
                    if (value !== validValue) {
                        e.value = validValue;
                                ...
                                value="${(_t = obj.default) !== null && _t !== void 0 ? _t : ''}"
        ...
        {
            obj.title = (_u = obj.title) !== null && _u !== void 0 ? _u : '';
            ...
            <div class="w-100 px-1" style="margin-top:8px;">
                ...
                obj.callback(e.value);
                        ...
                        placeholder="${(_v = obj.placeHolder) !== null && _v !== void 0 ? _v : ''}"
                        ${obj.readonly ? `readonly` : ``}
                >
${(_w = obj.default) !== null && _w !== void 0 ? _w : ''}</textarea
                >
            </div>`;
        }
        static;
        searchPlace(event, string, vale, string, placeholder, string, margin, string = '16px 0 0 0');
        {
            return html `
        ...
        {
            obj.title = (_x = obj.title) !== null && _x !== void 0 ? _x : '';
            const vm = {
            ...
            const linkComp = {
                id: obj.gvc.glitter.getUUID(),
                loading: true,
                text: (_y = obj.default) !== null && _y !== void 0 ? _y : '',
            };
            const dropMenu = {
                id: obj.gvc.glitter.getUUID(),
        ...
        });
        {
            return html `<select
                    ...
                    style="${(_z = obj.style) !== null && _z !== void 0 ? _z : ''}; ${obj.readonly ? 'background: #f7f7f7;' : ''}"
                    onchange="${obj.gvc.event((e) => {
                obj.callback(e.value);
            })}"
        ...
        static;
        dotlottieJS = 'https://unpkg.com/@dotlottie/player-component@latest/dist/dotlottie-player.mjs';
        static;
        maintenance();
        {
            return html `
        ...
        {
            const container = {
                class: `${(_1 = (_0 = obj === null || obj === void 0 ? void 0 : obj.container) === null || _0 === void 0 ? void 0 : _0.class) !== null && _1 !== void 0 ? _1 : ''}`,
                style: `margin-top: 2rem ;${(_2 = obj === null || obj === void 0 ? void 0 : obj.container) === null || _2 === void 0 ? void 0 : _2.style}`,
            };
            const circleAttr = {
                visible: ((_3 = obj === null || obj === void 0 ? void 0 : obj.circle) === null || _3 === void 0 ? void 0 : _3.visible) === false ? false : true,
                width: (_5 = (_4 = obj === null || obj === void 0 ? void 0 : obj.circle) === null || _4 === void 0 ? void 0 : _4.width) !== null && _5 !== void 0 ? _5 : 20,
                borderSize: (_7 = (_6 = obj === null || obj === void 0 ? void 0 : obj.circle) === null || _6 === void 0 ? void 0 : _6.borderSize) !== null && _7 !== void 0 ? _7 : 16,
            };
            const textAttr = {
                value: (_9 = (_8 = obj === null || obj === void 0 ? void 0 : obj.text) === null || _8 === void 0 ? void 0 : _8.value) !== null && _9 !== void 0 ? _9 : '載入中...',
                visible: ((_10 = obj === null || obj === void 0 ? void 0 : obj.text) === null || _10 === void 0 ? void 0 : _10.visible) === false ? false : true,
                fontSize: (_12 = (_11 = obj === null || obj === void 0 ? void 0 : obj.text) === null || _11 === void 0 ? void 0 : _11.fontSize) !== null && _12 !== void 0 ? _12 : 16,
            };
            return html `
                            ...
                            return html `
                                ...
                                ? html `
                                                        <div class="fs-2 text-center"
                                                             style="padding-bottom:32px;white-space:nowrap;">
                                                            ${vm.stateText}
                                                        </div>`
                                : html `${vm.data
                                    .map((dd, index) => {
        ...
        static;
        container(htmlString, string, width ?  : number, style ?  : string);
        {
            return html `
                <div
        ...
        static;
        duringInputContainer(gvc, GVC, obj, {
            centerText: string,
            list: {
                key: string,
                type: string,
        ...
        }, def, string[], callback, (value) => void );
        {
            ...
            if (obj.list.length > 1) {
                ...
                return html `
                    <div style="width: 100%; display: flex; flex-direction: column; gap: 6px;">
                        <input
                                class="form-control"
                                type="${(_13 = first.type) !== null && _13 !== void 0 ? _13 : 'text'}"
                                style="border-radius: 10px; border: 1px solid #DDD; padding-left: 18px;"
                                placeholder="${(_14 = first.placeHolder) !== null && _14 !== void 0 ? _14 : ''}"
                    ...
                    callback(defualt);
                        ...
                        <input
                                class="form-control"
                                type="${(_15 = second.type) !== null && _15 !== void 0 ? _15 : 'text'}"
                                style="border-radius: 10px; border: 1px solid #DDD; padding-left: 18px;"
                                placeholder="${(_16 = second.placeHolder) !== null && _16 !== void 0 ? _16 : ''}"
                                onchange="${gvc.event((e, ele) => {
                    defualt[1] = e.value;
                    callback(defualt);
                })}"
        ...
        static;
        radioInputContainer(gvc, GVC, data, {
            key: string,
            name: string,
            type: string,
            placeHolder: string,
        ...
        static;
        multiCheckboxContainer(gvc, GVC, data, {
            key: string,
            name: string,
            innerHtml: string,
            hiddenLeftLine: boolean,
            customerClass: string
        }[], def, string[], callback, (value) => void , obj ?  : {
            readonly: boolean,
            single: boolean,
            zeroOption: boolean
        });
        {
            ...
            return gvc.bindView({
                ...
                view: () => {
                    ...
                    return html `
                        <div style="width: 100%; display: flex; flex-direction: column; gap: 6px;">${checkboxHTML}
                        </div> `;
                },
            });
        }
        ...
        {
            obj.type = (_17 = obj.type) !== null && _17 !== void 0 ? _17 : 'single';
            const gvc = obj.gvc;
        ...
        static;
        mbContainer(margin_bottom_px, number);
        {
            return html `
                <div style="margin-bottom: ${margin_bottom_px}px"></div>`;
        }
        static;
        card(htmlString, string, classStyle, string = 'p-3 bg-white rounded-3 shadow border w-100');
        {
            return html `
                <div class="${classStyle}">${htmlString}</div>`;
        }
        static;
        mainCard(htmlString, string, classString ?  : string, styleString ?  : string);
        {
            return html `
        ...
        tab(data, {
            title: string,
            key: string
        }[], gvc, GVC, select, string, callback, (key) => void , style ?  : string);
        {
            return html `
                <div
        ...
        static;
        alertInfo(title, string, messageList ?  : string[], css, {
            class: string,
            style: string
        }
            = {
        ...
        static;
        selEventButton(text, string, event, string);
        {
            return html `
                ...
                view: () => {
                    if (vm.show) {
                        return html `
                            ...
                            return html `
                                                            <div class="cursor_pointer" onclick="${opt.event}">
                                                                ${opt.name}
                                                            </div>`;
                        }))}
                                        </div>
        ...
        static;
        summaryHTML(stringArray, string[][]);
        {
            return stringArray
                .map((list) => {
                return list
        ...
        string;
        {
            ...
            .box-container-${text}.open-box {
                max-height: ${(_18 = obj.openHeight) !== null && _18 !== void 0 ? _18 : 500}px;
        ...
        `);
            return html `
                <div class="box-tag-${obj.tag} box-container-${text}">
                    <div
                            class="box-navbar-${text} ${(_19 = obj.guideClass) !== null && _19 !== void 0 ? _19 : ''}"
        ...
        });
        {
            return html `<select
                    class="c_select"
                    style="${(_20 = obj.style) !== null && _20 !== void 0 ? _20 : ''}"
                    onchange="${obj.gvc.event((e) => {
                obj.callback(e.value);
            })}"
            >
        ...
        static;
        searchFilter(event, string, vale, string, placeholder, string, margin ?  : string);
        {
            return html `
...
"fa-regular fa-arrow-up-arrow-down" > /i>
    < /div>;
$;
{
    obj.gvc.bindView({
        ...
        view: () => {
            if (vm.show) {
                return html `
                            <div class="c_fixed" style="top: ${vm.top}
    px;
    right: calc
(
    100
...
- ${vm.right}
    ...
    class = "form-check d-flex flex-column"
    style = "gap: 16px" >
        ${obj.gvc.map(obj.options.map((opt) => {
                    return html `
                                                    <div>
...
/ >
<label class = "form-check-label c_updown_label"
for= "${opt.key}" >${opt.value}</label>
    < /div>`;
                }))}
</div>
< /div>`;
...
`;
    ...
    static sortFilter(obj: { gvc: GVC; callback: (value: any) => void; default: string; options: OptionsItem[] }) {
        const vm = {
            id: obj.gvc.glitter.getUUID(),
            checkClass: this.getDarkDotClass(obj.gvc),
            show: false,
...
$;
{
    obj.gvc.bindView({
        ...
        view: () => {
            if (vm.show) {
                return html `
                                <div class="c_fixed" style="top:20px; right: 0;position:absolute;">
...
"c_select";
style = "position: relative; ${obj.style ?? ''}" >
    class {
    };
...
"
    >
        style;
"font-size: 15px; cursor: pointer; color: #393939;" >
    $;
{
    defLine.length > 0
        ? defLine
            ...
            .
                join(' / ')
        :
            BgWidget.grayNote((_a = obj.placeholder) !== null && _a !== void 0 ? _a : '（點擊選擇項目）', 'font-size: 16px;');
}
/div>
    < /div>;
$;
...
settingDialog(obj, {
    gvc: GVC,
    title: string,
    innerHTML: (gvc) => string,
    footer_html: (gvc) => string,
    closeCallback: () => void 
});
{
    const glitter = (() => {
    ...
    return obj.gvc.glitter.innerDialog((gvc) => {
        ...
        return html `
            ...
            if ((_a = obj.cancel) === null || _a === void 0 ? void 0 : _a.event) {
                (_b = obj.cancel) === null || _b === void 0 ? void 0 : _b.event().then((response) => {
            ...
            ? html `
                ...
                ? BgWidget.save(gvc.event(() => {
                    var _a;
                    (_a = obj.save) === null || _a === void 0 ? void 0 : _a.event().then((response) => {
                        response && gvc.closeDialog();
                    });
...
static;
noImageURL = 'https://d3jnmi1tfjgtti.cloudfront.net/file/234285319/1722936949034-default_image.jpg';
static;
arrowDownDataImage(color, string);
string;
{
...
static;
whiteDotDataImage(color, string);
string;
{
    color = color.replace('#', '%23');
...
static;
getCheckedClass(gvc, GVC, color ?  : string);
{
...
static;
getDarkDotClass(gvc, GVC, color ?  : string);
{
    const className = Tool.randomString(6);
    gvc.addStyle(`
            .${className} {
...
static;
getWhiteDotClass(gvc, GVC, color ?  : string);
{
    const className = Tool.randomString(6);
    gvc.addStyle(`
            .${className} {
...
static;
imageSelector(gvc, GVC, image, string, callback, (src) => void );
{
    return gvc.bindView(() => {
        const id = gvc.glitter.getUUID();
        return {
