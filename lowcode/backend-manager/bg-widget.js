        ...
        return obj.gvc.bindView(() => {
            ...
            return {
                ...
                view: () => {
                    var _a, _b, _c, _d;
                    return html `
                        ${obj.title ? html ` <div class="tx_normal fw-normal" style="${(_a = obj.titleStyle) !== null && _a !== void 0 ? _a : ''}">${obj.title}</div>` : ``}
            ...
            view: () => {
                ...
                return html ` <div class="c_select" style="position: relative; ${(_a = obj.style) !== null && _a !== void 0 ? _a : ''}">
                    ...
                    obj.gvc.notifyDataChange(vm.id);
                        ...
                        >
                            <div style="font-size: 15px; cursor: pointer; color: #393939;">
                                ${defData ? defData.value : BgWidget.grayNote((_b = obj.placeholder) !== null && _b !== void 0 ? _b : '（點擊選擇項目）', 'font-size: 16px;')}
                            </div>
                        </div>
                        ${vm.show
                    ? html ` <div class="c_dropdown">
                        ...
                        gvc.closeDialog();
                            ...
                            <div class="c_dialog h-100">
                                <div class="c_dialog_body h-100">
                                    <div class="c_dialog_main h-100" style="max-height: 100%; padding: 0; gap: 24px; z-index: 1; position: relative;">${(_c = obj.innerHTML(gvc)) !== null && _c !== void 0 ? _c : ''}</div>
