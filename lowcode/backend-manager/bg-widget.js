...
export class BgWidget {
    ...
    static disableButton(text, obj) {
        var _a;
        return html `
            <button class="btn btn-gray-disable" style="" type="button">
    ...
    static iconButton(obj) {
        ...
        return html `<i class="${iconClass} cursor_pointer" style="font-size: ${(_a = obj === null || obj === void 0 ? void 0 : obj.size) !== null && _a !== void 0 ? _a : 18}px"
                       onclick="${obj.event}"></i>`;
    }
    ...
    static normalInsignia(text) {
        return html `
            <div class="insignia insignia-normal">${text}</div>`;
    }
    ...
    static selectLanguage(obj) {
        ...
        BgWidget.settingDialog({
            ...
            footer_html: (gvc) => {
                if (vm.edit_mode) {
                    return html `
                        <div class="w-100 justify-content-end d-flex " style="gap:10px;">
                        ...
                        refresh();
                                        ...
                                        <div class=" d-flex align-items-center justify-content-center cursor_pointer"
                                            ...
                                            <div class="d-flex align-items-center justify-content-center ps-2">
                                                <i class="fa-solid fa-plus fs-6" style="font-size: 16px; "
                                                   aria-hidden="true"></i>
                                            </div>
                                        </div>`)}
                            ${obj.selectable
        ...
        return obj.gvc.bindView(() => {
            ...
            return {
                ...
                view: () => {
                    ...
                    return html `
                        ${obj.title ? html `
                            <div class="tx_normal fw-normal" style="${(_a = obj.titleStyle) !== null && _a !== void 0 ? _a : ''}">${obj.title}</div>` : ``}
...
${(_c = obj.default) !== null && _c !== void 0 ? _c : ''}</textarea
    ...
    static richTextView(text) {
        return html `
            <div style="width: 100%; height: 200px; position: relative; background: white; border-radius: 10px; overflow: hidden; border: 1px #DDDDDD solid">
                <div
            ...
            view: () => {
                ...
                return html `
                    ...
                    ? html `
                        ...
                        return html `
                                                                <div class="d-flex align-items-center ${vm.random}-opt"
                                                                     onclick="${obj.gvc.event(() => call())}">
                                                                    <div class="form-check-label c_updown_label cursor_pointer">
                                                                        <div class="tx_normal ${opt.note ? 'mb-1' : ''}">
                                                                            ${opt.value}
            ...
            return html `
                ...
                view: () => {
                    ...
                    return html `
                        ...
                        return html `
                                                                <div class="d-flex align-items-center"
                                                                     style="gap: 24px">${printOptionVa(opt)}
                                                                </div>`;
                    }))}
                                            </div>
                                            <div class="c_dialog_bar">
                        ...
                        gvc.closeDialog();
                                    ...
                                    <div class="c_dialog h-100">
                                        <div class="c_dialog_body h-100">
                                            ...
                                            ${footer ? html `
                                                <div class="c_dialog_bar" style="z-index: 2;">${footer}</div>` : ``}
                                        </div>
                                    </div>
                                </div>`;
                },
    ...
    static multipleInput(gvc, def, cb) {
        const html = String.raw;
        const vm = {
