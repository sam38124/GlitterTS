...
export class BgWidget {
    ...
    static horizontalLine(css = {}) {
        ...
        return html `
            <div class="w-100" style="margin: ${marginValue}; border-bottom: ${size}px solid ${color};"></div>`;
    }
...
${(_c = obj.default) !== null && _c !== void 0 ? _c : ''}</textarea
        ...
        const formatLinkHTML = (icon, pathList) => {
            ...
            pathList.map((path, index) => {
                pathHTML += html `<span class="mx-1"
                                       style="font-size: 14px;">${path}</span>${index === pathList.length - 1
                    ? ''
    ...
    static select(obj) {
        ...
        >
            ${obj.gvc.map(obj.options.map(opt => html `
                            <option class="c_select_option" value="${opt.key}"
                                    ${obj.default === opt.key ? 'selected' : ''}>
                                ${opt.value}
                            </option>`))}
                                ...
                                return html `
                                                                ...
                                                                >
                                                                    <div class="text-nowrap"
                                                                         style="color: #393939 !important;">${d3.value}
                                                                    </div>
                                                                </td>`;
                            })
                                .join('')}
    ...
    static minHeightContainer(min_height) {
        return html `
            <div style="min-height: ${min_height}px"></div>`;
    }
