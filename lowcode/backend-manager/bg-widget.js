...
export class BgWidget {
    ...
    static tab(data, gvc, select, callback, style) {
        return html `
            <div style="justify-content: flex-start; align-items: flex-start; gap: 22px; display: inline-flex;cursor: pointer;margin-top: 24px;margin-bottom: 24px; ${style !== null && style !== void 0 ? style : ''}">
                ${data
            .map((dd) => {
            if (select === dd.key) {
                return html `
                                ...
                                ? html `
                                                    <div class="d-flex position-relative mt-2">
                                                        <div class="ms-2 border-end position-absolute h-100"
                                                             style="left: 0px;"></div>
                                                        <div class="flex-fill " style="margin-left:30px;width: 100%;">
                                                            ${dd.innerHtml}
                                                        </div>
                                                    </div>`
                                : ``,
...
${(_c = obj.default) !== null && _c !== void 0 ? _c : ''}</textarea
    ...
    static darkButton(text, event, obj) {
        ...
        return html `
            <button class="btn btn-black ${size.btn}" type="button" style="${(_a = obj === null || obj === void 0 ? void 0 : obj.style) !== null && _a !== void 0 ? _a : ''}" onclick="${event}">
    ...
    static searchFilter(event, vale, placeholder, margin) {
        return html `
            <div class="w-100 position-relative" style="margin: ${margin !== null && margin !== void 0 ? margin : 0};">
                <i class="fa-regular fa-magnifying-glass"
    ...
    static searchFilterOninput(event, vale, placeholder, margin) {
        return html `
            <div class="w-100 position-relative" style="margin: ${margin !== null && margin !== void 0 ? margin : 0};">
                ...
                <input class="form-control h-100"
                       style="border-radius: 10px; border: 1px solid #DDD; padding-left: 50px;"
                       placeholder="${placeholder}" oninput="${event}" value="${vale}"/>
            </div>`;
    }
    static select(obj) {
        var _a;
                    ...
                    return html `
                        ...
                        return html `
                            ...
                            : html `<input
                                                                                    ...
                                                                                    ${obj.default.includes(opt.key) ? 'checked' : ''}
                                                                            />`}
                                                                    ${opt.image ? BgWidget.validImageBox({
                            gvc: obj.gvc,
                            image: opt.image,
                            width: 40
                        }) : ''}
    ...
    static multiCheckboxContainer(gvc, data, def, callback, obj) {
        ...
        return gvc.bindView({
            ...
            view: () => {
                ...
                data.map((item) => {
                    checkboxHTML += html `
                        <div class="form-check" onclick="${gvc.event(() => {
                        if (obj && obj.readonly) {
                            return;
                        }
                        if (obj && obj.single) {
    ...
    static validImageBox(obj) {
        ...
        return obj.gvc.bindView({
            ...
            view: () => {
                var _a, _b;
                return html `<img class="${imageVM.class} ${(_a = obj.class) !== null && _a !== void 0 ? _a : ''}" style="${(_b = obj.style) !== null && _b !== void 0 ? _b : ''}"
                                 src="${imageVM.url}"/>`;
            },
            divCreate: {},
            onCreate: () => {
