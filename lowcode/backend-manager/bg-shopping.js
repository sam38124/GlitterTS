                                        ...
                                        function getDatalist() {
                                            return data.response.data.map((dd) => {
                                                return [
                                                    ...
                                                    {
                                                        key: '類別',
                                                        value: `<div class="d-flex align-items-center " style="height:40px;">${dd.content.collection.map((dd) => {
     ...
     <div style="width:900px;max-width:100%;">  ${BgShopping.card([
            ...
            obj.gvc.bindView(() => {
                ...
                return {
                    bind: bi,
                    view: () => {
                        return [EditorElem.h3(`<div class="d-flex align-items-center">商品內文<button class=" btn ms-2 btn-primary-c ms-2" style="height: 30px;width: 60px;" onclick="${obj.gvc.event(() => {
...
<div class="d-flex">${dd.option.map((d2) => {
                                        ...
                                        innerHtml: (gvc) => {
                                            ...
                                            return [
                                                EditorElem.editeInput({
                                                    gvc: gvc,
                                                    title: "分類標題",
                                                    default: dd !== null && dd !== void 0 ? dd : "",
                                                    placeHolder: ``,
                                                    callback: (text) => {
                                                        postMD.collection[index] = text;
                                                        refresh();
                                                    }
                                                })
                                            ].join('');
                    ...
                    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        resolve(` <div style="width:900px;max-width:100%;"> ${BgShopping.card([
                            ...
                            EditorElem.select({
                                ...
                                array: [{ title: '正式站', value: "https://core.newebpay.com/MPG/mpg_gateway" },
                                    { title: '測試站', value: "https://ccore.newebpay.com/MPG/mpg_gateway" }],
                                callback: (text) => {
