...
export class BgBlog {
    ...
    static template_select(gvc, callback) {
        ...
        return (html `
                <div class="p-2 border-bottom" style="">
...
function editor(cf) {
    ...
    vm.data.page_type = vm.data.page_type || 'page';
    let cVm = {
            ...
            view: () => {
                ...
                return html `
                    ...
                    if (cf.is_page) {
                        ...
                        return [
                            cf.is_page ? `` : BgWidget.mainCard(gvc.bindView(() => {
                ...
                })(), undefined, 'padding: 0 !important; margin: 0 !important; width: 73.5%;')}
