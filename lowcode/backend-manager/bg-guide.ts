...
export class BgGuide {
    ...
    public disableScroll() {
        ...
        // this.findPageIframe().contentWindow.addEventListener('scroll', preventScroll, { passive: false });
    ...
    private drawBGwithBelowWindow(
        ...
        let target = window.dom ?? this.findIframeDom(`${targetSelector}`);
    ...
    // 用於按下儲存按鈕的教學
    private drawFinBG(BG: HTMLElement, vm: any, targetSelector: string, viewID: string, step: number, key: string , window?:{loading?:boolean}) {
        function close() {
                            ...
                            <div style="width: 461px;height:210px;display: flex;flex-direction: column;align-items:center;border-radius: 10px;background: #FEAD20;">
                                ...
                                <div style="width:100%;margin-top: 24px;display: flex;align-items: center;justify-content: space-between;padding: 0 32px;">
                                    ...
                                    <div
                                            ...
                                            onclick="${gvc.event(() => {
                                                vm.step++;
                                                (document.querySelector('.guide-user-editor-1-icon') as HTMLElement).click();
            ...
            view: () => {
                switch (vm.step) {
                    case 1: {
                        ...
                        function digBG(x1: number, x2: number, x3: number, y1: number, y2: number, y3: number) {
                            gvc.addStyle(`
                                .guide-user-1{
                    ...
                    case 3: {
                        const className: string = 'addNewComponent';
                        ...
                        let target: any = document.querySelectorAll(`.${className}`);
                        if (target) {
                            target = target[target.length - 1];
                            this.detectClickThrough(target, () => {
                                vm.step++;
                    ...
                    case 4: {
                        const className: string = 'simpleAddGuide';
                    ...
                    case 5: {
                        const className: string = 'subComponentGuide';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                    ...
                    case 6: {
                        const className: string = 'guide-user-editor-7';
                    ...
                    case 7: {
                        let className: string = 'guide-user-editor-8';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                    ...
                    case 8: {
                        const className: string = 'guide-user-editor-8';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                    ...
                    case 9: {
                        const className: string = 'colorSettingGuide';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                        ...
                        if (target) {
                            ...
                            //      0 0,
                            //      0% ${first.y1}px,
                            //      ${first.x2}px ${first.y1}px,
                            //      ${first.x2}px ${first.y2}px,
                            //      ${first.x1}px ${first.y2}px,
                            //      ${first.x1}px ${first.y1}px,
                            //      0% ${first.y1}px,
                            //      0% ${second.y1}px,
                            //      ${second.x2}px ${second.y1}px,
                            //      ${second.x2}px ${second.y2}px,
                            //      ${second.x1}px ${second.y2}px,
                            //      ${second.x1}px ${second.y1}px,
                            //      0% ${second.y1}px, 0 100%, 100% 100%, 100% 0);`
                            // }
                            //
                            // let rect1 = target[0]!.parentElement!.getBoundingClientRect();
                            // let rect2 = target[1]!.parentElement!.getBoundingClientRect();
                            // console.log(rect2, rect1)
                            // let cssStyle = holeTwoBG({
                            //     x1: rect1.left, x2: rect1.right, y1: rect1.top, y2: rect1.bottom
                            // }, {
                            //     x1: rect2.left, x2: rect2.right, y1: rect2.top, y2: rect2.bottom
                            // });
                            ...
                            // return html`
                            //     <div
                            //             style="padding-left: 18px;width: 439px;height: 307px;flex-shrink: 0;filter: drop-shadow(2px 2px 10px rgba(0, 0, 0, 0.15));position: absolute;top: ${rect1.top +
                            //             12}px;left: ${rect1.right + 12}px;z-index:1033;"
                            //     >
                            //         <div style="position: relative;border-radius: 10px;">
                            //             <div style="display: flex;padding: 12px 24px;gap: 10px;width: 100%;background: #FEAD20;border-radius: 10px 10px 0 0;color:white;font-size: 20px;font-style: normal;font-weight: 700;line-height: normal;letter-spacing: 0.8px;">
                            //                 顏色設定
                            ...
                            //             </div>
                            //             <div style="background: #FFF;width:100%;padding: 18px 24px;border-radius: 0 0 10px 10px;font-size: 16px;font-style: normal;font-weight: 400;line-height: 160%; /* 25.6px */letter-spacing: 0.64px;">
                            //                 <div style="font-size: 16px;font-style: normal;font-weight: 400;line-height: 160%;letter-spacing: 0.64px;">
                            //                     <div>可以選擇要 <span style="font-weight: 700;">套用統一配色</span>  或是 <span style="font-weight: 700;">自定義配色</span></div>
                            //                     ${[{
                            //                         title:"1.套用統一配色:",
                            //                         content: "選擇一個配色，全站應用此配色的元件顏色將同步，方便修改、確保風格一致"
                            //                     },{
                    ...
                    case 10: {
                        const className: string = 'guideBackSetting';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                    ...
                    case 11: {
                        const className: string = 'guide-user-editor-4';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                                    ...
                                    <div style="font-size: 16px;font-style: normal;font-weight: 400;line-height: 160%;letter-spacing: 0.64px;white-space: normal">
                                        ...
                                        <div class="d-flex flex-column"
                                            ...
                                            ${(() => {
                                                ...
                                                return viewMode.map((data, index: number) => {
                                                    return html`
                                                        <div class="d-flex"
                    ...
                    case 12: {
                        const className: string = 'guide-user-editor-5';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                    ...
                    case 13: {
                        const className: string = 'guide-user-editor-6';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                ...
                switch (vm.step) {
                    case 1: {
                        ...
                        if (target) {
                            ...
                            function drawHole(x1: number, x2: number, x3: number, y1: number, y2: number, y3: number, y4: number) {
                    ...
                    case 3: {
                        const className: string = 'globalGuideColorSetting';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                    ...
                    case 4: {
                        const className: string = 'globalGuide-4';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                    ...
                    case 5: {
                        const className: string = 'globalGuide-5';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                        ...
                        if (target) {
                            ...
                            return this.drawBGwithRightWindow(BG, vm, target as any, `.${className}-BG`, viewID, vm.step, totalStep, {
                                ...
                                nextEvent: () => {
                                    ApiShop.getEditorGuide().then(r => {
                                        r.response.value.find((element: any) => element.title == "全站樣式").finish = true;
                                        ApiShop.setEditorGuide(r.response.value)
                                        this.guide = 0;
                                        this.step = 1;
                                        this.drawBG();
    ...
    public drawDesignEditorGuide() {
        ...
        return gvc.bindView({
            ...
            view: () => {
                switch (vm.step) {
                    case 1: {
                        const className: string = 'design-guide-1';
                        let clickTarget = document.querySelector(`.${className}-icon`) as HTMLElement;

                        clickTarget!.click();
                        if ((document.querySelector(`.${className}-icon`) as HTMLElement).style.color != 'white') {
                    ...
                    case 2: {
                        const className: string = 'guideDesign-2';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                    ...
                    case 3: {
                        const className: string = 'guideDesign-3';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
                    ...
                    case 5: {
                        const className: string = 'image-upload-container';
                        if (!document.querySelector(`.${className}`)) {
                            const timer = setInterval(() => {
                                if (document.querySelector(`.${className}`)) {
                                    clearInterval(timer);
