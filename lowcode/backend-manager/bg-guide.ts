        ...
        return gvc.bindView({
            ...
            view: () => {
                ...
                switch (vm.step) {
                    case 2: {
                        BG.style.clipPath = ``;
                        const target = document.querySelector(`.guide2-2`) as HTMLElement;
                            ...
                            return html`
                                ...
                                >
                                    <div style="position: relative;border-radius: 10px;">
                                        ...
                                        >
                                            點擊<span style="font-style: normal;font-weight: 700;line-height: 160%;letter-spacing: 0.64px;">「金流設定」</span>
                                        </div>
                                    </div>
                                </div>
                            `;
            ...
            view: () => {
                ...
                switch (vm.step) {
                                        ...
                                        tempHTML = html`
                                            ...
                                            >
                                                ...
                                                <div class="w-100" style="border-radius: 10px;">
                                                    ...
                                                    <div
                                                        style="background: #FFF;width:100%;padding: 18px 24px;display: flex;align-items: center;border-radius: 0 0 10px 10px;font-size: 16px;font-style: normal;font-weight: 400;line-height: 160%;letter-spacing: 0.64px;"
                                                    >
                                                        點擊線下付款，設定付款方式
                                                    </div>
                                                </div>
                    ...
                    case 4: {
                        ...
                        `);
                        return html`
                            <div class="d-flex flex-column" style="width: 332px;height: 209px;flex-shrink: 0;position: absolute;left: ${left}px;top:${rect.bottom + iframeRect.top + 24}px;">
    ...
    public drawInitGuide() {
        ...
        return gvc.bindView({
            ...
            view: () => {
                ...
                let count = dataList.filter((data: any) => {
                ...
                gvc.addStyle(html`
                    .g-container { position: relative; margin: auto; width: 124px; height: 124px; } .g-progress { position: relative; margin: auto; width: 124px; height: 124px; border-radius: 50%;
                    background: conic-gradient(#FEAD20 0, #FEAD20 ${(count / dataList.length) * 100}%, #EAEAEA ${(count / dataList.length) * 100}%, #EAEAEA); mask: radial-gradient(transparent,
                    transparent 48px, #000 48.5px, #000 0); } .g-circle { position: absolute; top: 0; left: 0; &::before, &::after { content: ""; position: absolute; top: 55px; left: 55px; width:
                    14px; height: 14px; border-radius: 50%; background: #FEAD20; z-index: 1; } &::before { transform: translate(0, -55px); } &::after { transform:
                    rotate(${(count / dataList.length) * 360}deg) translate(0, -55px) ; } }
                `);
                switch (vm.step) {
                    case -1: {
                    ...
                    case 0: {
                        return html`
                            <div style="width: 461px;height:210px;display: flex;flex-direction: column;align-items:center;border-radius: 10px;background: #FEAD20;">
                                ...
                                <div style="color: #FFF;font-size: 24px;font-weight: 700;letter-spacing: 0.96px;margin-top:12px;">商店建立成功！</div>
                                            ...
                                            view: () => {
                                                return dataList
                                                    .map((data) => {
                                                        return html`
                                                            <div
                                                                style="padding: 6px 18px;border-radius: 10px;border: 1px solid #DDD;background: #FFF;cursor: pointer; ${data.finished
                ...
                return html`
                    <div style="width: 461px;height:210px;display: flex;flex-direction: column;align-items:center;border-radius: 10px;background: #FEAD20;position: relative">
                        ...
                        <div style="color: #FFF;font-size: 24px;font-weight: 700;letter-spacing: 0.96px;">商店建立成功！</div>
                        <div style="color: #FFF;font-size: 16px;font-style: normal;font-weight: 500;line-height: 160%;letter-spacing: 0.64px;margin-top:6px;">跟著導覽教學，開張您的商店</div>
                        <div style="width:100%;margin-top: 24px;display: flex;align-items: center;justify-content: space-between;padding: 0 32px;">
                            <div
                                class="d-flex align-items-end"
