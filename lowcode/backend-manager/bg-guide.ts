...
export class BgGuide {
    ...
    public detectClickThrough(targetSelector:string , clickEvent:()=>void){
        let target = document.querySelector(targetSelector);
        const handleClick = ()=>{
            setTimeout(() => {
                clickEvent();
                this.eventSet=this.eventSet.filter((d:any)=>{return d!==handleClick});
    ...
    public drawInitGuide() {
        ...
        return gvc.bindView({
            ...
            view: () => {
                ...
                let count = dataList.filter((data:any)=>{return data.finished}).length;
                                ...
                                <div class=" d-flex flex-column align-items-center justify-content-center"
                                    ...
                                    <div class="g-container position-relative " style="">
                                        ...
                                        <div style="font-size: 25.92px;font-style: normal;font-weight: 700;line-height: normal;color:#393939;position: absolute;left: 50%;top: 50%;transform: translate(-50%,-50%)">
                                            ${dataList.filter((data:any)=>{return data.finished}).length}/${dataList.length}
                                        </div>
                                    </div>
