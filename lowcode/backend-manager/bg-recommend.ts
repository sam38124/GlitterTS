...
export class BgRecommend {
    ...
    public static linkTable(obj: { gvc: GVC; vm: LinkVM; rowCallback: (data: any, index: number) => void; user_id?: number }) {
        const html = String.raw;
        const gvc = obj.gvc;
        const vm = obj.vm;
        const glitter = gvc.glitter;
                                                    ...
                                                    BgWidget.mainCard(
                                                        [
                                                            ...
                                                            gvc.bindView({
                                                                ...
                                                                view: () => {
                                                                    const prefixURL = `https://${(window.parent as any).glitter.share.editorViewModel.domain}/distribution/`;
                                                                    return [      html`<div class="tx_normal fw-normal mb-2">自訂網址</div>`,
                                                                        html` <div
                                                            ...
                                                            return gvc.bindView({
                                                                ...
                                                                view: () => {
                                                                    return html`<div class="tx_700">分銷專屬折扣</div>
                                                                                ...
                                                                                { key: 'no', name: '不套用折扣' },
                                                                                {
                                                                                    ...
                                                                                    innerHtml: html`<div style="margin: 4px 0 8px;">
                                                                                        ...
                                                                                        ${BgWidget.select({
                                                                                            ...
                                                                                            options: [{ key: '', value: '（請選擇優惠券）' }].concat(
                                                                                    ...
                                                                                    ${
                                                                                        [
                                                                                            BgWidget.title_16(`折扣商品<div class="badge ms-2 mt-3" style="background:#eaeaea;color:#393939;">僅以下設定的商品會套用折扣</div>`),
                                                                                            ...
                                                                                            ${BgWidget.grayButton(
                                                                                                                            ...
                                                                                                                            gvc.event(() => {
                                                                                                                                BgProduct.collectionsDialog({
                                                                                                                                    gvc: gvc,
                                                                                                                                    default: vm.data.relative_data as string[],
                                                                                                                    ...
                                                                                                                    if (subVM.loading) {
                                                                                                                        if (vm.data.relative_data.length === 0) {
                                                                                                                            ...
                                                                                                                            new Promise<OptionsItem[]>((resolve) => {
                                                                                                                                resolve(BgProduct.getCollectiosOpts(vm.data.relative_data as string[]));
                                                                                                                            }).then((data) => {
                                                                                                                                subVM.dataList = data;
                                                                                                                                subVM.loading = false;
                                                                                                                                gvc.notifyDataChange(subVM.id);
                                                                                            ...
                                                                                            ${BgWidget.grayButton(
                                                                                                                            ...
                                                                                                                            gvc.event(() => {
                                                                                                                                BgProduct.productsDialog({
                                                                                                                                    ...
                                                                                                                                    callback: async (value) => {
                                                                                                                                        vm.data.relative_data = value;
                                                                                                                                        console.log(`select-product-first->`,value)
                                                                                                                                        subVM.dataList = await BgProduct.getProductOpts(vm.data.relative_data as string[]);
                                                                                                                                        subVM.loading = true;
                                                                                                                                        console.log(`select-product->`,subVM.dataList)
                                                                                                                                        gvc.notifyDataChange(subVM.id);
                                                                                                                                    },
                                                                                                                                });
                                                                                                                            }),
                                                                                                                ...
                                                                                                                onCreate: () => {
                                                                                                                    if (subVM.loading) {
                                                                                                                        if (vm.data.relative_data.length === 0) {
                                                                                                                            ...
                                                                                                                            new Promise<OptionsItem[]>((resolve) => {
                                                                                                                                resolve(BgProduct.getProductOpts(vm.data.relative_data as string[]));
                                                                                                                            }).then((data) => {
                                                                                                                                subVM.dataList = data;
                                                                                                                                subVM.loading = false;
                                                                                                                                gvc.notifyDataChange(subVM.id);
                                                                        ...
                                                                        ${(() => {
                                                                            const voucherData = vm.voucherList.find((item: { id: number }) => item.id === vm.data.voucher);
                                                                            if (!voucherData) {
                                                                                return '';
                                                                            }
                                                                                    ...
                                                                                    view: () => {
                                                                                        ...
                                                                                        return html`<div>
                                                                                            ${BgWidget.select({
                                                                                                ...
                                                                                                options: [{ key: '', value: '（請選擇推薦人）' }].concat(
                            ...
                            [
                                ...
                                html` <div class="update-bar-container">
                                    ...
                                    ${BgWidget.save(
                                        gvc.event(() => {
                                            // 未填寫驗證
                                            const valids: { key: 'name' | 'email' | 'phone'; text: string }[] = [
