            ...
            view: () => {
                ...
                switch (vm.step) {
                    ...
                    case 4: {
                        ...
                        `;
                        return this.drawBGwithBelowWindow(BG, vm, '.guide7-4', viewID, totalStep, totalStep, { width: 332, height: 235, title: "自訂主題", content: content, alignment: "left", btnText: "完成" }, () => {
                            this.leaveGuide(vm);
                        });
                    }
                    default: {
            ...
            view: () => {
                ...
                switch (vm.step) {
                    ...
                    case 4: {
                        ...
                        `;
                        return this.drawBGwithBelowWindow(BG, vm, '.guide7-4', viewID, totalStep - 4, totalStep, { width: 332, height: 235, title: "自訂主題", content: content, alignment: "left" });
                    }
                    case 5: {
                        ...
                        `;
                        return this.drawBGwithBelowWindow(BG, vm, '.guide8-5', viewID, totalStep - 3, totalStep, { width: 439, height: 261, title: "自訂主題", content: content });
                    }
                    case 6: {
                    ...
                    case 8: {
                        ...
                        `;
                        return this.drawBGwithBelowWindow(BG, vm, '.themeSwitch', viewID, totalStep, totalStep, { width: 439, height: 261, title: "切換主題", content: content, alignment: "left", btnText: "完成" });
                    }
                    case 9: {
                        return html `
