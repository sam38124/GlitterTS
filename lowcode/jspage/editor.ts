    ...
    this.create = (left: string, right: string) => {
      ...
      return html`
        ...
        >
          ...
          >
            <div
              class="${document.body.clientWidth < 800 ? `d-flex w-100 align-items-center` : `container-fluid pe-lg-4`}"
...
color: transparent;"
              ...
              ${document.body.clientWidth > 922 || EditorConfig.backend_page() === 'backend-manger'
                ...
                : html`
                  ...
                  `}
              <div class="border-end d-none d-lg-block" style="width:37px;height: 56px; "></div>
