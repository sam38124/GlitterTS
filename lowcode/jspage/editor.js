        ...
        this.create = (left, right) => {
            function getEditorTitle() {
                ...
                return glitter.share.blogEditor
                    ? `編輯Blog文章`
                    : html `<div class="d-flex align-items-end " onclick="${gvc.event(() => {
                        click++;
                        if (click > 5) {
            ...
            return html `
                <div class="position-relative vh-100 vw-100 overflow-auto" style="word-break: break-word;white-space: nowrap;background:whitesmoke;">
                    <header class="header navbar navbar-expand navbar-light bg-light border-bottom   fixed-top" data-scroll-header style="height: 56px;">
                ...
                switch (gvc.glitter.getUrlParameter('function')) {
                    ...
                    default:
                        return `width: 218px;`;
                            ...
                            >
                                <div class="d-flex align-items-center justify-content-center border-end " style="min-width:38px;height: 56px;width:38px;">
                                    <i
...
${glitter.share.editor_vm ? `d-none` : ``}"
                ...
                ? html `
                                          <button
                                              ...
                                              style="width: 56px;height:100%;display: inline-flex;
                                        ...
                                        view.push(html ` <div
                                            ...
                                            setTimeout(() => {
                                                gvc.notifyDataChange(id);
                                                                        ...
                                                                        >
                                                                            <iframe class="card  shadow position-absolute" src="${glitter.root_path}notice-widget?appName=cms_system&cms=true"></iframe>
                                                                        </div>`);
                                    })();
                                }
                                return view.join('');
