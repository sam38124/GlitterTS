...
${gvc.bindView(() => {
                                ...
                                return {
                                    ...
                                    view: () => {
                                        ...
                                        return new Promise((resolve, reject) => {
                                            resolve(html ` <div class="btn-group dropstart">
                    <button
                        type="button"
                    ...
                    <div class="dropdown-menu mx-1 dropdown-menu-end  end-0 ${vm.visible ? `show` : ``}" style="left: -90px;bottom: -90px;">
                        <a
                            class="dropdown-item"
