                                                            ...
                                                            resolve(questionText(`網域上架步驟`, [
                                                                {
                                                                    ...
                                                                    -<a class="fw-bold mt-2"
                                                                        href="https://domain.hinet.net/#/"
                                                                        target="_blank">中華電信HiNet</a><br>
                                                                    -<a class="fw-bold" href="https://tw.godaddy.com/"
                                                                        target="_blank">GoDaddy</a><br>
                                                                    -<a class="fw-bold"
                                                                        href="https://aws.amazon.com/tw/route53/"
                                                                        target="_blank">AWS Router 53</a><br>
                                                                    `
                                                                },
                                                                {
                                                                    title: '步驟二：更改DNS', content: html`
                                                                        前往DNS設定，並將A標籤設置為${serverINFO.response.ip}。
                                                                    `
                                                                },
                                                                {
                                                                    title: '步驟三：填寫網域名稱', content: html`
                                                                        <div class="mb-2">請輸入您的網域名稱:
                                                                        </div>${EditorElem.editeInput({
                                                                            gvc: gvc,
                                                                            title: "",
                                                                            default: viewModel.domain,
                                                                            placeHolder: `網域名稱`,
                                                                ...
                                                                },
                                                                {
                                                                    ...
                                                                    content: html`
                                                                        <div class="mb-2">PORT號 [ 範圍8000-8100 ] :
                                                                        </div>${EditorElem.editeInput({
                                                                            gvc: gvc,
                                                                            title: "",
                                    ...
                                    vmi.data = vm.dataList.map((dd: any) => {
                                        ...
                                        return [
                                            ...
                                            },
                                            {
                                                key: '移除',
                                                value: html`
                                                    <div class="hoverBtn d-flex align-items-center justify-content-center border rounded text-danger border-danger fs-6"
