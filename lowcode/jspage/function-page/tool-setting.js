            ...
            return {
                ...
                view: () => {
                    ...
                    return BgWidget.container(html `
                            ...
                            <div class="d-none border-bottom  mx-n2 mt-3"></div>
                            ${gvc.bindView((() => {
                            ...
                            view: () => {
                                        ...
                                        view: () => {
                                            ...
                                            return html `
                                                ...
                                                gvc.notifyDataChange(vid);
                                                                    ...
                                                                    <div class="px-3 my-2 ${dd.toggle ? `` : `d-none`}" style="white-space: normal;t">
                                ...
                                return vm.data
                                    ...
                                    return html `
                                        ...
                                        html `
                                                                                    <div
                                                                                            class="hoverF2 h-100 px-3 d-flex align-items-center ${(_a = dd.class) !== null && _a !== void 0 ? _a : ''}"
                                                                                            style="cursor: pointer;"
