                                            ...
                                            .map((dd) => {
                                                ...
                                                return EditorElem.colorSelect({
                                                    ...
                                                    callback: (text) => {
                                                        ...
                                                        // (document.querySelector('iframe') as any).contentWindow.glitter.pageConfig[0].gvc.recreateView();
                                                        // setTimeout(()=>{
                                                        //     (document.querySelector('iframe') as any).contentWindow.scrollTo(0,lastScrollY)
                                                        // })
                                                        //
                                                    },
                                                    gvc: gvc,
