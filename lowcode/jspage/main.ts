                ...
                view: () => {
                    if (viewModel.loading) {
                        ...
                        try {
                            ...
                            return doc.create(
                                html` <div class="d-flex overflow-hidden border-end" style="height:100vh;background:white;">
                                    ${gvc.bindView(() => {
                                        return {
                                            bind: 'left_sm_bar',
                                            view: () => {
...
"
                                            ...
                                            divCreate: {
                                                ...
                                                } h-100 border-end d-flex flex-column align-items-center`,
                                            },
                                        };
                                    })}
                                    <div
                                        class="offcanvas-body swiper scrollbar-hover  w-100 ${(() => {
                                    ...
                                    >
                                        ${AddComponent.leftNav(gvc)} ${PageSettingView.leftNav(gvc)} ${AddPage.leftNav(gvc)} ${SetGlobalValue.leftNav(gvc)} ${PageCodeSetting.leftNav(gvc)}
