...
-webkit-text-fill-color: transparent;" onclick="${
                                                        dd.event ||
                                                        gvc.event(() => {
...
-webkit-text-fill-color: transparent;"
                                                                    ...
                                                                    return gvc.bindView(() => {
                                                                        ...
                                                                        return {
                                                                            ...
                                                                            view: () => {
                                                                                ...
                                                                                if (vm_c.toggle) {
                                                                                    array.push(
                                                                                        AddComponent.getComponentDetail({
    ...
    public static getComponentDetail(obj: { data: any; gvc: GVC; withEmpty: boolean; type: string; callback: (data: any) => void; justGetIframe: boolean }) {
        const data = obj.data;
        const gvc = obj.gvc;
        ...
        return html` <div class="row m-0 pt-2 w-100">
            ${data
                .sort((a: any, b: any) => {
                    if (
                        ['SY00-內文', 'SY00-按鈕連結', 'SY00-圖片元件', 'SY00-影片方塊', 'SY00-標題', 'SY00-商品顯示區塊', 'SY00-富文本區塊'].find((dd) => {
