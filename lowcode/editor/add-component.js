                ...
                return {
                    ...
                    view: () => {
                        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            resolve(html ` <div class="p-2 border-bottom border-top" style="background: whitesmoke;">
                                    <div class="input-group">
                                        <input
                                            class="form-control input-sm"
                                            placeholder="關鍵字或標籤名稱"
                                ...
                                return {
                                    bind: tagCId,
                                    view: () => {
                                        return tagList.response.result
                                            .map((dd, index) => {
                                            if (vm.query_tag.indexOf(dd.tag) !== -1) {
                                                return html ` <div
                                                                class="d-flex align-items-center justify-content-center p-2    bgf6 fw-500 border "
                                                    ...
                                                    gvc.notifyDataChange(tagCId);
                                                            ...
                                                            >
                                                                <i class="fa-solid fa-circle-minus me-1" style="color:red;font-size:14px;"></i>
                                                                ${dd.tag}
                                                            </div>`;
                                            }
                                            else {
                                    ...
                                    divCreate: {
                                        class: `flex-fill d-inline-flex px-2`,
                                ...
                                return {
                                        ...
                                        return html ` <button
                                            ...
                                            switch (vm.template_from) {
                                                ...
                                                case 'all':
                                                    ...
                                                    <div class="dropdown-menu my-1 ${show ? `show` : ``} position-fixed" style="transform: translateY(30px);cursor: pointer;background: #f6f6f6">
                                                        <a
                                                            class="dropdown-item"
                                                            onclick="${gvc.event(() => {
                                    ...
                                    divCreate: {
                                        class: `btn-group dropdown p-2 border-start`,
                                        ...
                                        if (data) {
                                            ...
                                            return (() => {
                                                if (data.response.result.data.length === 0) {
                                                    return html `
                                                    <div class="d-flex align-items-center justify-content-center flex-column w-100" style="width:700px;">
                                                        <lottie-player
                                                        ...
                                                        ></lottie-player>
                                                        <h3 class="text-dark fs-6 mt-n3 px-2  " style="line-height: 200%;text-align: center;">查無相關模塊。</h3>
                                                    </div>
                                                `;
                                                }
                                                else {
                                                    ...
                                                    <div
                                                        class="w-100"
                                                        style=" max-height:${Storage.select_function === 'user-editor' ? `calc(100vh - 160px)` : `calc(100vh - 220px)`};overflow-y: auto;"
                                                    >
