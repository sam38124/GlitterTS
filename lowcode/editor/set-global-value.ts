                                ...
                                return `<div class="d-flex align-items-center justify-content-center hoverBtn  border"
                                 ...
                                 data-bs-title="${dd.label}" onclick="${gvc.event(() => {
                                    ...
                                    SetGlobalValue.checkFinish(() => {
                                        ...
                                        Storage.global_select = dd.key as any
                                        gvc.notifyDataChange(id)
                                    })
...
${(() => {
    ...
    public static resourceView(gvc: GVC) {
        return gvc.bindView(() => {
            return {
                bind: gvc.glitter.getUUID(),
                view: () => {
                    return new Promise(async (resolve, reject) => {
                        const data = await SetGlobalValue.valueRender(gvc)
                ...
                left: gvc.bindView(() => {
                    return {
                        ...
                        view: () => {
                            return [
                                html`
                                    <div class="d-flex   px-2   hi fw-bold d-flex align-items-center border-bottom bgf6"
                                         style="color:#151515;font-size:14px;gap:0px;height:48px;">共用資源管理
                                        <div class="flex-fill"></div>
                                        <li class="btn-group dropend" onclick="${gvc.event(() => {
                                            ...
                                            <div class="dropdown-menu  position-fixed pb-0 border "
                                ...
                                new PageEditor(gvc, vid, docID).renderLineItem(viewModel.globalValue.map((dd: any, index: number) => {
                                    ...
                                    selectEvent: (dd) => {
                                        ...
                                        dd.data.tagType = dd.data.tagType ?? 'value'
                    ...
                    return {
                        ...
                        view: () => {
                            if (viewModel.selectItem && viewModel.selectItem.data && (viewModel.selectItem.data.tagType || (viewModel.selectItem.type === 'container'))) {
                                return html`
                                    <div class="d-flex mx-n2 mt-n2 px-2 hi fw-bold d-flex align-items-center border-bottom  py-2 bgf6"
                                         style="color:#151515;font-size:14px;gap:0px;height:48px;">
                                        ${viewModel.selectItem.label}
                                        <div class="flex-fill"></div>
                                        <button class="btn btn-primary-c me-2" style="height: 28px;width: 80px;"
                                                onclick="${gvc.event(() => {
                                                    gvc.glitter.share.editorViewModel.globalValue = viewModel.globalValue;
                                                    gvc.glitter.htmlGenerate.saveEvent(true)
                                                })}">
...
-取值代碼:<br>glitter.share.globalValue["${viewModel.selectItem.data.tag}"]
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-fill"></div>
                                        <button class="btn btn-danger me-2" style="height: 30px;width: 90px;"
                                                onclick="${gvc.event(() => {
                                                    const dialog = new ShareDialog(gvc.glitter)
                                                    dialog.checkYesOrNot({
                                                        text: '是否確認刪除資源?',
    ...
    public static domainSetting(gvc: GVC) {
        const id = gvc.glitter.getUUID()
        const html = String.raw
        return html`
    ...
    public static pluginSetting(gvc: GVC) {
        const html = String.raw
        const id = gvc.glitter.getUUID()
        const vm: {
                                ...
                                view: () => {
                                                ...
                                                <div class="d-flex w-100  ps-2   hi fw-bold d-flex align-items-center border-bottom bgf6"
                                                    ...
                                                    ${gvc.bindView(() => {
                                                        ...
                                                        return {
                                                            ...
                                                            divCreate: {
                                                                class: `d-flex align-items-center justify-content-center me-2 h-100 border-start ps-2`,style:`cursor:pointer;`
                                                            },
                                                            onCreate:()=>{
                                 ...
                                 data-bs-title="${dd.label}" onclick="${gvc.event(() => {
                                                                ...
                                                                SetGlobalValue.checkFinish(() => {
                                                                    ...
                                                                    Storage.select_global_editor_tab = dd.key as any
                                                                    vm.select = dd.key as any
                                                                    gvc.notifyDataChange(id)
                                                                })
    ...
    public static pluginViewRender(gvc: GVC) {
        ...
        const og: any = JSON.parse(JSON.stringify(glitter.share.editorViewModel))
        const viewModel: any = JSON.parse(JSON.stringify(glitter.share.editorViewModel))
                ...
                right: gvc.bindView(() => {
                    return {
                        ...
                        view: () => {
                            ...
                            if (!dd) {
                                return html`
                                    <div class="d-flex ps-2 hi fw-bold d-flex align-items-center border-bottom  py-2 bgf6"
                                         style="color:#151515;font-size:16px;gap:0px;height:48px;">
                                        插件說明
                                    </div>
                                    <div class="d-flex flex-column w-100 align-items-center justify-content-center"
                                         style="">
                                        <div class="alert alert-info m-2 p-2 fw-500"
                        ...
                        view: () => {
                            ...
                            return html`
                                ...
                                <div class="px-2">
                                    ...
                                    }), `<div class="alert alert-info mt-2 fw-500 p-2" style="font-size:14px;white-space: normal;">可使用$字符設定相對路徑。<br>範例 : $router/sample.js</div>`].join('')}
                                </div>
                            `
                        },
                        divCreate: {
                            ...
                            if (!dd) {
                                return html`
                                    ...
                                    <div class="d-flex flex-column w-100 align-items-center justify-content-center"
                                        ...
                                        <div class="alert alert-info m-2 p-2 fw-500"
                                             style="white-space: normal;word-break: break-all;font-size:14px;">
                                            設定資源相對路徑，來決定頁面與事件模塊所加載的路徑位置。<br><br>
