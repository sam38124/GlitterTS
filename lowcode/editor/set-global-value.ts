...
${(() => {
    ...
    public static leftNav(gvc: GVC) {
        ...
        return html` <div
            ...
            ></div>
            <div id="setGlobalView" class="position-fixed left-0 top-0 h-100 bg-white shadow-lg " style="width:600px;z-index: 99999;left: -150%;">${SetGlobalValue.view(gvc)}</div>`;
    }
                    ...
                    return {
                        ...
                        view: () => {
                            return [
                                ...
                                new PageEditor(gvc, vid, docID).renderLineItem(
                                    viewModel.globalValue.map((dd: any, index: number) => {
                                        dd.index = index;
                                        return dd;
                                    }),
                                    false,
                                    viewModel.globalValue,
                                    {
                                                            ...
                                                            return `<div class="fw-500 me-2 pb-1 " style="font-size:15px;color:#151515;">開發者模式</div>
                                                                <div class="form-check form-switch mode-switch" style="" data-bs-toggle="mode"
                                                                    ...
                                                                    <input type="checkbox" class="form-check-input" style="${
                                                                        Storage.develop_mode === 'true' ? `background-color:#E30000FF !important;` : `background-color:gray !important;`
                                                                    }" id="theme-mode"
