        ...
        onCreateView: () => {
            ...
            return html `
                ...
                gvc.closeDialog();
                            ...
                            >
                                <i class="fa-solid fa-left-to-bracket hoverBtn" style="cursor:pointer;" aria-hidden="true"> </i>
                            </div>
                ...
                return url.href;
                            ...
                            style="border:2px solid lightgrey;${viewType === ViewType.mobile && document.body.clientWidth > 768 ? `width: 414px;` : `width:100%;height:100%;`}
"
                        ></iframe>
                    </div>
                </div>
