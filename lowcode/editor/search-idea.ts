                                    ...
                                    return html`
                                        <div class="col-12 mb-3 rounded-3">
                                            ...
                                            >
                                                ...
                                                >
                                                    <div class="position-absolute w-100 h-100 d-flex align-items-center justify-content-center rounded-3" style="overflow: hidden;">
                                                        <img
                                                            class="w-100 "
                                                    ...
                                                    >
                                                        <button class="btn btn-secondary d-flex align-items-center " style="height: 28px;width: 75px;gap:5px;">選擇</button>
                                                    </div>
                                                </div>
                                                <h3 class="fs-6 mb-0 d-flex justify-content-between align-items-center">${dd.template_config.name}</h3>
                                            </div>
                                        </div>
                                    `;
                                })
...
(window as any).glitter.setModule(import.meta.url, SearchIdea);
