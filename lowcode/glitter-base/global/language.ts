export class Language {
    ...
    public static languageDataList() {
        return [
            ...
            { key: 'please_enter_email_verification_code', tw: '請輸入信箱驗證碼', cn: '请输入邮箱验证码', en: 'Please enter email verification code' },
            ...
            { key: 'enter_phone_number', tw: '請輸入手機號碼', cn: '请输入手机号码', en: 'Please enter your phone number' },
            { key: 'enter_valid_email', tw: '請輸入有效電子信箱', cn: '请输入有效电子邮箱', en: 'Please enter a valid email address' },
            { key: 'enter_valid_phone_number', tw: '請輸入有效手機號碼', cn: '请输入有效手机号码', en: 'Please enter a valid phone number' },
            ...
            { key: 'please_confirm_password_again', tw: '請再次輸入確認密碼', cn: '请再次输入确认密码', en: 'Please enter confirm password again' },
            ...
            { key: 'member_exists_prompt', tw: '已經有會員了？前往', cn: '已经有会员了？前往', en: 'Already have an account? Go to' },
            { key: 'member_not_exists_prompt', tw: '還沒有成為會員？前往', cn: '还没有成为会员？前往', en: 'Not a member yet? Go to' },
            { key: 'registration_terms_agreement', tw: '註冊完成時，即代表您同意我們的', cn: '注册完成时，即代表您同意我们的', en: 'By completing the registration, you agree to our' },
            { key: 'terms_of_service', tw: '服務條款', cn: '服务条款', en: 'Terms of Service' },
            { key: 'privacy_policy', tw: '隱私條款', cn: '隐私政策', en: 'Privacy Policy' },
            { key: 'login_terms_agreement', tw: '登入完成時，即代表您同意我們的', cn: '登录完成时，即代表您同意我们的', en: 'By completing the login, you agree to our' },
            ...
            { key: 'password_mismatch', tw: '密碼與確認密碼不符', cn: '密码与确认密码不符', en: 'Passwords do not match' },
            ...
            { key: 'existing_user', tw: '此為已註冊的使用者', cn: '此为已注册的用户', en: 'This user is already registered' },
            { key: 'incorrect_credentials', tw: '帳號或密碼錯誤', cn: '帐号或密码错误', en: 'Incorrect account or password' },
            { key: 'verification_code_sent', tw: '成功寄送驗證碼', cn: '成功发送验证码', en: 'Verification code sent successfully' },
            ...
            { key: 'resend_code_timer', tw: 'xxx秒後可重新取得驗證碼', cn: 'xxx秒后可重新获取验证码', en: 'Resend the verification code in xxx seconds' },
