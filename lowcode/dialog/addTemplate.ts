...
init(import.meta.url, (gvc, glitter, gBundle) => {
    return {
        onCreateView: () => {
            ...
            const vm: {
                type: 'add' | 'select' | 'edit',
                id: string,
                searchText: string,
                addType: "page" | 'module' | 'article' | 'blog'
            } = {
...
function userMode(gvc: GVC, id: string, searchText: string, type: "page" | 'module' | 'article' | 'blog') {
    const html = String.raw
                                ...
                                return new Promise(async (resolve, reject) => {
                                    ...
                                    switch (vm.select) {
                                        ...
                                        case "me":
                                            ...
                                            }].concat(data.response.result.filter((dd: any) => {
                                            ...
                                            if (data.response.result.length === 0) {
                                                ...
                                                resolve(html`
                                                    <div class="row m-0 pt-2"
                                                        ...
                                                        ${data.response.result.map((dd: any,index:number) => {
                                                            return html`
