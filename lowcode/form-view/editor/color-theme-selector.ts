        ...
        return cf.gvc.bindView(() => {
            ...
            return {
                ...
                view: () => {
                    ...
                    return html`
                        <div class="t_39_16 my-2">${cf.widget.bundle.form_title}</div>
                        <div class="position-relative"
                            ...
                            <div style="align-self: stretch; justify-content: flex-start; align-items: center; gap: 10px; display: inline-flex">
                                <div style="padding: 9px 18px;background: white; border-radius: 7px; overflow: hidden; border: 1px #DDDDDD solid; justify-content: center; align-items: center; display: flex">
                                    <div style="align-self: stretch; flex-direction: column; justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                                        <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                                            <div style="color: #554233; font-size: 17px;  font-weight: 400; word-wrap: break-word">
                                                Title
                                            </div>
                                            <div style="color: #554233; font-size: 14px;  font-weight: 400; word-wrap: break-word">
                                                Aa
                                            </div>
                                        </div>
                            ...
                            <div class="w-100 ">
                                ...
                                <div class="dropdown-menu my-1 p-0 rounded-3 position-fixed  "
                                    ...
                                    <div class="d-flex flex-column">
                                        ${globalValue.color_theme.map((value: any, index: number, array: any) => {
                                            return html`
...
padding-left:12px;padding-right: 12px;${(`${index}` === select.id) ? `background:#F7F7F7;` : ``};"
                                                    ...
                                                    <div style="width:100px;padding: 9px 18px;background: white; border-radius: 7px; overflow: hidden; border: 1px #DDDDDD solid; justify-content: center; align-items: center; display: flex">
                                                        <div style="align-self: stretch; flex-direction: column; justify-content: flex-start; align-items: center; gap: 2px; display: inline-flex">
                                                            <div style="flex-direction: column; justify-content: flex-start; align-items: center; display: flex">
                                                                <div style="color: #554233; font-size: 17px;  font-weight: 400; word-wrap: break-word">
                                                                    Title
