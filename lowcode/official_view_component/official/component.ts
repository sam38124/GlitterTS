                                ...
                                if (!tag) {
                                    ...
                                    ((window as any).glitterInitialHelper).getPageData(page_request_config, (d2: any) => {
                                        ...
                                        function getFormData(ref: any) {
                                            //判斷是否有上次的更新資料
                                            ref= (window.parent as any).glitter.share.updated_form_data[`${page_request_config.appName}_${tag}`] || ref;
                                                                                                                    ...
                                                                                                                    view: async () => {
                                                                                                                        ...
                                                                                                                        function refresh(widget: any, device: 'mobile' | 'desktop' | 'def') {
                                                                                                                            ...
                                                                                                                            if (widget.storage && widget.storage.updatePageConfig) {
                                                                                                                                ...
                                                                                                                                try {
                                                                                                                                    for (const b of (window.parent as any).document.querySelector('.iframe_view').contentWindow.document.querySelectorAll(`.${widget.data.refer_app || (window as any).appName}_${pageData.tag}`)) {
                                                                                                                                        b.updatePageConfig(refer_form, device, oWidget);
                                                                                                                                    }
                                                                                                                                } catch (e) {
                                                                                                                        ...
                                                                                                                        function getItemsVisibility(dd: any) {
                                                                                                                            ...
                                                                                                                            const custom = oWidget[`${type}_editable`].find((d1: any) => {
                                                                                                                                return d1 === dd.key
                                                                                                                            });
                                                                                                                            //先統一刪除賦予值
                                                                                                                        ...
                                                                                                                        try {
                                                                                                                            ...
                                                                                                                            const global_setting_view = [
                                                                                                                                    ...
                                                                                                                                    BgWidget.settingDialog({
                                                                                                                                        ...
                                                                                                                                        innerHTML: (gvc: GVC) => {
                                                                                                                                            return html`
                                                                                                                                                <div class="px-3 pb-3">
                                                                                                                                                    ${[
                                                                                                                                                        BgWidget.alertInfo(``, [`勾選自定義項目，將會於${(Storage.view_type === 'mobile') ? `手機版` : `電腦版`}顯示獨特內容，而不會影響到其他尺寸的呈現樣式。`], {
                                                                                                                                ...
                                                                                                                                `<div class="d-flex align-items-center mx-3" style="gap:6px;cursor:pointer;" onclick="${gvc.event(() => {
                                                                                                                                    glitter.share.only_show_cuatomize = !glitter.share.only_show_cuatomize;
                                                                                                                                    gvc.notifyDataChange(vm.id)
                                                                                                                                })}">
                                                                                                                            ...
                                                                                                                            if (vm.page === 'editor') {
                                                                                                                                const array_items: any = await filterFormat((dd) => {
                                                                                                                                    return dd.page !== 'color_theme' && dd.category !== 'style' && getItemsVisibility(dd)
                                                                                                                                })
                                                                                                                                return [
...
font-weight: 700;" onclick="${gvc.event(() => {
                                                                                                                                ...
                                                                                                                                return global_setting_view + [setting_option.map((dd: any, index: any) => {
                                                                                                                                    return gvc.bindView(() => {
                                                                                                                                        const vm_c: {
                                                                                                                                            id: string,
                                                                                                                                            toggle: boolean
