              ...
              try {
                ...
                if (!tag) {
                  ...
                  (window as any).glitterInitialHelper.getPageData(page_request_config, (d2: any) => {
                    ...
                    function getFormData(ref: any) {
                      ...
                      if (widget.data.refer_app) {
                        ...
                        if (gvc.glitter.document.body.clientWidth < 800 && (widget as any).mobile.refer === 'hide') {
                          ...
                          (widget as any).desktop.refer === 'hide'
                        ) {
                          resolve(`
                                                <!-- tag=${tag} -->
                                                `);
                          ...
                          ((widget as any)[`mobile_editable`] ?? []).map((dd: any) => {
                            formData[dd] = JSON.parse(
                              JSON.stringify(
                                ((widget as any).mobile.data.refer_form_data || data.page_config.formData)[dd] || {}
                              )
                            );
                          });
                          ...
                          ((widget as any)[`desktop_editable`] ?? []).map((dd: any) => {
                            formData[dd] = JSON.parse(
                              JSON.stringify(
                                ((widget as any).desktop.data.refer_form_data || data.page_config.formData)[dd] || {}
                              )
                            );
                          });
                    ...
                    data.config.formData = getFormData(
        ...
        editor: async () => {
          ...
          const CustomStyle: any = await new Promise((resolve, reject) => {
            gvc.glitter.getModule(
              new URL(gvc.glitter.root_path + 'glitterBundle/html-component/custom-style.js', import.meta.url).href,
              clas => {
                resolve(clas);
              }
            );
                                      ...
                                      Object.keys(oWidget.data.refer_form_data).map(dd => {
                                        if (
                                          ...
                                          widget.data.refer_form_data[dd] =
                                            widget.data.refer_form_data[dd] ??
                                            JSON.parse(JSON.stringify(oWidget.data.refer_form_data[dd]));
                                        }
                                      });
                                                    ...
                                                    array_html.push(
                                                      gvc.bindView(() => {
                                                        ...
                                                        async function filterFormat(filter: (dd: any) => boolean) {
                                                          ...
                                                          const formFormat = JSON.parse(
                                                            JSON.stringify(page_config.formFormat)
                                                          );
                                                            ...
                                                            function refresh(
                                                              ...
                                                              if (widget.data.refer_app) {
                                                                ...
                                                                try {
                                                                  ...
                                                                  ].data.response.result[0].page_config =
                                                                ...
                                                                try {
                                                                  for (const b of (window.parent as any).document
                                                                    ...
                                                                    .contentWindow.document.querySelectorAll(
                                                                      `.${widget.data.refer_app || (window as any).appName}_${pageData.tag}`
                                                                    )) {
                                                                    b.updatePageConfig(refer_form, device, oWidget);
                                                                  }
                                                                } catch (e) {}
...
font-weight: 700;"
                                                                                      ...
                                                                                      array_string.push(`<div class="px-3 pb-2 ">${EditorElem.select(
                                                                                        {
                                                                                          ...
                                                                                          array:
                                                                                            glitter.share.editorViewModel.appConfig.font_theme.map(
                                                                                              (
                                                                                                dd: any,
                                                                                                index: number
                                                                                              ) => {
  ...
  <div class="bt_border_editor mt-2"
                                                 onclick="${gvc.event((e, event) => {
                                                   gvc.glitter.getModule(
                                                     `${gvc.glitter.root_path}/setting/fonts-config.js`,
                                                     FontsConfig => {
                                                       ...
                                                       NormalPageEditor.toggle({
                                                         visible: true,
                                                         view: FontsConfig.fontsSettingView(
                                                           gvc,
                                                           glitter.share.editorViewModel.appConfig,
                                                           true
                                                         ),
                                                         title: '管理全站字型',
                                                       });
                                    ...
                                    if (
                                      ...
                                      if (
                                        ...
                                        appendHtml(
                                          ...
                                          dd,
                                          false,
                                          dd.data.refer_app ? id : pageData.id,
                                          parent_config
                                        );
                                      }
