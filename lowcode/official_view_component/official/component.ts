                                    ...
                                    (window as any).glitterInitialHelper.getPageData(page_request_config, (d2: any) => {
                                        ...
                                        if (widget.data.refer_app) {
                                            ...
                                            if (gvc.glitter.document.body.clientWidth < 768 && (widget as any).mobile.refer === 'hide') {
                                                ...
                                                `);
                                                return;
                                            } else if (gvc.glitter.document.body.clientWidth >= 768 && (widget as any).desktop.refer === 'hide') {
                                                resolve(`
                                                <!-- tag=${tag} -->
                                                `);
                                                return;
                                            ...
                                            } else if (gvc.glitter.document.body.clientWidth >= 768 && (widget as any).desktop.refer === 'custom') {
                                        ...
                                        function getView() {
                                            ...
                                            function getCreateOption() {
                                                ...
                                                createOption.style += (() => {
                                                    if (gvc.glitter.document.body.clientWidth < 768 && (widget as any).mobile && (widget as any).mobile.refer === 'custom') {
                                                        return CustomStyle.value(gvc, (widget as any).mobile);
                                                    } else if (gvc.glitter.document.body.clientWidth >= 768 && (widget as any).desktop && (widget as any).desktop.refer === 'custom') {
                                                                    ...
                                                                    function refresh(widget: any) {
                                                                        if (widget.data.refer_app) {
                                                                            ...
                                                                            if (pageData.id !== id) {
                                                                                ...
                                                                                try {
                                                                                    (window as any).glitterInitialHelper.share[`getPageData-${parent_array.tag}`].data.response.result[0].config =
                                                                                        parent_array;
                                                                                } catch {}
                                                                            }
                                                                            ...
                                                                            if (!widget.storage) {
                                                                                try {
                                                                                    const doc: any = (
                                                                                        (document.querySelector('#editerCenter iframe') as any)!.contentWindow as any
                                                                                    ).document.querySelectorAll(`.${widget.data.refer_app}_${widget.data.tag}`)!;
                                                                                    if (doc) {
                                                                                        for (const b of doc) {
                                                                            ...
                                                                            try {
                                                                                (window as any).glitterInitialHelper.share[`getPageData-${pageData.tag}`].data.response.result[0].page_config =
                                                                            ...
                                                                            view: () => {
                                                                                return [
                                                                                    ...
                                                                                    GlobalWidget.showCaseEditor({
                                                                                        ...
                                                                                        widget: widget,
                                                                                        view: (widget) => {
                                                                                            refer_form = widget.data.refer_app
                                                                                                ? widget.data.refer_form_data || page_config.formData || {}
                                                                                                : page_config.formData;
                                                                                            const array_html = [
                                                                                                `<div class="d-flex px-2 border-bottom py-2 align-content-center justify-content-between" style="gap:10px;">
${[
    {
        title: '內容調整',
        key: 'content',
    ...
    .map((dd) => {
        return `
                                                                                                    <div
                                                                                                            class="${dd.key === vm.select ? `bt_ffb40` : `bt_ffb40_stroke`}"
                                                                                                            style="height: 38px;border-radius: 5px;width: calc(50% - 5px);"
                                                                                                            onclick="${gvc.event(() => {
                                                                                                                vm.select = dd.key;
                                                                                                                gvc.notifyDataChange([id]);
                                                                                                            })}"
    ...
    .join(`<div class=" border-start" style="height: 35px;width: 1px;"></div>`)}
</div>`,
                                                                                            ];
                                                                                            if (vm.select === 'content') {
                                                                                                array_html.push(
                                                                                                ...
                                                                                                array_html.push(
                                                                                                    `<div class="px-2">${CustomStyle.editor(gvc, widget, () => {
                                                                                                        refresh(widget);
                                                                                                    })}</div>`
                                                                                                );
                                                                                            }
