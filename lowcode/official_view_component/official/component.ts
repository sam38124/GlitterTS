                                    ...
                                    (window as any).glitterInitialHelper.getPageData(page_request_config, (d2: any) => {
                                        ...
                                        function getFormData(ref: any) {
                                            ...
                                            if (widget.data.refer_app) {
                                                ...
                                                if (gvc.glitter.document.body.clientWidth < 768 && (widget as any).mobile.refer === 'hide') {
                                                    resolve(`
                                                <!-- tag=${tag} -->
                                                `);
                                                    return;
                                                ...
                                                `);
                                                    return;
                                                } else if (gvc.glitter.document.body.clientWidth < 768 && (widget as any).mobile.refer === 'custom') {
                                        ...
                                        function getView() {
                                            ...
                                            function getCreateOption() {
                                                ...
                                                createOption.style += (() => {
                                                    if (
                                                        gvc.glitter.document.body.clientWidth < 768 &&
                                                        (widget as any).mobile &&
                                                        (widget as any).mobile.refer === 'custom' &&
                                                        (widget as any)[`mobile_editable`].find((d1: any) => {
                                                            return d1 === '_container_margin';
                                                        })
                                                    ) {
                                                        return RenderValue.custom_style.value(gvc, (widget as any).mobile);
                                                    } else if (
                                                        gvc.glitter.document.body.clientWidth >= 800 &&
                                                        (widget as any).desktop &&
                                                        (widget as any).desktop.refer === 'custom' &&
                                                        (widget as any)[`desktop_editable`].find((d1: any) => {
                                                            return d1 === '_container_margin';
                                                        })
                                                    ) {
                                            ...
                                            return new glitter.htmlGenerate(viewConfig, [], sub).render(
                                                gvc,
                                                {
                                                    class: ``,
                                                    style: ``,
                                                                ...
                                                                function getReferForm(widget: any, type: string) {
                                                                    if (widget.data.refer_app) {
                                                                        widget.data.refer_form_data =
                                                                            widget.data.refer_form_data ||
                                                                            (oWidget.data.refer_form_data && JSON.parse(JSON.stringify(oWidget.data.refer_form_data))) ||
                                                                            JSON.parse(JSON.stringify(page_config.formData));
                                                                        if (type !== 'def') {
                                                                            Object.keys(widget.data.refer_form_data).map((dd) => {
                                                                                if (
                                                                                    !((oWidget as any)[`${type}_editable`] ?? []).find((d1: any) => {
                                                                                        return d1 === dd;
                                                                                    })
                                                                                ) {
                                                                            ...
                                                                            Object.keys(oWidget.data.refer_form_data).map((dd) => {
                                                                                if (
                                                                                    ...
                                                                                    widget.data.refer_form_data[dd] =
                                                                                        widget.data.refer_form_data[dd] ?? JSON.parse(JSON.stringify(oWidget.data.refer_form_data[dd]));
                                                                                }
                                                                            });
                                                                                                                ...
                                                                                                                view: () => {
                                                                                                                    if (vm.type === 'preview') {
                                                                                                                        return html` <i
                                                                                                                            ...
                                                                                                                            >
                                                                                                                                <span style="font-size: 14px; color: #393939; font-weight: 400;"
                                                                                                                                    >更改命名</span
                                                                                                                                >
                                                                                                                            </button>`;
                                                                                                                    } else {
                                                                                                                ...
                                                                                                                view: async () => {
                                                                                                                    ...
                                                                                                                    function refresh(widget: any, device: 'mobile' | 'desktop' | 'def') {
                                                                                                                        if (widget.data.refer_app) {
                                                                                                                            ...
                                                                                                                            if (pageData.id !== p_id) {
                                                                                                                                ...
                                                                                                                                try {
                                                                                                                                    ...
                                                                                                                                    (window as any).glitterInitialHelper.share[
                                                                                                                                        `getPageData-${(window as any).appName}-${parent_array.tag}`
                                                                                                                                    ].data.response.result[0].config = parent_array;
                                                                                                                                } catch (error) {
                                                                                                                            ...
                                                                                                                            if (!widget.storage) {
                                                                                                                                try {
                                                                                                                                    const doc: any = (
                                                                                                                                        ...
                                                                                                                                        `.${oWidget.data.refer_app}_${oWidget.data.tag}`
                                                                                                                                    )!;
                                                                                                                                    if (doc) {
                                                                                                                                        for (const b of doc) {
                                                                                                                            ...
                                                                                                                            try {
                                                                                                                                (window as any).glitterInitialHelper.share[
                                                                                                                                    `getPageData-${pageData.tag}`
                                                                                                                                ].data.response.result[0].page_config = pageData.page_config;
                                                                                                                            } catch {}
                                                                                                                        }
                                                                                                                        widget.storage &&
                                                                                                                    ...
                                                                                                                    const setting_option = [
                                                                                                                        {
                                                                                                                            ...
                                                                                                                            array: await filterFormat((dd) => {
                                                                                                                                if (
                                                                                                                                    type === 'def' ||
                                                                                                                                    oWidget[`${type}_editable`].find((d1: any) => {
                                                                                                                                        return d1 === dd.key;
                                                                                                                                    })
                                                                                                                                ) {
                                                                                                                        ...
                                                                                                                        switch (dd.key) {
                                                                                                                            ...
                                                                                                                            case 'background':
                                                                                                                                return (
                                                                                                                                    type === 'def' ||
                                                                                                                                    oWidget[`${type}_editable`].filter((d1: any) => {
...
justify-content: center; align-items: center; gap: 8px; display: inline-flex;cursor: pointer;"
                                                                                                                                      ...
                                                                                                                                      >
                                                                                                                                          <div
                                                                                                                                              style="color: white; font-size: 16px; font-family: Noto Sans; font-weight: 700; word-wrap: break-word"
                                                                                                                                          >
                                                                                                                                              設置自定義選項
                                                                                                                                          </div>
                                                                                                                                      </div>`,
                                                                                                                                ...
                                                                                                                                html` <div
                                                                                                                                    class="p-3 mt-3 d-flex align-items-center ${setting_option.length >
                                                                                                                                    0
                                                                                                                                        ? ``
                                                                                                                                        : `d-none`}"
...
font-weight: 700;"
                                                                                                                                                        ...
                                                                                                                                                        switch (dd.key) {
                                                                                                                                                            ...
                                                                                                                                                            case 'color':
                                                                                                                                                                dd.array &&
                                                                                                                                                                    dd.array.length > 0 &&
                                                                                                                                                                    array_string.push(
                                                                                                                                                                        `<div class="px-1 pb-3 mt-n2">${FormWidget.editorView(
                                                                                                                                                                            {
                                                                                                                                                                                gvc: gvc,
                                                                                                                                                                                array: dd.array.map(
                                                                                                                                                                                    (dd: any) => {
                                                                                                                                                                ...
                                                                                                                                                                array_string.push(`<div class="px-3 pb-2 ">${EditorElem.select(
                                                                                                                                                                    {
                                                                                                                                                                        ...
                                                                                                                                                                        array: glitter.share.editorViewModel.appConfig.font_theme.map(
                                                                                                                                                                            (
                                                                                                                                                                                dd: any,
                                                                                                                                                                                index: number
                                                                                                                                                                            ) => {
  ...
  <div class="bt_border_editor mt-2"
                                                ...
                                                管理全站字型
                                                                                                                                                            ...
                                                                                                                                                            case 'margin':
                                                                                                                                                                array_string.push(
                                                                                                                                                                    `<div class="px-3 pb-2">${CustomStyle.editorMargin(
                                                                                                                                                                        gvc,
                                                                                                                                                                        widget,
                                                                                                                                                                        () => {
                                                                                                                                                                            refresh(widget, type);
                                                                                                                                                            ...
                                                                                                                                                            case 'background':
                                                                                                                                                                array_string.push(
                                                                                                                                                                    `<div class="px-3 pb-2">${CustomStyle.editorBackground(
                                                                                                                                                                        gvc,
                                                                                                                                                                        widget,
                                                                                                                                                                        () => {
                                                                                                                                                                            refresh(widget, type);
                                                                                                                                                            ...
                                                                                                                                                            case 'develop':
                                                                                                                                                                array_string.push(
                                                                                                                                                                    `<div class="px-3">${CustomStyle.editor(
                                                                                                                                                                        gvc,
                                                                                                                                                                        widget,
                                                                                                                                                                        () => {
                                                                                                                                                                            refresh(widget, type);
                                                                                            ...
                                                                                            toggle_visible: (bool) => {
                                                                                                if (bool) {
                                                                                                    $(
                                                                                                        (
                                                                                                            gvc.glitter.document.querySelector('#editerCenter  iframe') as any
                                                                                                        ).contentWindow.document.querySelector('.' + view_container_id)
                                                                                                    ).show();
                                                                                                } else {
                                                                                                    $(
                                                                                                        (
                                                            ...
                                                            async function loop(array: any, id: string, parent_config: any) {
                                                                for (const dd of array) {
                                                                    if (dd.type === 'container') {
                                                                        ...
                                                                        if (
                                                                            !pageData.template_config ||
                                                                            !pageData.template_config.tag ||
                                                                            !pageData.template_config.tag.find((dd: any) => {
                                                                                return dd === '商品卡片';
                                                                            })
                                                                        ) {
                        ...
                        gvc.bindView(() => {
                            ...
                            return {
                                ...
                                view: () => {
                                    return html`
                                        <div
                                            class="${Storage.select_function === 'user-editor' ? `d-none` : ``} mx-0 d-flex  px-3 hi fw-bold d-flex align-items-center shadow border-bottom  py-2 bgf6 "
