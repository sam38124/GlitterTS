...
<h2 class="fs-lg mb-2 fw-normal fw-500 mb-2 ">Three ways to bind views to data.</h2>
${doc.previewCode({
                            previewString: [
    ...
    return {
        onCreateView: () => {
            ...
            return \`\${mvvm}\`
                                ...
                                `<h2 class="fs-lg mb-2 fw-normal fw-500">Step1. Create class and define your components.</h2>${doc.codePlace(`import {GVC} from '../glitterBundle/GVController.js';
...
}`, 'language-typescript')}<h2 class="fs-lg mb-2 fw-normal fw-500  mt-4">Step2. Import view component in GVController.</h2>${doc.codePlace(`import {init} from '../glitterBundle/GVController.js'
...
<section id="${this.id}" class="border-bottom py-5 ps-lg-2 ps-xxl-0">
<h2 class="h4">${this.title}</h2>
<h2 class="fs-lg mb-2 fw-normal fw-500 mb-2 ">Use gvc.notifyDataChange to refresh view component.</h2>
...
gvc.notifyDataChange(['view2','view1'])`, 'language-typescript')}
        ...
        <div class="d-sm-flex align-items-end justify-content-between ps-lg-2 ps-xxl-0 mt-2 mt-lg-0 pt-4 mb-n3 border-bottom pb-2">
          <div class="me-4">
           ...
           <h2 class="fs-lg mb-2 fw-normal fw-500">Use bindview to manage your view components..</h2>
          </div>
        </div>
        ${(() => {
                let html = '';
            ...
            `, doc.asideScroller(sessions), new Items("BindView", gvc));
        },
        onCreate: () => {
            gallary.addScript();
            doc.addScript();
