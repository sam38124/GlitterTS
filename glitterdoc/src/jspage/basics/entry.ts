...
<h2 class="fs-lg mb-2 fw-normal fw-500 mb-2 ">You can write something logic to set home page or do it directly.</h2>
${doc.previewCode({
                            previewString: [
...
export class Entry {
    public static onCreate(glitter: Glitter) {
        ...
        glitter.setHome('jspage/'+glitter.getUrlParameter('page') ?? "getting-started/introduction.js",glitter.getUrlParameter('page') ?? "getting-started/introduction.js",{})
    }
}`, 'language-typescript'),
                                doc.codePlace(`'use strict';
import {Glitter} from './glitterBundle/Glitter.js' ;
    ...
    public static onCreate(glitter: Glitter) {
        ...
        switch (glitter.getUrlParameter("page")){
            ...
            default:
                ...
                {
                    id: `Option`,
                    title: 'Option: Global value',
                    get html() {
                        return `
<section id="${this.id}" class="border-bottom py-5 ps-lg-2 ps-xxl-0">
<h2 class="h4">${this.title}</h2>
<h2 class="fs-lg mb-2 fw-normal fw-500 mb-2 ">You can set value on global env and use it in anywhere .</h2>
...
<section id="${this.id}" class="border-bottom py-5 ps-lg-2 ps-xxl-0">
<h2 class="h4">${this.title}</h2>
<h2 class="fs-lg mb-2 fw-normal fw-500 mb-2 ">You can set global style for any page.</h2>
...
<section id="${this.id}" class="border-bottom py-5 ps-lg-2 ps-xxl-0">
<h2 class="h4">${this.title}</h2>
<h2 class="fs-lg mb-2 fw-normal fw-500 mb-2 ">You can set global script for any page.</h2>
${doc.codePlace(`glitter.addMtScript(['../bootstrap.min.js','../moment.min.js'],()=>{
//Success callback
},()=>{
//Error callback
});
        ...
        <div class="d-sm-flex align-items-end justify-content-between ps-lg-2 ps-xxl-0 mt-2 mt-lg-0 pt-4 mb-n3 border-bottom pb-2">
          <div class="me-4">
             <h1 class="pb-1">Entry.js</h1>
           <h2 class="fs-lg mb-2 fw-normal fw-500">The app entry point is entry.js</h2>
          </div>
        </div>
        ${(() => {
                let html = ''
